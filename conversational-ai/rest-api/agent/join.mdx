...
<ParameterList title="BODY" required={true}>
  ...
  <Parameter name="preset" type="string" required={false} deprecated>
    Use `credential_mode: "managed"` within the `asr`, `llm`, or `tts` block instead. See [Use managed mode](/conversational-ai/develop/managed-mode).
    ...
    - **ASR**
      - [deepgram_nova_2](/conversational-ai/models/asr/deepgram#use-a-preset)
      - [deepgram_nova_3](/conversational-ai/models/asr/deepgram#use-a-preset)
    - **LLM**
      - [openai_gpt_4o_mini](/conversational-ai/models/llm/openai#use-a-preset)
      - [openai_gpt_4_1_mini](/conversational-ai/models/llm/openai#use-a-preset)
      - [openai_gpt_5_nano](/conversational-ai/models/llm/openai#use-a-preset)
      - [openai_gpt_5_mini](/conversational-ai/models/llm/openai#use-a-preset)
    - **TTS**
      - [minimax_speech_2_6_turbo](/conversational-ai/models/tts/minimax#use-a-preset)
      - [minimax_speech_2_8_turbo](/conversational-ai/models/tts/minimax#use-a-preset)
      - [openai_tts_1](/conversational-ai/models/tts/openai#use-a-preset)
    </details>
  ...
  <Parameter name="properties" type="object" required={true}>
    ...
    <Parameter name="asr" type="object" required={false}>
      ...
      <Parameter name="credential_mode" type="string" possibleValues="managed" required={false}>
        Set to `"managed"` to use Agora-managed credentials for the selected vendor. When set, you do not need to provide an API key. See [Use managed mode](/conversational-ai/develop/managed-mode).
      </Parameter>
      ...
      - `xai`: [xAI (Beta)](/conversational-ai/models/asr/xai)
    ...
    <Parameter name="tts" type="object" required={true}>
      ...
      <Parameter name="vendor" type="string" required={true} possibleValues="microsoft,elevenlabs,minimax,deepgram,cartesia,openai,humeai,rime,fishaudio,google,amazon,sarvam,xai">
        ...
        - `deepgram`: [Deepgram (Beta)](/conversational-ai/models/tts/deepgram)
        - `murf`: [Murf (Beta)](/conversational-ai/models/tts/murf)
        ...
        - `xai`: [xAI (Beta)](/conversational-ai/models/tts/xai)
    ...
    <Parameter name="avatar" type="object" required={false}>  
      ...
      <Parameter name="vendor" type="string" possibleValues="akool,liveavatar,anam,generic" required={false}>  
        ...
        - `liveavatar`: [LiveAvatar (Beta)](/conversational-ai/models/avatar/heygen)
        - `anam`: [Anam (Beta)](/conversational-ai/models/avatar/anam)
        - `generic`: [Generic (Beta)](/conversational-ai/models/avatar/generic)
      </Parameter> 

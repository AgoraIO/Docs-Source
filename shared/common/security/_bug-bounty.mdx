...
<details>
<summary>System importance classifications</summary>

|Classification |Asset Examples| 
|---|---|
|Core system |<Vg k="AGORA_BACKEND"/>, the mail system, and official websites such as [www.agora.io](http://www.agora.io/), [sso.agora.io](http://sso.agora.io/), and `api.agora.io`|
...
<details>
<summary>Severity classification examples</summary>

...
In order to create the environment necessary to integrate Chat Starter Kit into your app, do the following:
...
5. Integrate the Starter Kit into your project.
  ...
  The Chat Starter Kit is now added into your project.

...
<PlatformWrapper platform={['ios','macos']}>
    ...
    - <Link to="{{Global.SIG2_SDK_API_IOS}}/rtmstreamchannel/publishtopicmessage(message:intopic:with:completion:)">publishTopicMessage(message:inTopic:with:completion:)</Link>
    ...
    - <Link to="{{Global.SIG2_SDK_API_MACOS}}/rtmstreamchannel/publishtopicmessage(message:intopic:with:completion:)">publishTopicMessage(message:inTopic:with:completion:)</Link>

...
* **iOS**
    ...
    ![](https://agora-doc.s3.us-east-1.amazonaws.com/images/video-sdk/ios-screen-sharing.png)
    ...
    1. Start screen sharing
        ...
        To start screen sharing, you call `startScreenCapture` combined with the user's action. There are two ways to do this:

        * Prompt the user to press and hold the **Screen Recording** button in the Control Center on iOS, and select the extension you created to start recording.

...
1. **Other features**
   ...
   - A new method <Link to="{{Global.API_REF_RN_ROOT_VOICE}}/class_irtcengineex.html#api_irtcengineex_enableencryptionex">enableEncryptionEx</Link> is added for enabling media stream or data stream encryption in multi-channel use-cases.
   ...
   - A new method <Link to="{{Global.API_REF_RN_ROOT_VOICE}}/class_irtcengineex.html#api_irtcengineex_getcallidex">getCallIdEx</Link> is introduced for retrieving call IDs in multi-channel use-cases.
...
1. **Other improvements**
   ...
   - In <Link to="{{Global.API_REF_RN_ROOT_VOICE}}/enum_audioeffectpreset.html">AudioEffectPreset</Link>, a new enumeration `RoomAcousticsChorus` (chorus effect) is added, enhancing the spatial presence of vocals in chorus use-cases.
...
- <Link to="{{Global.API_REF_RN_ROOT_VOICE}}/enum_audioeffectpreset.html">AudioEffectPreset</Link> adds `RoomAcousticsChorus`, enhancing the spatial presence of vocals in chorus use-cases.

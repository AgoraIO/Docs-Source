...
2.  (Optional) If you have not added a credit card to your account, follow these steps:
    ...
    1.  Click **Add New Card**.
        ...
        ![Add new card](https://agora-doc.s3.us-east-1.amazonaws.com/images/common/console-add-new-card.png)
...
1.  In <Link to="{{Global.AGORA_CONSOLE_URL}}/billing">Billing</Link>, select the **Bank Transfer** tab.
    ...
    ![Bank transfer](https://agora-doc.s3.us-east-1.amazonaws.com/images/common/console-bank-transfer.png)

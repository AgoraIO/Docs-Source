...
1. **Start or stop screen sharing**
    ...
    **NOTE**
    ...
    The Flutter screen sharing methods used in this example currently work only on the Windows platform. You will need a custom implementation to enable screen sharing on other platforms.
    ---

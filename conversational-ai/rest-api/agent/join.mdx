...
<ParameterList title="BODY" required={true}>
  ...
  <Parameter name="properties" type="object" required={true}>
    ...
    <Parameter name="tts" type="object" required={true}>
      ...
      <Parameter name="vendor" type="string" required={true} possibleValues="microsoft,elevenlabs,cartesia,openai,humeai,rime,fishaudio,groq,google,amazon">
        TTS provider. 
  ...
  Whether to receive agent performance data:
      ...
      This setting only takes effect when `advanced_features.enable_rtm` is `true`. See [Listen to agent events](/conversational-ai/develop/agent-events) to learn how to use client components to receive agent performance data.
      </Parameter>
      ...
      This setting only takes effect when `advanced_features.enable_rtm` is `true`. See [Listen to agent events](/conversational-ai/develop/agent-events) to learn how to use client components to receive agent error events.
      </Parameter>      
    </Parameter>    
  </Parameter>
</ParameterList>

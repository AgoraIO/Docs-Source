...
Creates a video encoded data sender module. This method creates a `VideoEncodedImageSender` object, which can be used in the [`NewCustomVideoTrackEncoded`](./localaudiotrack#newcustomvideotrackencoded) method.

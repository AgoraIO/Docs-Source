...
import RTCMinutesCalculator from '@site/src/components/RTCMinutesCalculator.jsx';

This page explains the updated pricing for <Vg k="COMPANY"/> <Vpd k="SDK"/> and guides you through the new pricing model.
...
![Billing structure](/images/rtc-sdk/pricing-structure.png)
...
![Package usage workflow](/images/rtc-sdk/pricing-workflow.svg)

## Basic service

<Vg k="COMPANY" /> uses [standard minutes](#standard-minutes-calculator) to measure usage for all basic services. Audio and video usage is converted into Standard minutes according to the following conversion ratios:

| Service Type | Latency | Conversion Ratio | List Price/1000 min |
|:-------------|:--------|:----------------:|--------------------:|
| Audio minute | Ultra-low | 1 : 1 | $0.99 |
| Video HD | Ultra-low | 1 : 4 | $3.99 |
| Video Full HD | Ultra-low | 1 : 9 | $8.99 |
| Video 2K | Ultra-low | 1 : 16 | $15.99 |
| Video 2K+ | Ultra-low | 1 : 36 | $35.99 |
| Broadcast Streaming Audience Audio | Low | 1 : 0.57 | $0.59 |
| Broadcast Streaming Audience Video HD | Low | 1 : 2 | $1.99 |
| Broadcast Streaming Audience Video Full HD | Low | 1 : 4.57 | $4.59 |
| Broadcast Streaming Audience Video 2K | Low | 1 : 8 | $7.99 |
| Broadcast Streaming Audience Video 2K+ | Low | 1 : 18 | $17.99 |
...
Use of <Vg k="VSDK"/> value-added services may incur costs in addition to basic service charges. For billing details, refer to the corresponding pricing page:

* [Cloud Recording](/cloud-recording/overview/pricing)
* [Cloud Transcoding](/cloud-transcoding/overview/pricing)
* [Local screenshot upload](/realtime-communication/advanced-features/screenshot-upload?platform=ios#pricing)
* [Media Push](/media-push/overview/pricing)
* [Media Pull](/media-pull/overview/pricing)
* [RTC associated features](../overview/pricing-legacy#pricing-for-associated-features)
...
<Vg k="COMPANY" /> calculates video usage for each user based on aggregate resolution, which is the combined resolution of all video streams a user subscribes to. If a user subscribes to both audio and video at the same time, <Vg k="COMPANY" /> counts this usage as video only.
...
This falls in the range 2,073,600 to 3,686,400, so <Vg k="COMPANY" /> counts this usage as **2K video**.
...
<Vg k="COMPANY" /> uses standard duration for unified billing. It is calculated using the following formula:
...
The Standard minutes estimated by this calculator are indicative and may not match actual usage billing. Accuracy in all cases is not guaranteed, and the calculations should be used as estimates only. Actual billing is based on Agora's official pricing policy and conversion ratios, which may vary. Please refer to Agora's [Pricing](../overview/pricing) policy for complete and up-to-date information on Standard minutes conversion and billing.
</Admonition>
...
Even if a user does not actively subscribe to any streams, audio usage time is still generated in the channel, which results in audio subscription fees. Only audio usage is charged for publishing audio or video streams.
</details>

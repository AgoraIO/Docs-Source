...
1. **Set the audio route**
    ...
    When the user taps the speckerphone checkbox, enable or disable the speakerphone. To implement this workflow, add the following method before `document.getElementById("join").onclick = async function ()`

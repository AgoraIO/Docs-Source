...
1. **Test with an authorized user** 
    ...
    Open two Linux terminals. Navigate to `<extracted-folder>/agora_rtsa_sdk/example/out/x86_64` and execute the following command to launch the <Vpl k="CLIENT" /> from both terminals. 

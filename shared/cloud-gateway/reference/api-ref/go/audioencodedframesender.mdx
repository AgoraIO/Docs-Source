...
Creates an encoded audio data sending module. This method creates an `AudioEncodedFrameSender` object, which can be used in the [`NewCustomAudioTrackEncoded`](./localaudiotrack#newcustomaudiotrackencoded) method.

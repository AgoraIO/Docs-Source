...
This section introduces the main changes of v<Vg k="VSDK_RELEASE" /> compared to v<Vg k="VSDK_PREVIOUS_RELEASE" /> in the following categories. You need to update the code of your app according to your business use-case.
    ...
    If the version before upgrading is a version before v3.7.0, please check the [v3.x release notes](../../3.x/realtime-communication/introduction/release-notes?platform=ios) to obtain the changes between this version and v3.7.0.
    </Admonition>
...
See [Virtual Background](/realtime-communication/advanced-features/virtual-background?platform=android) to update the code in your app.

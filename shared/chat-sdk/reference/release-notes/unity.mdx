...
v1.1.3 was released on September XX, 2023.

#### New features

- Disable domain reload in **Enter Play Mode Options**
- Set the **Managed Code Stripping Level** property to **High**
- Change the AppKey without restarting the IDE

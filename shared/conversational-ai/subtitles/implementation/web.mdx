...
Copy the [`message.ts`](https://github.com/AgoraIO-Community/Conversational-AI-Demo/blob/main/Web/Scenes/VoiceAgent/src/services/message.ts) file to your project and import the module before calling the module API.

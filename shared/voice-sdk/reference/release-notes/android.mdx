...
1. **<Vpd k="SDK_LITE"/>**
   ...
   - For the list of APIs supported by <Vpd k="SDK_LITE"/>, see <Link to="{{Global.API_REF_ANDROID_ROOT_VOICE_SDK}}/rtc_lite_api.html#rtc_lite_api"><Vpd k="SDK_LITE"/> API</Link>.

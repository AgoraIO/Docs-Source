...
<div class="alert note">After calling the [Set custom recording configuration](configuration) API, custom recording is automatically enabled for all live streams under the entry point.</div>

...
1. Create UMG
    ...
    ![VolumeControlMute](/images/rtc-sdk/volume-control-mute-implementation-blueprint-1.png)
...
1. Bind UI Events
    ...
    ![VolumeControlMute](/images/rtc-sdk/volume-control-mute-implementation-blueprint-2.png)
...
1. Implement Callback Function
    ...
    ![VolumeControlMute](/images/rtc-sdk/volume-control-mute-implementation-blueprint-3.png)
...
1. Create UMG
    ...
    ![VolumeControlMute](/images/rtc-sdk/volume-control-mute-implementation-blueprint-4.png)
...
1. Bind UI Events
    ...
    ![VolumeControlMute](/images/rtc-sdk/volume-control-mute-implementation-blueprint-5.png)
...
3. Implement UI Events
    ...
    ![VolumeControlMute](/images/rtc-sdk/volume-control-mute-implementation-blueprint-6.png)
...
1. Create UMG
    ...
    ![VolumeControlMute](/images/rtc-sdk/volume-control-mute-implementation-blueprint-7.png)
...
1. Bind UI Events
    ...
    ![VolumeControlMute](/images/rtc-sdk/volume-control-mute-implementation-blueprint-8.png)
...
1. Implement UI Events
    ...
    ![VolumeControlMute](/images/rtc-sdk/volume-control-mute-implementation-blueprint-9.png)
...
4. Add Callback Event
    ...
    1. Enable listening to the **OnAudioVolumeIndication** callback, as shown in the following figure:
        ...
        ![VolumeControlMute](/images/rtc-sdk/volume-control-mute-implementation-blueprint-10.png)
    ...
    1. When the **OnAudioVolumeIndication** callback is triggered, print the received user volume information, as shown in the following figure:
        ...
        ![VolumeControlMute](/images/rtc-sdk/volume-control-mute-implementation-blueprint-11.png)

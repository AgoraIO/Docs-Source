...
* <Link to= "{{global.API_REF_UNITY_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onchannelmediarelayevent">onChannelMediaRelayEvent</Link>
</PlatformWrapper>
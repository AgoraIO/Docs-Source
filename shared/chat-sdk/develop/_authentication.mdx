...
For test purposes, you can generate temporary tokens in Agora Console. However, in the development environment, you need to deploy your own app server to use AgoraTools to generate tokens.

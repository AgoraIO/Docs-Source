...
| <code className="index-group-item-rtmeventlistener index-api-onconnection" id={config.onconnection[props.ag_platform]}>{config.onconnection[props.ag_platform]}</code> | <span class="index-desc-onconnection">(Deprecated) Receive event notifications when client connection status changes. For details, see <a href="#enumvconnectionstatepropsag_platform">SDK connection state</a > and<a href="#enumvconnectionreasonpropsag_platform">SDK connection state change reason</a >.</span> |
| <code className="index-group-item-rtmeventlistener index-api-onlinkstateevent" id={config.onlinkstateevent[props.ag_platform]}>{config.onlinkstateevent[props.ag_platform]}</code> | <span class="index-desc-onlinkstateevent">Receive event notifications when client connection status changes. For details, see <a href="#LinkStateEvent"><code>{config.linkstateevent[props.ag_platform]}</code></a >.</span> |

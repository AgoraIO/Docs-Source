...
<div class="alert note">Media Broadcast is currently in public beta. To enable this service, contact <a href="mailto:sales@agora.io">sales@agora.io</a>.</div>
...
- The App ID of your Agora project. See [Get the App ID](https://docs.agora.io/en/Agora%20Platform/get_appid_token?platform=All%20Platforms#获取-app-id).
- A Customer ID/Customer Secret pair. See[ Generate a Customer ID and Customer Secret](https://docs.agora.io/en/Agora%20Platform/get_appid_token?platform=All%20Platforms#key-secret).
...
The call frequency limit of the Media Broadcast RESTful API is 50 times per second. If the call frequency exceeds the limit, see [How can I avoid being frequency limited when calling Agora Server RESTful APIs?](https://docs.agora.io/cn/faq/restful_api_call_frequency).

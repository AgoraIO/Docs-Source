...
The following example shows how to record both audio and video in an interactive live streaming or broadcast streaming channel in composite recording mode. 

...
This section shows you how to implement a basic, real-time audio and video <Vpl k="CLIENT"/>. 
The following figure shows the basic process of using <Vpd k="SDK"/> to achieve audio and video interaction:

![](/images/video-sdk/tmp_quick-start-sequence.jpg)

A complete code sample that implements the basic process of real-time interaction is presented here for reference. Copy the sample code into your project to quickly implement the basic functions of real-time audio and video interaction. Then, follow the implementation steps to understand the core API calls.
...
This section describes how to import Android-related classes and obtain the camera, recording, and other permissions of Android devices.

1. Import Android related classes
...
### Join a channel and publish audion and video streams

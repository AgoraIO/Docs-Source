...
synchronization capabilities for real-time systems into your <Vpl k="CLIENT" />. You can also use <Vg k="SIG" /> to enhance the user experience for <Vg k="VIDEO" />, <Vg k="AUDIO" />,  <Vg k="ILS" />, and <Vg k="BS" /> applications.

This page guides on how to use the <Vpd k="SDK" /> to rapidly build a simple application. It shows you how to integrate the <Vpd k="SDK" /> and implement pub-sub messaging into your <Vpl k="CLIENT" />. For information and implementation details about stream channels, where users communicate using topics in a channel, see [Stream channels](../core-functionality/stream-channel).

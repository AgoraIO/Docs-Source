...
![Agora chat examples web](https://agora-doc.s3.us-east-1.amazonaws.com/images/chat/agora-chat-examples-empty.png)
...
1. Send a message
   ...
   Fill in the user ID of the receiver (`Roy`) in the **single chat id** box and type in the message ("Hi, how are you doing?") to send in the **message content** box, and click **Send** to send the message.
	...
	![Send a message](https://agora-doc.s3.us-east-1.amazonaws.com/images/chat/send-message-web.png)
...
1. Receive the message
   ...
   ![Receive a message](https://agora-doc.s3.us-east-1.amazonaws.com/images/chat/receive-message-web.png)

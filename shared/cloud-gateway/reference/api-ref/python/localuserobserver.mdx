...
Callback for receiving data stream messages. This callback indicates that the local user has received the stream message sent by the remote user through the [`send_stream_message`](./rtcconnection#sendstreammessage) method.

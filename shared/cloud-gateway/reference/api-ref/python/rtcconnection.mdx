...
|`user_id`|The local user ID. No more than 64 bytes. If you do not set the user ID or set it to `None`, the SDK automatically returns a user ID in the `on_connected` callback. You must record and manage this ID yourself. Depending on the user ID type you selected in the [`initialize`](./agoraservice#initialize) method, the supported character set is different: The supported character set for integer user IDs includes 10 digits 0-9. The supported character set for string user IDs includes: - 26 lowercase English letters: a-z; - 26 uppercase English letters: A-Z; - 10 digits: 0-9; - Space; - `!`, `#`, `$`, `%`, `&`, `(`, `)`, `+`, `-`, `:`, `;`, `<`, `=`, `.`, `>`, `?`, `@`, `[`, `]`, `^`, `_`, `{`, `}`, `|`, `~`, `,`|

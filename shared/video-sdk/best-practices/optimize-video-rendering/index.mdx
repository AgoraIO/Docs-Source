...
The API and sample code in this guide are for the Windows platform. If you're targeting another platform, refer to the Windows implementation as a reference and check the [API reference](/api-reference) for platform-specific details.

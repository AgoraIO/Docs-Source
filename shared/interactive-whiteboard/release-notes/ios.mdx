...
- <Link to="{{Global.API_REF_IOS_WHITE}}/Classes/WhiteRoomConfig.html?platform=iOS#/api/name/drawOnlyApplePencil">drawOnlyApplePencil</Link>
- <Link to="{{Global.API_REF_IOS_WHITE}}/Classes/WhiteSdkConfiguration.html?platform=iOS#/api/name/disableNewPencilStroke">disableNewPencilStroke</Link>

...
<CodeItem language="shell" name="HTTPie">{`http GET https://api.sd-rtn.com/dev/v1/kicking-rule \\
...
xhr.addEventListener('readystatechange', function () {
  ...
  \}
\});\n
xhr.open('GET', 'https://api.sd-rtn.com/dev/v1/kicking-rule');
...
\const req = unirest('GET', 'https://api.sd-rtn.com/dev/v1/kicking-rule');\n
req.headers({
  Authorization: '',
  Accept: 'application/json'
\});\n
...
<CodeItem language="c" name="RestSharp">{`var client = new RestClient("https://api.sd-rtn.com/dev/v1/kicking-rule");
...
client.prepare("GET", "https://api.sd-rtn.com/dev/v1/kicking-rule")
...
<CodeItem language="java" name="Unirest">{`HttpResponse<String> response = Unirest.get("https://api.sd-rtn.com/dev/v1/kicking-rule")
  .header("Authorization", "")
  .header("Accept", "application/json")
  .asString();`}</CodeItem>
</CodeGroup>
...
$response = $client->request('GET', 'https://api.sd-rtn.com/dev/v1/kicking-rule', [
  'headers' => [
    'Accept' => 'application/json',
    'Authorization' => '',
  \],
...
$response = Invoke-WebRequest -Uri 'https://api.sd-rtn.com/dev/v1/kicking-rule' -Method GET -Headers $headers`}</CodeItem>
<CodeItem language="kotlin" name="RestMethod">{`$headers=@{}
$headers.Add("Authorization", "")
$headers.Add("Accept", "application/json")
$response = Invoke-RestMethod -Uri 'https://api.sd-rtn.com/dev/v1/kicking-rule' -Method GET -Headers $headers`}</CodeItem>
</CodeGroup>
...
(client/get "https://api.sd-rtn.com/dev/v1/kicking-rule" {:headers {:Authorization ""}

---
title: 'Display files (Whiteboard)'
sidebar_position: 4
type: docs
description: >
...
- Ensure the format of the converted images or web pages is supported by the Agora Interactive Whiteboard SDK.
  ...
  - Static images in PNG, JPG/JPEG, and WEBP formats converted from PPT, PPTX, DOC, DOCX, and PDF files. You can convert them yourself or use the [static-file conversion service](/interactive-whiteboard/reference/file-conversion#static-file-conversion) of Agora Interactive Whiteboard.
  - HTML web pages converted from PPTX files. You must use the [dynamic-file conversion service](/interactive-whiteboard/reference/whiteboard-api/file-conversion#dynamic-file-conversion) of Agora Interactive Whiteboard to do the conversion.
...
- Understand the basic concepts and operations of scenes. See [Scene Overview](/interactive-whiteboard/develop/scenes/overview) and [Manage Scenes](/interactive-whiteboard/develop/scenes/manage-scenes). 
...
The following section extends the [Join a Whiteboard Room](../get-started/get-started-sdk) sample code to show the creation of multiple scenes and the display of a six-page, animated PPTX file.

1. Upload the PPTX source file to a third-party cloud storage service, and call the [Start file conversion](/interactive-whiteboard/reference/whiteboard-api/file-conversion#start-file-conversion) API to create a dynamic-file conversion task that converts the PPTX file to HTML web pages.

2. Call the [Query file conversion progress](/interactive-whiteboard/reference/whiteboard-api/file-conversion#query-the-progress-of-a-file-conversion-task) API to get the URLs of the converted HTML web pages from the `conversionFileUrl` parameter in the response body.
...
- [Start file conversion](/interactive-whiteboard/reference/whiteboard-api/file-conversion#start-file-conversion)
- [Query file conversion progress](/interactive-whiteboard/reference/whiteboard-api/file-conversion#query-the-progress-of-a-file-conversion-task)

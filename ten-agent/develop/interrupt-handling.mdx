...
The interrupt handling mechanism manages conversation flow by detecting when to stop ongoing processing and clean up system state. This document explains how interrupts work and how to customize them for your use case.

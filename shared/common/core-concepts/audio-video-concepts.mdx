...
![orientation_adaptive_locked_landscape](/images/common/basic-audio-and-video.png)
...
![An audio module](/images/common/audio-module.png)
...
![Video module functions](/images/common/video-module.png)

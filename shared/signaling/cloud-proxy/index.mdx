...
![cloud proxy](https://agora-doc.s3.us-east-1.amazonaws.com/images/signaling/cloud-proxy.svg)
...
- Set up the [<Vg k="MESS_SDK"/> reference app](/en/signaling/get-started/sdk-quickstart#project-setup)
...
This section contains content that completes the information on this page, or points you to documentation that explains other aspects to this
product.

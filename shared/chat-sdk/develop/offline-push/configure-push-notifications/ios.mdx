...
You can use extension fields to implement customized push settings, ringtones, notification bar collapse, force push, silent message sending, and rich text push.

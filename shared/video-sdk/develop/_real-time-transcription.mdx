...
1. When you join a channel in your app, use an integer value for your UID. For example, `7`.
1. When you [start an RTT session](https://documenter.getpostman.com/view/6319646/SVSLr9AM#92041cab-1f45-4ff3-83a5-601fa06a0427) set `uid` to the same integer UID enclosed in quotation marks. For example, `"7"`.

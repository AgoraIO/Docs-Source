...
After upgrading the SDK, you need to update the code in your app according to your business scenarios. For details, see [Migrate from v3.7.0 to v4.0.0](./migration_guide_android_ng?platform=Android).
...
In order to enhance the real-time audio interactive activities based on the Agora SDK, this release supports the one-stop solution for the extensions from the [Agora extensions marketplace](https://www.agora.io/en/marketplace):

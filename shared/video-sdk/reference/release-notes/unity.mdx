...
After upgrading the SDK, you need to update the code in your app according to your business scenarios. For details, see [Migrate from v3.x to v4.0.0 RC](https://docs.agora.io/en/video-call-4.x/migration_guide_unity_ng).

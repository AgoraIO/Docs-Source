...
<div class="alert info">Make sure you have <a href="/cn/agora-class/agora_class_quickstart_electron#dev-env">set up the development environment</a>.</div>
...
4. After pulling the code to your local device, you are free to edit the code according to your needs. You can refer to the [Customize the Classroom UI guide](/en/agora-class/agora_class_custom_ui_web).

...
A static document refers to the PNG or JPG/JPEG images converted from a PPT, PPTX, DOC, DOCX, or PDF document by using the [Agora Interactive Whiteboard file conversion service](/interactive-whiteboard/reference/file-conversion-overview#static-file-conversion).

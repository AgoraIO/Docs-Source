...
<Admonition type="info" title="Note">Starting from v4.4.0, the SDK provides an API sunset notice, which includes information about deprecated and removed APIs in each version. See <Link to="{{Global.API_REF_MACOS_ROOT_VOICE_SDK}}/agorartckit">API reference</Link>.</Admonition>

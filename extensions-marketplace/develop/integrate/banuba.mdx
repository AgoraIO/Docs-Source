...
If you have any problems with installing Agora frameworks with Swift Package Manager refer to this <a href = "https://github.com/agorabuilder/AgoraRtcEngine_iOS_Preview">page</a>
...
4. Get [the latest Agora Video SDK archive](https://console.agora.io/marketplace/extension/introduce?serviceName=banuba).

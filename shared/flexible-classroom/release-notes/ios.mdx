...
- Web client:
  ...
  - Introduces [EDUClassroomUIStore](/flexible-classroom/get-started/enable-flexible-classroom) for customizing the classroom UI, which replaces the UIKit in previous versions.

...
| [`entireScenes`](../reference/whiteboard-api/room-managementl#entirescenes)      | Gets the information of all scenes in the current room.      |
| [`scenePathType`](../reference/whiteboard-api/room-managementl#scenepathtype)     | Gets the type of the scene path.                             |
| [`putScenes`](../reference/whiteboard-api/room-managementl#putscenes)         | Inserts multiples scenes under the specified scene directory. |
| [`setScenePath`](../reference/whiteboard-api/room-managementl#setscenepath)      | Switches to the specified scene.                             |
| [`setSceneIndex`](../reference/whiteboard-api/room-managementl#setsceneindex)     | Switches to the specified scene under the current scene directory. |
| [`moveScene`](../reference/whiteboard-api/room-managementl#movescene)         | Moves or renames a scene.                                    |
| [`removeScenes`](../reference/whiteboard-api/room-managementl#removescenes)      | Deletes a scene or a scene directory.                        |
| [`cleanCurrentScene`](../reference/whiteboard-api/room-managementl#cleancurrentscene) | Clears all contents on the current scene.                    |

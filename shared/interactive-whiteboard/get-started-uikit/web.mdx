...
- A web browser that meets the minimum version requirements in [SDK options](/en/whiteboard/product_whiteboard?platform=Web#sdk-options).

- A valid [Agora account](https://docs.agora.io/en/Agora%20Platform/sign_in_and_sign_up).

- An Agora project with the whiteboard service enabled. Get the App Identifier and SDK token from Agora Console. See [Enable and Configure Interactive Whiteboard Service](https://docs.agora.io/en/whiteboard/enable_whiteboard?platform=Web#get-security-credentials-for-your-whiteboard-project).
...
Call [/v5/rooms (POST)](https://docs.agora.io/en/whiteboard/en/whiteboard/whiteboard_room_management?platform=RESTful&versionId=4c630b90-a0e0-11eb-934a-83674cc9d04a#create-a-room-post) on your app server to create a room.
...
- Use code. See [Generate a Token from your app server](https://docs.agora.io/en/whiteboard/generate_whiteboard_token_at_app_server). (Recommended)
...
After experiencing the basic whiteboard functionality, you can call APIs of the Fastboard SDK to insert images, audio and video, and documents to the whiteboard. For detailed implementation instructions, see [Display Files](./present_files?platform=Web).

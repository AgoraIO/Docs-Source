...
- Your project integrates a version of the Chat SDK later than v1.0.3 and has implemented the basic <Link to="/agora-chat/get-started/get-started-sdk?platform={{platform.PATH}}">real-time chat functionalities</Link>.
...
<div class="alert note">Add-on fees are incurred if you use this feature. See <a href="/agora-chat/reference/pricing#optional-add-on-fee">Pricing</a> for details.</div>
## Understand the tech

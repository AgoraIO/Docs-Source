...
| Profanity filter | The profanity filter can detect and filter out profanities in messages according to the configurations you set. |
...
<Admonition type="info" title="Note">Content moderation powered by ActiveFence is currently in public beta. Moderation powered by Microsoft Azure is currently the default option. See [GA Agora website](https://docs.agora.io/en/agora-chat/develop/content-moderation) for details.</Admonition>

Agora Chat can scan messages for illegal and inappropriate text and image content, and mark the content for moderation. Active Fence uses the following categories to moderate:

- Text messages:

    - Harassment or bullying: Any language that is considered to be disrespectful, derogatory, or harmful to others.
    - Profanity: Messages containing language or words that are considered vulgar, offensive, or taboo in a particular culture or society. Profanity text can include swear words, curse words, racial slurs, sexually explicit language, or else.
    - Hate speech: Discrimination, hatred and/or incitement of violence towards individuals or groups based on their religion, ethnicity, gender, sexual orientation, social caste.
    - Child grooming: Images of sexual abuse of minors.
    - General violence: Texts containing incitement, and/or threat of violence against an individual or a group. These include physical, digital, political, and sexual violence, violence against animals or property, and depiction and glorification of violent acts.
    - Promoting terrorism: Any promotion or glorification of any ideology, individual, or organization associated with domestic or international terrorism.
    - Self-harm: Promotion, instruction, glorification of intentional self-injury, eating disorders, and/or suicide.
    - General adult content: Texts containing explicit or suggestive language or themes, often involving sexual content or nudity. Intended for mature audiences and may not be appropriate for children or individuals who are easily offended.
    - PII: The content contains personally identifiable information, which includes URLs, US bank numbers, social security numbers, International Bank Account Number (IBAN) codes, phone numbers, crypto, UK National Health Service (NHS) information, IP addresses, US passports, first and last names, email addresses, US driver licenses, and credit cards.

- Images:

    - Profanity: Images and videos containing physical gestures or body language that are used to insult, intimidate, or harass someone, or to express contempt or disrespect towards them.
    - Hate speech: Discrimination, hatred and/or incitement of violence towards individuals or groups based on their religion, ethnicity, gender, sexual orientation, social caste.
    - Child abuse: Images of sexual abuse of minors
    - Promoting terrorism: Any promotion or glorification of any ideology, individual or organization associated with domestic or international terrorism
    - General adult content: Images and videos containing commercial pornography, amateur pornography, child sexual abuse material (CSAM), sexting selfies, nudity, sex acts, greyscale pornographic images, sexually explicit cartoons and manga.
    - Swimwear adult content: Images and videos containing people wearing swim/beachwear, underwear and lingerie.
    - Graphic violence: Does not cover Socially Acceptable Violence (MMA, Boxing, Hunting, Fishing), animation, cartoons, or in-game violence.
    - Gambling: Images and videos containing gambling imagery and events, gambling advertising, casinos, lottery, online betting, slots, poker, blackjack, craps, roulette, and other games of chance.
    - Unauthorized sales (drugs): Images and videos containing illegal and legal drugs, drug use, drug paraphernalia, plants, and symbols relating to drugs.
    - Unauthorized sales (alcohol): Images and videos containing alcoholic brands and beverages, people drinking alcohol, frat parties, keg stands, bars and nightclubs, party aftermaths, shots, beer pong, kegs, and plastic cups associated with drinking alcohol.
    - Unauthorized sales (weapons): Images and videos containing rifles, machine guns, handguns, grenade launchers, swords, knives, and people holding handheld weapons.
...
2. To create a moderation rule, click **Add**:
...
The profanity filter can detect and filter out profanities in messages according to the configurations you set.
...
2. On the **Rule Config** page, you can add or delete words and determine which filtering method to apply to messages that contain the specified keywords. You can replace the word with \*\*\* or simply not send the word. You can add up to 100,000 words to the list, including by uploading a `.txt` file.

The SDK provides means to configure whether the sender of the filtered message will receive their masked message upon delivery to the recipient.

### Domain filter

The domain filter can detect and filter out certain domains in messages according to the configurations you set.

...
The <Vg k="UIK" /> does not provide a UI for `insertImage`. You need to implement the UI yourself.
...
The <Vg k="UIK" /> does not provide a UI for insertMedia. You need to implement the UI yourself.
...
The UI Kit also provides another insertDocs method for inserting and displaying documents. For details, see the <a href = "https://docs-preprod.agora.io/en/whiteboard/fastboard_api_web?platform=Web#insertdocs-22">API reference</a>.

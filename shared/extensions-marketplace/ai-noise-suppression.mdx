...
When <Vg k="RTEE_NS" /> is enabled, if <Vg k="VSDK" /> detects that the device performance is not sufficient, it will:

- Disable <Vg k="RTEE_NS" />
- Enable traditional noise reduction
- Throw the -1054(WARN_APM_AINS_CLOSED) error code.
</PlatformWrapper>

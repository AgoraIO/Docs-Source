...
| `name` | String | Required. The name of the custom transcoding template. This name must be different from the `name` of any [preset transcoding templates](./rest-api-transcoding-fls); otherwise, an error occurs. |
...
~5767b890-c15c-11ec-8e95-1b7dfd4b7cb0~
...
In the <Vg k="GET_STARTED"/> project you implemented, your <Vpl k="CLIENT" /> uses an authentication token obtained manually from <Vg k="CONSOLE" /> to join a channel. In a production environment, your <Vpl k="CLIENT" /> retrieves this token from a token server. This section shows you how to:

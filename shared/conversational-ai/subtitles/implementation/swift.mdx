...
1. **Implement subtitle UI rendering logic**
    ...
    Implement the `ConversationalAIAPIEventHandler` protocol in your subtitle UI module, and use the `onTranscriptionUpdated` method to handle and render subtitles to the UI.

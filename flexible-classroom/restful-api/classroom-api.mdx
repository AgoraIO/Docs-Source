...
Flexible Classroom Cloud Service uses tokens for authentication. You need to put the corresponding information into the `Authorization: agora token=` field when sending your HTTP request. For details, see [Secure authentication with tokens](../develop/authentication-workflow).
...
| Parameter  | Type    | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| :--------- | :------ | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `region`   | String  | (Required) The region for connection. For details, see [Network geofencing](../develop/classroom-security#network-geofencing). Flexible Classroom supports the following regions:<ul><li>`cn`: Mainland China.</li><li>`ap`: Asia Pacific.</li><li>`eu`: Europe.</li><li>`na`: North America.</li></ul>                                                                                                                                                                                                                                                                 |
| `appId`    | String  | (Required) Agora App ID.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |

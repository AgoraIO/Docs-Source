...
The Agora Interactive Whiteboard SDK provides the following methods in the `Room` interface for managing scenes:

| Methods             | Description                                                  |
| :------------------ | :----------------------------------------------------------- |
| [`SceneState`](https://docs.agora.io/en/whiteboard/API%20Reference/whiteboard_web/globals.html#scenestate)        | Gets the information of the currently displayed scene.       |
| [`entireScenes`](https://docs.agora.io/en/whiteboard/API%20Reference/whiteboard_web/interfaces/room.html#entirescenes)      | Gets the information of all scenes in the current room.      |
| [`scenePathType`](https://docs.agora.io/en/whiteboard/API%20Reference/whiteboard_web/interfaces/room.html#scenepathtype)     | Gets the type of the scene path.                             |
| [`putScenes`](https://docs.agora.io/en/whiteboard/API%20Reference/whiteboard_web/interfaces/room.html#putscenes)         | Inserts multiples scenes under the specified scene directory. |
| [`setScenePath`](https://docs.agora.io/en/whiteboard/API%20Reference/whiteboard_web/interfaces/room.html#setscenepath)      | Switches to the specified scene.                             |
| [`setSceneIndex`](https://docs.agora.io/en/whiteboard/API%20Reference/whiteboard_web/interfaces/room.html#setsceneindex)     | Switches to the specified scene under the current scene directory. |
| [`moveScene`](https://docs.agora.io/en/whiteboard/API%20Reference/whiteboard_web/interfaces/room.html#movescene)         | Moves or renames a scene.                                    |
| [`removeScenes`](https://docs.agora.io/en/whiteboard/API%20Reference/whiteboard_web/interfaces/room.html#removescenes)      | Deletes a scene or a scene directory.                        |
| [`cleanCurrentScene`](https://docs.agora.io/en/whiteboard/API%20Reference/whiteboard_web/interfaces/room.html#cleancurrentscene) | Clears all contents on the current scene.                    |
...
The following section extends the [Join a Whiteboard Room](https://docs.agora.io/en/whiteboard/join_whiteboard_room_web?platform=Web) sample code to show the implementation of scene management.
...
- `scenes`: An array of scenes. A single scene contains the following fields:
  ...
  - `ppt`: (Optional) The image or web page to be displayed in the scene. Each scene can display only one image or web page. You can also use [`PptDescription`](https://docs.agora.io/en/whiteboard/API%20Reference/whiteboard_web/globals.html?platform=All%20Platforms&changePlatformAlert=All%20Platforms#pptdescription) to set the width, height, resource path, or preview of the image or web page. 
...
Now you can call the two methods to switch to the new scenes inserted in the <a href="#add">Add scenes</a> section.
...
Once you grasp the basic operations of scenes, you can refer to [Display Files](/en/whiteboard/display_files?platform=Web&versionId=e4b782a0-1b78-11ec-8e65-856920855d60) for instructions on creating a set of scenes to display a complete file.

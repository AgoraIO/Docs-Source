...
* **New LLM provider**
    ...
    - [xAI Grok](/conversational-ai/models/llm/xai)
...
* Changes to [**Start a conversational AI agent**](/conversational-ai/rest-api/agent/join)
    ...
    * **New parameters**
        ...
        - [`properties.llm.credential_mode`](/conversational-ai/rest-api/agent/join#properties-llm-greeting-configs-interruptable): Sets managed mode for the vendor. You do not need to provide the API Key when using managed mode.

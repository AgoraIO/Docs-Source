...
1. **Other features**
   ...
   - A new method <Link to="{{Global.API_REF_FLUTTER_ROOT_VOICE_SDK}}/class_irtcengineex.html#api_irtcengineex_enableencryptionex">enableEncryptionEx</Link> is added for enabling media stream or data stream encryption in multi-channel scenarios.
   ...
   - A new method <Link to="{{Global.API_REF_FLUTTER_ROOT_VOICE_SDK}}/class_irtcengineex.html#api_irtcengineex_getcallidex">getCallIdEx</Link> is introduced for retrieving call IDs in multi-channel scenarios.
...
1. **Other improvements**
   ...
   - In <Link to="{{Global.API_REF_FLUTTER_ROOT_VOICE_SDK}}/enum_audioeffectpreset.html">AudioEffectPreset</Link>, a new enumeration `roomAcousticsChorus` (chorus effect) is added, enhancing the spatial presence of vocals in chorus scenarios.
...
- <Link to="{{Global.API_REF_FLUTTER_ROOT_VOICE_SDK}}/enum_audioeffectpreset.html">AudioEffectPreset</Link> adds `roomAcousticsChorus`, enhancing the spatial presence of vocals in chorus scenarios.

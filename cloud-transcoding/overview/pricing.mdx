...
|----------|----------------|-------------|
| **Subscription fee** | The duration when <Vg k="COMPANY" /> service subscribes to audio and video streams | Based on the actual duration of audio and video streams processed |
...
When outputting audio streams, audio processing fees apply. It is calculated as follows:

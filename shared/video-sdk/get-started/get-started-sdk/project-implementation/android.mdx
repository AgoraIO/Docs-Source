...
## Implement the Extensions Marketplace logic

The following figure shows the API call sequence of implementing Extensions Marketplace.

<ProductWrapper notAllowed="video-calling">
image::ils-call-logic-android.svg[]
</ProductWrapper>

<ProductWrapper product="video-calling">
image::video-call-logic-android.svg[]
</ProductWrapper>
...
3.  **Setup Agora Engine**
    ...
    To implement Agora Extensions Marketplace, you use Video SDK to create an Agora Engine instance. In `/app/java/com.example.<projectname>/MainActivity`, add the following code before `onCreate`.
...
7.  **Join the channel to start Extensions Marketplace**

...
1. Sign in to <Vg k="CONSOLE" />.
    ...
    This opens the Agora login page in your browser. Sign in and return to the terminal.

1. Use `agora init` to clone the official starter for your chosen template, bind it to your Agora project, and write the runtime-specific environment file.
...
- Explore the SDK API references for [Typescript](/conversational-ai/reference/sdk/typescript), [Python](/conversational-ai/reference/sdk/python), and [Go](/conversational-ai/reference/sdk/go).

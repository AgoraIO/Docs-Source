...
import CreateUI from '@docs/assets/code/video-sdk/get-started-sdk-create-ui-swift.mdx';
import ShowMessage from '@docs/assets/code/video-sdk/show-message.mdx';
import ViewDidDisappear from '@docs/assets/code/video-sdk/get-started-view-did-disappear.mdx';
...
1.  **Handle hardware permissions on the device**

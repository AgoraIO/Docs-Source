...
| `roomName`                                    | String  | (Required) The name of the classroom. The string length must be less than 64 characters                       |
...
| `roomProperties.flexProps`                    | Object |  (Optional) Initialize room properties.          |
| `roomProperties.widgets`                      | Object |  (Optional) In-room component setup.         |
| `roomProperties.widgets.netlessBoard`         | Object |  (Optional) In-room whiteboard component setup.            |
| `roomProperties.widgets.netlessBoard.state`   | Integer |  (Optional) The status of the whiteboard component in the room. Can be set to:：<ul><li>`0`: disable</li><li>`1`: enable</li></ul>.            |
| `roomProperties.widgets.easemobIM`            | Object |  (Optional) In-room chat room component settings.            |
| `roomProperties.widgets.easemobIM.state`      | Integer | (Optional) The state of the chat room component within the room. Can be set to:：<ul><li>`0`: disable</li><li>`1`: enable</li></ul>.            |
| `roleConfig`                                  | Object  | (Optional)	Role configuration.     |
| `roleConfig.2`                                | Object | (Optional) Student role configuration. |
| `roleConfig.2.limit`                          | Integer | (Optional) Student number limit.  |
| `roleConfig.2.defaultStream`                  | Object | (Optional) Student default flow configuration.  |
| `roleConfig.2.defaultStream.state`            | Integer | (Optional) Student default flow status. Can be set to:<ul><li>`0`: disable</li><li>`1`: enable</li></ul>. |
| `roleConfig.2.defaultStream.videoState`       | Integer | (Optional) Student default streaming video status. Can be set to: <ul><li>`0`: disable</li><li>`1`: enable</li></ul>.  |
| `roleConfig.2.defaultStream.audioState`       | Integer | (Optional) Student default streaming audio state. Can be set to: <ul><li>`0`: disable</li><li>`1`: enable</li></ul>.  |
...
| `appId` | String | (Required) Agora App ID.|
| `roomUuid` | String | (Required) The classroom ID. This is the globally unique identifier of a classroom. It is also used as the channel name when a user joins a channel. The string length must be less than 64 bytes. The following character sets are supported:<ul><li>All lowercase English letters: a to z.</li><li>All numeric characters: 0-9</li><li>The space character.</li><li>"!", "#", "$", "%",  "&", "(", ")", "+", "-", ":", ";", "\<",  "=", ".", ">", "?",  "@", "[", "]",  "^", "_",  "\{", "\}",  "\|",  "~", "," </li></ul>  |
| `extAppUuid` | String | (Required) The extApp ID. The string length must be less than 64 bytes. The following character sets are supported:<ul><li>All lowercase English letters: a to z.</li><li>All numeric characters: 0-9</li><li>The space character.</li><li>"!", "#", "$", "%",  "&", "(", ")", "+", "-", ":", ";", "\<",  "=", ".", ">", "?",  "@", "[", "]",  "^", "_",  "\{", "\}",  "\|",  "~", "," </li></ul>  |
...
| :----------- | :----- | :----------------------------------------------------------- |
| `properties` | Object | The user properties. |
| `common` | Object | The JSON object contains the following fields:<ul><li>`state`: Integer, the state of extApp. `0` means disabled, and `1` means enabled.</li></ul> |
| `cause` | Object | The update reason. |
...
| 429 | N/A | The interface is limited. |
...
| `startTime` | Number | Class start time, Unix timestamp (milliseconds), UTC time. When state=1, this field has a value. |
| `endTime` | Number | Class end time, Unix timestamp (milliseconds), UTC time. When state=2, this field has a value. |
| `closeTime` | Number | Class closing time, Unix timestamp (milliseconds), UTC time. When state=3, this field has a value. |

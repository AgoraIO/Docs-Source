...
Enable Cloud Proxy with the new optional `enableCloudProxy` parameter in `RtmConfig`. See <Link to="{{Global.SIG_SDK_API_WEB}}/interfaces/rtmconfig.html#enablecloudproxy">API reference</Link>.

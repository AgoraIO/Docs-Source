...
| `username` | String | The unique login account of the user. The user ID must be 64 characters or less and cannot be empty.  The following character sets are supported:<ul><li>26 lowercase English letters (a-z)</li><li>"\_", "-", "."</li></ul><Admonition type="info"><ul><li>Do not use any of the 26 uppercase English letters (A-Z).</li><li>Ensure that each `username` under the same App ID is unique.</li></ul></Admonition> | Yes |
...
```shell
curl -X POST -H 'Content-type: application/json' -H 'Accept: application/json' -H 'Authorization: Bearer <YourAppToken>' -d '{"usernames":["user1"], "mute_duration":86400000}' 'http://XXXX/app-id/XXXX/chatgroups/10130212061185/mute'
```
...
```json
{
    ...
    "uri": "http://XXXX/app-id/XXXX/chatgroups/10130212061185/mute",
    "entities": [],
    "data": [{
        "result": true,
...
```shell
DELETE https://{host}/app-id/{app_id}/chatgroups/{group_id}/mute/{member_id}
```
...
```shell
curl -X DELETE -H 'Accept: application/json' -H 'Authorization: Bearer <YourAppToken>' 'http://XXXX/app-id/XXXX/chatgroups/10130212061185/mute/user1'
```
...
```json
{
    "action": "delete",
    "application": "527cd7e0-XXXX-XXXX-9f59-ef10ecd81ff0",
    "uri": "http://XXXX/app-id/XXXX/chatgroups/10130212061185/mute/user1",
    "entities": [],
    "data": [{
        "result": true,
        "user": "user1"
...
```shell
curl -X GET -H 'Accept: application/json' 'http://XXXX/app-id/XXXX/chatgroups/10130212061185/mute' -H 'Authorization: Bearer <YourAppToken>'
```
...
```shell
curl -X POST -H 'Content-Type: application/json' -H 'Accept: application/json' -H 'Authorization: Bearer {Your app token}' 'http://XXXX/app-id/XXXX/chatgroups/{The group ID}/ban'
```
...
```json
{
    ...
    "uri": "http://XXXX/app-id/XXXX/chatgroups/1208XXXX5169153/ban",
    "entities": [],
    "data": {
        "mute": true
    },
...
```shell
curl -X DELETE -H 'Content-Type: application/json' -H 'Accept: application/json' -H 'Authorization: Bearer {Your app token}' 'http://XXXX/app-id/XXXX/chatgroups/1208XXXX5169153/ban'
```
...
```json
{
    "action": "put",
    "application": "527cd7e0-XXXX-XXXX-9f59-ef10ecd81ff0",
    "uri": "http://XXXX/app-id/XXXX/chatgroups/120824965169153/ban",
    "entities": [],
    "data": {
        "mute": false
    },

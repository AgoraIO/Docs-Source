...
After enabling and configuring Okta integration, you can choose to enable the Big Bang feature. In this case, login to Agora Console with email and password is no longer available and your team members can log in only via Okta. To enable this feature, contact [Agora support](mailto:support@agora.io).
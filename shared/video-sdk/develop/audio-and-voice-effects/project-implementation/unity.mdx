...
1. **Enable the user to start, stop, play, and pause audio mixing**
    ...
    For more detail, see the following:
        ...
        - <Link to="{{Global.API_REF_UNITY_ROOT}}/class_irtcengine.html#api_irtcengine_pauseaudiomixing">ResumeAudioMixing</Link>
...
1. **Configure sound effects, audio profile, and audio route**
    ...
    ```
    The `SetDefaultAudioRouteToSpeakerphone` and `SetDefaultAudioRouteToSpeakerphone` methods applies to Android and iOS only.

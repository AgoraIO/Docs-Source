...
1. **Add the extension to your project**
  ...
  obtained the certificate.
    ...
    1. Save the model and prop files you need from the resource package to the `/app/src/main/assets` folder in your project.
        ...
        For details of the files provided in the resource pack, see [Resource package structure](https://github.
  com/Faceunity/FULiveDemoDroid/blob/master/doc/Android_Nama_Demo_Guide.md#2-file-structure).

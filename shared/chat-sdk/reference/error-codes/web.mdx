...
| 27 | `WEBIM_CONNCTION_APPKEY_NOT_ASSIGN_ERROR` |  The App Key is invalid. Log in again using a valid App Key. For how to get the App Key, see [Get the information of the Agora Chat project](/agora-chat/get-started/enable#get-the-information-of-the-agora-chat-project). |

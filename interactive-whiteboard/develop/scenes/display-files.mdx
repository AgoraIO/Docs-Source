...
- Ensure the format of the converted images or web pages is supported by the <Vg k="WHITE_SDK" />.
  ...
  - Static images in PNG, JPG/JPEG, and WEBP formats converted from PPT, PPTX, DOC, DOCX, and PDF files. You can convert them yourself or use the [static-file conversion service](../reference/whiteboard-api/file-conversion#static-file-conversion) of <Vg k="WHITE" />.
  - HTML web pages converted from PPTX files. You must use the [dynamic-file conversion service](../reference/whiteboard-api/file-conversion#dynamic-file-conversion) of <Vg k="WHITE" /> to do the conversion.
...
- Complete file conversion and generate a set of URLs for the converted images or web pages. If you need to use the file-conversion feature of the <Vg k="WHITE" />, see [File Conversion Overview](../reference/whiteboard-api/file-conversion).
...
- Integrate the <Vg k="WHITE_SDK" /> into your project and implement joining a room. For details, see [Join a whiteboard room](../get-started/get-started-uikit#join-the-whiteboard-room)

## Implementation

The following section extends the [Join a whiteboard room](../get-started/get-started-uikit#join-the-whiteboard-room) sample code to show the creation of multiple scenes and the display of a six-page, animated PPTX file.
...
- [Start file conversion (POST)](../reference/whiteboard-api/file-conversion#start-file-conversion-post)
- [Query file conversion progress (GET)](../reference/whiteboard-api/file-conversion#query-the-progress-of-a-file-conversion-task)

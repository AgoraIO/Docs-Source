...
1. **Create a [new project](https://developer.android.com/studio/projects/create-project)** (Optional)
    ...
    1. Select Phone and Tablet > Empty Views Activity and click Next .
    1. Set the project name and storage path, select the language as Java, and click **Finish** to create the Android project.
...
<Tabs>
  ...
  <TabItem value="tab2" label="Manual integration">
    ...
    1. Select the file `/app/libs/agora-rtc-sdk.jar` inn the left navigation bar of Android Studio project files, right-click, and select **add as a library** from the drop-down menu.

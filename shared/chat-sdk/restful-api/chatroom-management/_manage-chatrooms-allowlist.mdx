...
This page shows how to manage a chat room allow list using the Agora Chat RESTful APIs. Before calling the following methods, ensure that you understand the call frequency limit described in [Limitations](../reference/limitations).

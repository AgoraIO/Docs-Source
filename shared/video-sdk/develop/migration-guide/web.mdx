...
- [What's changed](#whats-changed) between  <Vpd k="NAME"/> v<Vg k="VSDK_PREVIOUS_RELEASE" /> and v<Vg k="VSDK_RELEASE" />.

- [Core API change list](#core-api-change-list) between  <Vpd k="NAME"/> v<Vg k="VSDK_PREVIOUS_RELEASE" /> and v<Vg k="VSDK_RELEASE" />.

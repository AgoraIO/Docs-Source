...
The typical transmission pipeline for extensions in <Vg k="VSDK" /> consists of the following chain of stages.

![](/images/extensions-marketplace/ai-noise-suppression.png)

In the pre-processing stage, <Vg k="RTEE_NS"/> uses deep learning noise reduction algorithms to modify <audio src=""></audio> data in the pipeline.
...
1. To activate <Vg k="RTEE_NS" /> in your <Vpl k="CLIENT" /> contact support@agora.io.
</PlatformWrapper>

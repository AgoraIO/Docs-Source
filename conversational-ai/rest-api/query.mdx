...
<CodeItem language="bash" name="curl">{`curl --request get \\
  --url https://api.agora.io/cn/api/conversational-ai-agent/v2/projects/:appid/agents/:agentId \\
...
const url = "https://api.agora.io/cn/api/conversational-ai-agent/v2/projects/:appid/agents/:agentId";

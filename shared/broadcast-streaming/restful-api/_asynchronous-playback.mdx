...
<div class="alert note">Currently, the asynchronous playback function only supports <a href="./enable-fls?platform=RESTful">Push CDN mode</a>.</div>
...
<a name="http-code"></a>
## HTTP status code
~3ebbc600-0807-11ed-a46a-e58831549a58~
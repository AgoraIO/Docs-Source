...
1. **Develop your extension**
    ...
    - [Develop an audio extension](../develop/integrate/audio-filter)
    - [Develop a video extension](../develop/integrate/video-filter)
...
1. **Help developers easily integrate your extension into their <Vpl k="CLIENT" />**.
    ...
    Write the [Implementation guide](../develop/integrate/implementation-guide) for your extension

1. **Share provisioning, usage, and billing information with Agora**

    - [Provisioning API](../develop/integrate/provisioning)
    - [Usage and billing API](../develop/integrate/usage)

1. **Publish your extension**

    When your extension is thoroughly developed and tested, you need to submit it for Agora review and provide the finalized version of your extension listing assets. For details, see [Publish your extension](../develop/implement/publish-extension).

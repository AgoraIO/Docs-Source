...
| --- | --- | --- | --- |
| `to` | Array | An array of the group IDs that receive the message. Within one second, you can send a maximum of 20 messages to chat groups, and for each request, you can send messages to a maximum of 3 chat groups. | Yes |
...
| `payload.to` | String | The message recipient.<ul><li>For a one-to-one chat, it indicates the peer user that receives the message.</li><li>For a group chat, it indicates the chat group ID.</li><li> For a room chat, it indicates the chat room ID.</li></ul>|

...
2. Under **My Projects**, locate the project that has Chat enabled and click the **Edit** ✎ button.

4. On the project config page, select **Chat > Features** > **Push Certificate** and click **Add Push Certificate**.

    ![](/images/chat/configure-push-certificate-apple.png)

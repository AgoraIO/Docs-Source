...
* **New ASR, LLM, MLLM, and TTS providers**
    ...
    * ASR
        ...
        - [Google](/conversational-ai/models/asr/google)
        - [Amazon](/conversational-ai/models/asr/amazon)
        - [AssemblyAI](/conversational-ai/models/asr/assembly-ai)
    * LLM
        - [Groq](/conversational-ai/models/tts/groq)
        - [Amazon Bedrock](/conversational-ai/models/tts/amazon)
    * MLLM
        - [Gemini Live](/conversational-ai/models/mllm/gemini)
    * TTS
        ...
        - [PlayAI](/conversational-ai/models/tts/play-ht)
...
- [Start a conversational AI agent](/conversational-ai/rest-api/agent/join)
    ...
    - **New APIs**
        - Outbound Calls
            - [Initiate an outbound call](/conversational-ai/rest-api/outbound-call/start)
            - [Retrieve call records](/conversational-ai/rest-api/outbound-call/history)
            - [Hang-up a call](/conversational-ai/rest-api/outbound-call/hang-up)
            - [Retrieve call status](/conversational-ai/rest-api/outbound-call/status)

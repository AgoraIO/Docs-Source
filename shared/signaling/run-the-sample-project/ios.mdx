...
1.  Download the [<Vg k="SIG" />](https://github.com/AgoraIO/RTM) repository on Github, and locate the `Agora-RTM-Tutorial-iOS` folder or the `Agora-RTM-Tutorial-iOS-Objective-C` folder.

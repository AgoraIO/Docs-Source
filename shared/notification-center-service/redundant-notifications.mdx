...
1. Enable Agora <Vg k="NCS_LONG" />, and subscribe to RTC channel event callbacks. Best practice is to subscribe to the following event types according to your scenario:

    * In the `LIVE_BROADCASTING` profile: `103`, `104`, `105`, `106`, `111`, and `112`.
    * In the `COMMUNICATION` profile: `107`, `108`, `111`, and `112`.

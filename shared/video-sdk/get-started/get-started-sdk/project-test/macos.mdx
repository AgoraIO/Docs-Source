...
2. Allow the app to access the device's microphone and camera.
</ProductWrapper>
<ProductWrapper product="voice-calling">
2. Allow the app to access the device's microphone.
</ProductWrapper>

3. Install the app on a second macOS device. Open the app, join the same channel, and observe the test results.
    <ProductWrapper notAllowed="voice-calling">

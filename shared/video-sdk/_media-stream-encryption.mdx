...
In order to create the environment necessary to integrate media stream encryption into your <Vpl k="CLIENT" />, you need to:

-   Open the [Get started with <Vpd k="NAME"/>](../get-started/get-started) project you created previously.

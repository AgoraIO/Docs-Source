...
- A web browser that meets the [minimum version requirements](./en/whiteboard/product_whiteboard&versionId=bc4d9270-af10-11eb-b31a-57565fd331e4#supported-platforms).
- A valid [Agora account](https://docs.agora.io/en/Agora%20Platform/sign_in_and_sign_up).
- An Agora project with the whiteboard service enabled. Get the app identifier and SDK token from the Agora Console. See [Enable and Configure Interactive Whiteboard Service](../develop/enable-whiteboard).
...
- RESTful APIs:
  ...
  - [https://api.netless.link/v5/tokens/rooms/\{uuid} (POST)](./en/whiteboard/generate_whiteboard_token&versionId=1e4caf80-a0e1-11eb-934a-83674cc9d04a#generate-a-room-token-post)
- APIs of `WhiteWebSdk`
 - joinRoom

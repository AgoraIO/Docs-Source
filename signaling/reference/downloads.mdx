...
1. Download the Agora <Vg k="MESS_SDK" /> from https://download.agora.io/rtmsdk/release/Agora_RTM_SDK_for_Web_v1.5.0.zip. In the SDK folder, find the JS file in the libs folder, and save it to your project directory.
...
1. Download the latest [<Vg k="MESS_SDK" /> for Linux Java](https://download.agora.io/rtmsdk/release/Agora_RTM_SDK_for_Linux_Java_v1_5_0.zip) and decompress the file. Copy the `*.so` file and the `*.jar` file to the `lib` folder.
...
1. Download the latest version of [<Vg k="MESS_SDK" /> (Linux C++)](https://download.agora.io/rtmsdk/release/Agora_RTM_SDK_for_Linux_v1_5_0.zip) and extract the files. Copy the `*.so` file in the SDK folder into your `lib` folder, and copy the `*.h` file in the SDK folder into your `include` folder.
...
1. Unzip the latest version of <Vg k="MESS_SDK" /> to a local directory.
...
1. Download and extract the latest version of the [Agora <Vg k="MESS_SDK" />](https://download.agora.io/sdk/release/Agora_Unity_RTM_SDK_1.4.10_20220726_163.zip).

...
See the [LiveBroadcasting](https://github.com/AgoraIO/API-Examples/windows/APIExample/APIExample/Basic/LiveBroadcasting) sample project to update the code in your app.
...
- Custom video source/Custom video renderer: [CustomVideoCapture](https://github.com/AgoraIO/API-Examples/windows/APIExample/APIExample/Advanced/CustomVideoCapture)

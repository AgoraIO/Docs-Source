...
|`context`|The context.|
|`appid`|Your Agora project's App ID. If your Agora project has enabled Token authentication, you can also assign this parameter to an RTC Token. See [Get App ID](todo)for details.|
...
|`use_string_uid`| Whether to use String user IDs. - `0`: Do not use. - `1`: Use.|

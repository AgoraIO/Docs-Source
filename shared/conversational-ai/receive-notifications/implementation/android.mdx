...
1. **Integrate the subtitle processing toolkit**
    ...
    Copy the [`convoaiApi`](https://github.com/Shengwang-Community/Conversational-AI-Demo/tree/main/Android/scenes/convoai/src/main/java/io/agora/scene/convoai/convoaiApi) folder to your project and import the toolkit before calling its API. Refer to [Toolkit Structure](#toolkit-structure) to understand the role of each file.

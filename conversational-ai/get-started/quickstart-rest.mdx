...
- Implemented the [voice](/voice-calling/get-started/get-started-sdk) or [video](/video-calling/get-started/get-started-sdk) calling quickstart. Sample client: [LINK-HERE]

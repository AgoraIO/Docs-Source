...
1. **Portrait center stage**
   ...
   To enhance the presentation effect in online meetings, shows, and online education scenarios, this version introduces the  <Link to="{{Global.API_REF_IOS_ROOT}}/api-ref/rtc/ios/API/toc_center_stage#api_irtcengine_enablecameracenterstage">enableCameraCenterStage</Link> method to activate the portrait center stage. This ensures that presenters, regardless of movement, always remain centered in the video frame, achieving better presentation effects.

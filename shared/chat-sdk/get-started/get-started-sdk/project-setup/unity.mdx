...
1. Go to the [SDK download page](https://docs-preprod.agora.io/en/agora-chat/downloads?platform=All%20Platforms), and download the latest version of the Agora Chat SDK package for Unity, and decompress it.

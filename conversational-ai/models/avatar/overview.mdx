...
1. Specify the configuration in the request body as `properties` > `avatar` when [Starting a conversational AI agent](/conversational-ai/rest-api/join)
...
* **Billing and usage**: AI avatars incur video streaming costs in addition to provider fees. Review the pricing models of both [Agora's Realtime Communication](/realtime-communication/overview/pricing) services and your chosen avatar provider to understand total costs.
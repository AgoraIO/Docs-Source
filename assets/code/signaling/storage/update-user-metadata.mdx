...
<PlatformWrapper platform={['ios','macos']}>
    ...
    - <Link to="{{Global.SIG2_SDK_API_IOS}}/rtmstorage/rtmmetadataitem/init(key:value:revision:)">RtmMetadataItem(key:value:revision:)</Link>
    ...
    - <Link to="{{Global.SIG2_SDK_API_MACOS}}/rtmstorage/rtmmetadataitem/init(key:value:revision:)">RtmMetadataItem(key:value:revision:)</Link>

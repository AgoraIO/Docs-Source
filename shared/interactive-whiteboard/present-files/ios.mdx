...
The UI Kit does not provides a UI for <code>insertImg</code>. You need to implement the UI yourself.
...
The UI Kit does not provides a UI for <code>insertMedia</code>. You need to implement the UI yourself.

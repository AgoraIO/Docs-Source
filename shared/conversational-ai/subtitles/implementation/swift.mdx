...
1. **Integrate the subtitle processing toolkit**
    ...
    Copy the [`ConversationalAIAPI`](https://github.com/Shengwang-Community/Conversational-AI-Demo/tree/main/iOS/Scenes/ConvoAI/ConvoAI/ConvoAI/Classes/ConversationalAIAPI) folder to your project and import the toolkit before calling the toolkit APIs. Refer to [Toolkit Structure](#toolkit-structure) to understand the role of each file.
...
1. **Create a subtitle processing toolkit instance**
    ...
    To enable subtitle transcription, first create configuration objects for the <vg k="VSDK"/> and Chat SDK instances. Then set the subtitle rendering mode, and finally, create the Conversational AI component instance.

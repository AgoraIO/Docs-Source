...
Once you grasp the basic operations of scenes, you can refer to [Display Files](/interactive-whiteboard/develop/scenes/display-files) for instructions on creating a set of scenes to display a complete file.

...
* Activated the stream channel capability in <Vg k="SIG" />. For activation, raise a [support ticket](https://agora-ticket.agora.io/). The <Vg k="COMPANY" /> support team confirms activation through a ticket update.

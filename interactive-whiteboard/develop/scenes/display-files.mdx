...
- [putScenes](../reference/whiteboard-api/room-managementl#putscenes)
- [setScenePath](../reference/whiteboard-api/room-managementl#setscenepath)
- [setSceneIndex](../reference/whiteboard-api/room-managementl#setsceneindex)

...
- **MCP tool calls**: When the agent invokes tools through [MCP servers](/conversational-ai/rest-api/agent/join), response times can increase significantly. Filler words bridge this gap while the agent waits for tool results.
...
- An Agora [account](/conversational-ai/get-started/manage-agora-account) and project with Conversational AI enabled. 
- A working Conversational AI agent. If you don't have one yet, follow the [quickstart](/conversational-ai/get-started/quickstart) to set one up.

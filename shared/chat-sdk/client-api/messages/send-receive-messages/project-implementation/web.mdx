...
By default, two minutes after a user sends a message, they can withdraw it. You can change this time frame and extend it no longer than 7 days in Agora Console. See [Enable and configure Chat](../../get-started/enable).

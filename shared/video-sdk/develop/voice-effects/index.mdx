...
Before proceeding with the code examples on this page, make sure you have completed the [SDK quickstart](/realtime-communication/get-started/get-started-sdk) guide.

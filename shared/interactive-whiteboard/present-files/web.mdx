...
The Agora UI Kit provides the [`insertImage`](/en/whiteboard/fastboard_api_web?platform=Web#insertimage) method for inserting and displaying an image in the main window of the whiteboard. You can call this method and pass in the URL of the image to display a specified image.

### Prerequisites

Before you start, make sure you meet the following requirements:

- Integrate the Agora UI Kit in your project, and join the room. See [Join a Whiteboard Room](./join_whiteboard_room_web_fastboard?platform=Web).
...
<div class = "alert info">The UI Kit does not provides a UI for insertImage. You need to implement the UI yourself.</div>

## Play audio and video

The Agora UI Kit integrates the media player extension and provides the [`insertMedia`](/en/whiteboard/fastboard_api_web?platform=Web#insertmedia) method for playing audio and video files. You can simply call `insertMedia` and pass in the audio and video file name and URL to play the audio and video in a sub-window on the whiteboard.
...
<div class = "alert info">The UI Kit does not provides a UI for insertMedia. You need to implement the UI yourself.</div>

## Present documents

The Agora UI Kit integrates the docs viewer and slide extensions and provides the [`insertDocs`](/en/whiteboard/fastboard_api_web?platform=Web#insertdocs-12) method for presenting documents. You can simply call `insertDocs` and pass the parameters of a document to present the document in a paginated format in a sub-window on the whiteboard. The implementation workflow is as follows:
...
- Ensure the format of the converted images or web pages is supported by the Agora UI Kit.

    The Agora UI Kit supports inserting and displaying images or web pages in the following formats:
...
<div class = "alert info">The UI Kit also provides another insertDocs method for inserting and displaying documents. For details, see the <a href = "https://docs-preprod.agora.io/en/whiteboard/fastboard_api_web?platform=Web#insertdocs-22">API reference</a>.</div>

...
- [Enabled Agora conversational AI](/conversational-ai/get-started/manage-agora-account#enable-conversational-ai) for your project.
- The following information from <Vg k="CONSOLE" />:
    - [App ID](/conversational-ai/get-started/manage-agora-account#get-the-app-id): The string identifier for your project used to call the <Vpd k="NAME" /> RESTful API.

...
| Usage type                              | Hosts <br></br>(< 400ms latency)                       | Audience <br></br> <Vg k="ILSP"/> (400 – 800ms latency) | Hosts <br></br>(< 400ms latency)| Audience <br></br> <Vg k="ILSS"/>  (1,500 – 2,000ms latency) |
| --------------------------------------- | ------------------------------------------------------ | ------------------------------------------------------- | -------------------------------------------------- |

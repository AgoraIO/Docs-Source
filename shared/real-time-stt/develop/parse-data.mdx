...
1. Copy the following Protobuf definition to a local `SttMessage.proto` file:
    ...
    message Text {
      ...
      int64 uid = 4;        
      int64 time = 6;       // The start time of the transcription of this segment
      repeated Word words = 10;         // An array of transcription results
      int32 duration_ms = 12;           // The time taken to transcribe, in milliseconds.
      string data_type = 13;            // transcribe or translate
      repeated Translation trans = 14;  // An array of translation results.
      string culture = 15;              // The source language of the transcription.
      int64 text_ts = 16;               // The timestamp of the transcription used to align the source and target text during real-time translation.
      MultilingualTranscript multilingual_transcript = 18;       // original transcript of multilingual translation
    }
    ...
    message MultilingualTranscript {    
      string culture = 1;

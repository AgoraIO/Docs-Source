...
The following figure shows the video data transmission process when you perform custom video capture in push mode:

![Custom video source](/images/video-sdk/custom-video-capture-apple.png)

1. Call `setExternalVideoSource` to enable custom video capture.
1. Use SDK external methods to implement the collection module yourself.
1. Send the collected video frames to the SDK through the `pushExternalVideoFrame` method.
...
* Publish to a single channel
    ...
    ![Custom video source](/images/video-sdk/publish-custom-tracks-in-a-channel.png)

* Publish to multiple channels

    ![Custom video source](/images/video-sdk/publish-custom-tracks-in-multiple-channels.png)
</PlatformWrapper>

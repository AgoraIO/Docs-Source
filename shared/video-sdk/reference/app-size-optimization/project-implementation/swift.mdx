...
<Tabs>
<TabItem value="all" label="Use all extensions" default>
...
<TabItem value="none" label="Don't use any extension" default>
<CodeBlock language="ruby" >
{`# platform :ios, '9.0'
target 'Your App' do
...
<TabItem value="some" label="Use some extensions" default>
<CodeBlock language="ruby" >
{`# platform :ios, '9.0'
target 'Your App' do

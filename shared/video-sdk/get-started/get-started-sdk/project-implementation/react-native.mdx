...
To ensure that you receive all events from the moment the engine starts, call `registerEventHandler` immediately after [initializing the engine](#initialize-the-engine).
</Admonition>

...
1.  Download and extract the latest version of the [Agora RTM SDK]({rootdir}/{local_product}/reference/downloads.html).
...
**MessageManager.cs sample code**
    ...
    namespace io.agora.rtm.quickstart
    {
        public class MessageManager : MonoBehaviour
        {
            ...
            // Callback when the connection state changes between the SDK and the Agora RTM system

...
export const RELEASE = '4.0.0-beta.2'
...
export const API_REF_ANDROID_ROOT  = `${API_REF_ROOT}/android/${RELEASE}/API`;
export const API_REF_ANDROID_ROOT_VOICE_SDK = `${API_REF_ROOT_VOICE_SDK}/android/${RELEASE}/API`;
...
export const API_REF_IOS_ROOT = `${API_REF_ROOT}/ios/${RELEASE}/API`;
export const API_REF_IOS_ROOT_VOICE_SDK = `${API_REF_ROOT_VOICE_SDK}/ios/${RELEASE}/API`;
export const API_REF_RN_ROOT  = `${API_REF_ROOT}/react-native/${RELEASE}/API`;
export const API_REF_RN_ROOT_VOICE = `${API_REF_ROOT_VOICE_SDK}/react-native/${RELEASE}/API`;
export const API_REF_MACOS_ROOT = `${API_REF_ROOT}/macos/${RELEASE}/API`;
export const API_REF_MAC_ROOT_VOICE_SDK = `${API_REF_ROOT_VOICE_SDK}/macos/${RELEASE}/API`;
export const API_REF_FLUTTER_ROOT = `${API_REF_ROOT}/flutter/${RELEASE}/API`;
export const API_REF_FLUTTER_ROOT_VOICE_SDK = `${API_REF_ROOT_VOICE_SDK}/flutter/${RELEASE}/API`;
...
export const API_REF_ELECTRON_ROOT  = `${API_REF_ROOT}/electron/${RELEASE}/API`;
export const API_REF_ELECTRON_ROOT_VOICE_SDK  = `${API_REF_ROOT_VOICE_SDK}/electron/${RELEASE}/API`;
export const API_REF_CPP_ROOT  = `${API_REF_ROOT}/cpp/${RELEASE}/API`;
export const API_REF_CPP_ROOT_VOICE_SDK  = `${API_REF_ROOT_VOICE_SDK}/cpp/${RELEASE}/API`;

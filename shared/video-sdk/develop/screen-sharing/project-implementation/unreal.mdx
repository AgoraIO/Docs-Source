...
To enable <Vg k="SCR_SHR" />, choose one of the following methods according to your scenario:
...
The flow diagram and implementation steps in this article are based on the first scenario.
...
Depending on your application scenario, choose one of the following <Vg k="SCR_SHR" /> methods.

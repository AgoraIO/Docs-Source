...
![rtc-channel](https://agora-doc.s3.us-east-1.amazonaws.com/images/extensions-marketplace/active-fence.svg)
...
1. **Customize your callback fields**
    ...
    <Vg k="RTEE_AF" /> allows you to add custom fields for your callbacks. Take the following steps to add custom callback fields:
        ...
        1. Press **Add Field** and choose **EDITABLE** to open an **Add an editable field** window.
            ...
            ![Add an editable field](https://agora-doc.s3.us-east-1.amazonaws.com/images/extensions-marketplace/active-fence-add-an-editable-field.png)

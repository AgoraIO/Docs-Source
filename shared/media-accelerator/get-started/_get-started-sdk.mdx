...
The Internet of things (IoT) is a network of physical objects with sensors, processing ability, software and other technologies that connect and exchange data with other devices. In several important applications, IoT devices must send or receive audio and video streams to perform their function. <Vpd k="PRODUCT" /> enables you to implement real-time audio and video stream transmission and intercommunication in IoT devices with a small SDK size, low memory usage, and low power consumption.
...
Receive video feed by mobile apps from one or multiple cameras.

Perform two-way audio communication between mobile apps and cameras.

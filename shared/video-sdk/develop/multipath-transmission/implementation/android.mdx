...
Multipath network transmission requires permission to read and modify the device network status. You must add the following permissions to the Android project’s `/app/src/main/AndroidManifest.xml` file:

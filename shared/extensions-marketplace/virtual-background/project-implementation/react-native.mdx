...
1. **Declare the variables you need**
    ...
    To cycle through different virtual background modes, in `App.tsx`, add the following to variable declarations:
...
1. **Use a state variable to track whether virtual background is enabled**

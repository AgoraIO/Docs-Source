...
1. Specify the configuration in the request body as `properties` > `asr` when [Starting a conversational AI agent](/conversational-ai/rest-api/agent/join)
...
- [AssemblyAI (Beta)](assembly-ai)
- [Amazon Transcribe (Beta)](amazon)
- [Google (Beta)](google)

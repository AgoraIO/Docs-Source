...
- [`onAgentStateChanged`](/conversational-ai/reference/toolkit/android#onagentstatechanged)
- [`onAgentInterrupted`](/conversational-ai/reference/toolkit/android#onagentinterrupted)
- [`onAgentMetrics`](/conversational-ai/reference/toolkit/android#onagentmetrics)
- [`onAgentError`](/conversational-ai/reference/toolkit/android#onagenterror)
</TabItem>
...
- [`onAgentStateChanged`](/conversational-ai/reference/toolkit/ios#onagentstatechanged)
- [`onAgentInterrupted`](/conversational-ai/reference/toolkit/ios#onagentinterrupted)
- [`onAgentMetrics`](/conversational-ai/reference/toolkit/ios#onagentmetrics)
- [`onAgentError`](/conversational-ai/reference/toolkit/ios#onagenterror)
</TabItem>

...
- When using Agora cloud proxy, refer to [Connect to Agora through a restricted network](../core-functionality/cloud-proxy)
</ProductWrapper>
</ProductWrapper>
</ProductWrapper>
</ProductWrapper>
...
|Destination ports |Port type |Operation |
|---|---|---|
|443; 6443; 9591; 9593; 9601; 27387 |TCP |Allow |
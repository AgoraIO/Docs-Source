...
Agora provides an [open source custom LLM project](https://github.com/Shengwang-Community/Conversational-AI-Server-Sample) on GitHub for your reference. Download the project or view the source code for a more complete example.

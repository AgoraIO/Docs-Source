...
This retrieves up to 100 conversations per API call by default. Contact support@agora.io if you want to adjust this limit. Agora Chat server can store up to 3,000 conversation per end user.

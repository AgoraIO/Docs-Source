...
To add more fun to event, you can enable virtual gift sending with the Agora <Vg k="MESS_SDK" />. An audience member can send virtual gifts to the host. All members in the live streaming room can see the gift.

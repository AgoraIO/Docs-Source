...
1. **Test the dual steam functionality**
    ...
    Click **High Video Quality**. The <Vpl k="CLIENT" /> moves the video to the larger frame and switches the video quality to high. Tap on the remote video in the larger frame. Click the same button to switch back to the low quality stream.

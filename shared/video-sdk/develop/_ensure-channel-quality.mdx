...
To test the code presented on this page, you need to:

* Set up the [Video SDK reference app](../get-started/get-started-sdk#project-setup) for <Vg k="VSDK" />.
</PlatformWrapper>
...
To test functionality in the **Call quality best practice** example:

1. **Launch the web demo for testing**

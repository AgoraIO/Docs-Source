...
In the modified message, the message ID remains unchaged and only the message content is edited and the following items are added: operator ID, operation time, the number of modification times.

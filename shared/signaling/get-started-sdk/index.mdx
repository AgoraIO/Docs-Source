...
synchronization capabilities for real-time systems into your <Vpl k="CLIENT" />. You can also use <Vg k="SIG" /> to enhance the user experience for <Vg k="VIDEO" />, <Vg k="AUDIO" />,  <Vg k="ILS" />, and <Vg k="BS" />.

This page shows you how to easily integrate pub-sub messaging into your <Vpl k="CLIENT" /> using <Vg k="MESS_SDK" />. For information about stream channels where users communicate using topics in a channel, see [Stream channel quickstart](/en/signaling/develop/stream-channel).

...
If you want to customize the classroom UI based on the default UI of Flexible Classroom, you need to integrate Flexible Classroom by downloading the [source code](https://github.com/AgoraIO-Community/CloudClass-AndroidHub. Refer to the following steps:
...
1. [Integrate Flexible Classroom into your own project](integrate-flexible-classroom/) through Maven.

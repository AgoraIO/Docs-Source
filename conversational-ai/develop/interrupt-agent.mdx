...
- Integrate <Vg k="VSDK" /> v4.5.1 or later and follow the [Quickstart](/realtime-communication/get-started/get-started-sdk) guide to implement basic real-time audio and video features.

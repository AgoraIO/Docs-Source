...
In order to create the environment necessary to integrate Chat UI sample into your app, do the following:
...
5. Integrate the UI sample into your project.
   ...
   1. Create a Podfile for your project.
      ...
      pod init
      ```
   2. Add dependencies to the UI sample in the Podfile.
  ...
  The Chat UI sample is now added into your project.

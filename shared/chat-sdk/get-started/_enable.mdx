...
- An [Agora project](/video-calling/reference/manage-agora-account#create-an-agora-project) that uses  **APP ID + Token** as its authentication.
- An Agora Chat pricing plan. For how to subscribe to a plan, see <Link to="../reference/pricing?platform={{platform.PATH}}#subscribe-to-the-pricing-plan">Subscribe to the pricing plan</Link>.
...
- <Link to="../client-api/content-moderation/moderation-overview?platform={{platform.PATH}}">Moderation</Link>

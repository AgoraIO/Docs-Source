...
During <Vpd k="NAME"/> sessions, hosts use the <Vg k="SCR_SHR" /> feature in the <Vg k="COMPANY" /> <Vg k="VSDK" /> to share their screen content with other users or viewers in the form of a video stream. Screen sharing is typically used in the following use-cases:
...
This page shows you how to implement <Vg k="SCR_SHR" /> in your <Vpl k="CLIENT" />.

## Understand the tech

The <Vg k="SCR_SHR" /> feature provides the following <Vg k="SCR_SHR" /> modes for use in various use-cases:

<details>
<summary>Screen sharing use-cases</summary>

![Screen Sharing Functionality](https://agora-doc.s3.us-east-1.amazonaws.com/images/video-sdk/screen-sharing-functionality.png)
</details>
...
<PlatformWrapper platform="macos, windows, unreal">
...
<PlatformWrapper notAllowed="{['macos','android','unreal','web','react-native','unity','windows']}">
## Set up your project
<ProjectSetup/>
</PlatformWrapper>

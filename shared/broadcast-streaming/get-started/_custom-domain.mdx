...
- [Enable Broadcast Streaming](./enable-fls?platform=RESTful) in Agora Console.
- Decide an [FLS mode](#mode) according to your business scenario.
...
Agora supports both RTMP and RTMPS. For details, see [Construct the URL for pushing a live stream](./streaming-url-fls?platform=RESTful#construct-the-url-for-pushing-a-live-stream).

### Step 2: Push the live stream

To push an RTMP/RTMPS stream, you can choose one of the following methods:

- Use streaming software, such as OBS. See [Streaming Software Configuration](./obs-config-fls?platform=RESTful).
- Use the Media Push RESTful API to convert live streams within an Agora channel to an RTMP/RTMPS stream. See [Media Push RESTful API Reference](https://docs-preprod.agora.io/en/Interactive%20Broadcast/streaming_restful?platform=All%20Platforms).

### Step 3: Construct the URL for playing the live stream

Agora supports RTMP, HTTP-FLV, and HLS. For details, see [Construct the URL for playing a live stream](./streaming-url-fls?platform=RESTfu).
...
- [Stream pushing/playing authentication](https://docs-preprod.agora.io/en/fusion-cdn-streaming/rest-api-authentication-fls?platform=RESTful)
- [Transcoding](https://docs-preprod.agora.io/en/fusion-cdn-streaming/rest-api-transcoding-fls?platform=RESTful)
- [Snapshot and content moderation](https://docs-preprod.agora.io/en/fusion-cdn-streaming/rest-api-snapshot-fls?platform=RESTful)
- [Stream management](https://docs-preprod.agora.io/en/fusion-cdn-streaming/rest-api-stream-admin-fls?platform=RESTful)

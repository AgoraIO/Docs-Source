...
1. Create a new folder containing the `index.tsx` and `index.css` files.
...
2. Import this component in the interactive small class scene file:
...
Add an event handling method for `_handleClassroomEvent`:

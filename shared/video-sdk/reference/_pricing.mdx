...
* [Cloud proxy](/video-calling/advanced-features/cloud-proxy#pricing)

## Standard minutes calculator

The Standard minutes calculator helps you estimate usage of Standard minutes based on the number of hosts, their published streams, and the number of audience members in a channel. Use this tool to understand the pricing policy and estimate your monthly usage.

<details>
<summary>Standard Minutes Calculator</summary>

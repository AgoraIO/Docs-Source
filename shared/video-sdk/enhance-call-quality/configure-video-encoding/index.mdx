...
Video resolution affects billing. If you set 1280×720 but network conditions 
force adaptation to 640×360, you're billed for 640×360 (the actual subscribed 
resolution), not your initial setting.
</Admonition>
...
| Use case | Resolution | Frame rate | Bitrate | Notes |
|-----------|-------------|-------------|----------|-------|
| One-to-one call | 640×360 | 15 fps | 400 Kbps | Clear video, moderate bandwidth |
| One-to-many call | 320×240 | 15 fps | 200 Kbps | Smaller windows, conserve bandwidth |
| Screen sharing | 1280×720 | 15 fps | 1200 Kbps | High resolution for text clarity |

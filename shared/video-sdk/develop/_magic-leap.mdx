...
<details>
<summary>Magic Leap <Vg k="VIDEO"/> workflow</summary>

![Video Calling Web UIKit](https://agora-doc.s3.us-east-1.amazonaws.com/images/video-calling/video-call.svg)
</details>
</ProductWrapper>

<ProductWrapper product="interactive-live-streaming">
<details>
<summary>Magic Leap <Vg k="ILS"/> workflow</summary>

![Video Calling Web UIKit](https://agora-doc.s3.us-east-1.amazonaws.com/images/interactive-live-streaming/get-started-sdk-livestreaming.png)
</details>
...
- To ensure communication security in a test or production environment, best practice is to use a token server to ensure communication security, see [Secure authentication with tokens](../token-authentication/authentication-workflow).

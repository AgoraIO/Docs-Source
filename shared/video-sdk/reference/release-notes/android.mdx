...
1. **Wide and ultra-wide cameras**
   ...
   To allow users to capture a broader field of view and more complete scene content, this release introduces support for wide and ultra-wide cameras. You can first call <Link to="{{Global.API_REF_ANDROID_ROOT}}//api-ref/rtc/android/API/toc_video_device#api_irtcengine_querycamerafocallengthcapability">queryCameraFocalLengthCapability</Link> to check the device's focal length capabilities, and then call <Link to="{{Global.API_REF_ANDROID_ROOT}}/class_irtcengine.html#api_irtcengine_setcameracapturerconfiguration">setCameraCapturerConfiguration</Link> and set `cameraFocalLengthType` to the supported focal length types, including wide and ultra-wide.
...
1. **Multi-camera capture**
   ...
   1. Support for specifying cameras by camera ID:
      ...
      - New method <Link to="{{Global.API_REF_ANDROID_ROOT}}//api-ref/rtc/android/API/toc_video_device#api_irtcengine_switchcamera2">switchCamera [2/2]</Link> supports switching cameras by `cameraId`, allowing apps to dynamically adjust camera usage during runtime based on available cameras.
...
1. **Other features**
   ...
   - New method <Link to="{{Global.API_REF_ANDROID_ROOT}}//api-ref/rtc/android/API/toc_network#api_irtcengineex_enableencryptionex">enableEncryptionEx</Link> is added for enabling media stream or data stream encryption in multi-channel scenarios.
   - New method <Link to="{{Global.API_REF_ANDROID_ROOT}}//api-ref/rtc/android/API/toc_audio_mixing#api_irtcengine_setaudiomixingplaybackspeed">setAudioMixingPlaybackSpeed</Link> is introduced for setting the playback speed of audio files.
   - New method <Link to="{{Global.API_REF_ANDROID_ROOT}}//api-ref/rtc/android/API/toc_network#api_irtcengineex_getcallidex">getCallIdEx</Link> is introduced for retrieving call IDs in multi-channel scenarios.
...
- <Link to="{{Global.API_REF_ANDROID_ROOT}}//api-ref/rtc/android/API/toc_speech_driven#api_imediaengine_registerfaceinfoobserver">registerFaceInfoObserver</Link>
- <Link to="{{Global.API_REF_ANDROID_ROOT}}//api-ref/rtc/android/API/class_ifaceinfoobserver">IFaceInfoObserver</Link>
- <Link to="{{Global.API_REF_ANDROID_ROOT}}//api-ref/rtc/android/API/toc_speech_driven#callback_ifaceinfoobserver_onfaceinfo">onFaceInfo</Link>
...
- <Link to="{{Global.API_REF_ANDROID_ROOT}}//api-ref/rtc/android/API/toc_network#api_irtcengineex_getcallidex">getCallIdEx</Link>
- <Link to="{{Global.API_REF_ANDROID_ROOT}}//api-ref/rtc/android/API/toc_network#api_irtcengineex_enableencryptionex">enableEncryptionEx</Link>
- <Link to="{{Global.API_REF_ANDROID_ROOT}}//api-ref/rtc/android/API/toc_audio_mixing#api_irtcengine_setaudiomixingplaybackspeed">setAudioMixingPlaybackSpeed</Link>
- <Link to="{{Global.API_REF_ANDROID_ROOT}}//api-ref/rtc/android/API/toc_video_device#api_irtcengine_querycamerafocallengthcapability">queryCameraFocalLengthCapability</Link>
- <Link to="{{Global.API_REF_ANDROID_ROOT}}//api-ref/rtc/android/API/class_focallengthinfo">AgoraFocalLengthInfo</Link>
- <Link to="{{Global.API_REF_ANDROID_ROOT}}//api-ref/rtc/android/API/enum_camerafocallengthtype">CAMERA_FOCAL_LENGTH_TYPE</Link>
...
- <Link to="{{Global.API_REF_ANDROID_ROOT}}//api-ref/rtc/android/API/toc_video_device#api_irtcengine_switchcamera2">switchCamera [2/2]</Link>
- <Link to="{{Global.API_REF_ANDROID_ROOT}}/">EAR_MONITORING_FILTER_BUILT_IN_AUDIO_FILTERS</Link>

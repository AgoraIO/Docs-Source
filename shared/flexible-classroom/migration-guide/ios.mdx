...
Follow the steps in [Integrate Flexible Classroom into Your App](/en/agora-class/agora_class_integrate_ios#change_default_ui) to re-integrate Flexible Classroom v1.1.5.

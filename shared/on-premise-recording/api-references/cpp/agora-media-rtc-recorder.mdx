...
|-----------------|-------------------------------------|---------------------------------------------------------------------------------------------------|
| `agora_service` | `base::IAgoraService*`              | Agora service object; ensure it has been initialized. See [`IAgoraService`](agora-service).   |
...
| `config`      | `const EncryptionConfig&`           | Encryption configuration. See [`EncryptionConfig`](struct#encryptionconfig).                          |
...
| Parameter                 | Type                                              | Description                                                                                     |
|---------------------------|---------------------------------------------------|-------------------------------------------------------------------------------------------------|
| `subscriptionOptions`     | `const agora::rtc::VideoSubscriptionOptions&`   | Video subscription options. See [`VideoSubscriptionOptions`](struct#videosubscriptionoptions).     |
...
| `subscriptionOptions`    | `const VideoSubscriptionOptions&`                 | Video subscription options. See [`VideoSubscriptionOptions`](struct#videosubscriptionoptions).     |
...
| Parameter | Type                                | Description                                                                                     |
|-----------|-------------------------------------|-------------------------------------------------------------------------------------------------|
| `layout`  | `const VideoMixingLayout&`         | Layout configuration for the mixed video stream. See [`VideoMixingLayout`](struct#videomixinglayout). |
...
| Parameter | Type                                                            | Description                                                                                     |
|-----------|-----------------------------------------------------------------|-------------------------------------------------------------------------------------------------|
| `config`  | `const media::MediaRecorderConfiguration&`                     | Recorder configuration. See [`MediaRecorderConfiguration`](struct#mediarecorderconfiguration).     |
...
| Parameter             | Type                               | Description                                                                                     |
|-----------------------|------------------------------------|-------------------------------------------------------------------------------------------------|
| `watermark_configs`   | `WatermarkConfig*`                 | Array of watermark configurations. See [`WatermarkConfig`](struct#watermarkconfig).               |
...
| Parameter | Type                                       | Description                                                                                                    |
| --------- | ------------------------------------------ | -------------------------------------------------------------------------------------------------------------- |
| `config`  | `const media::MediaRecorderConfiguration&` | Configuration of the recorder instance. See [`MediaRecorderConfiguration`](struct#mediarecorderconfiguration). |
...
| Parameter           | Type               | Description                                                                            |
| ------------------- | ------------------ | -------------------------------------------------------------------------------------- |
| `watermark_configs` | `WatermarkConfig*` | An array of watermark configurations. See [`WatermarkConfig`](struct#watermarkconfig). |
| `num`               | `int`              | Number of watermark configurations.                                                    |
...
| Parameter | Type                                  | Description                                                                                                 |
| --------- | ------------------------------------- | ----------------------------------------------------------------------------------------------------------- |
| `handler` | `IAgoraMediaRtcRecorderEventHandler*` | The event handler instance. See [`IAgoraMediaRtcRecorderEventHandler`](agora-media-rtc-recorder-eventhandler). |
...
| Parameter | Type                                   | Description                                                                                                               |
| --------- | -------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- |
| `config`  | `const LocalAccessPointConfiguration&` | The configuration of the local access point. See [`LocalAccessPointConfiguration`](struct#localaccesspointconfiguration). |

...
import ProjectTest from '@docs/shared/extensions-marketplace/ai-noise-suppression/project-test/react-js.mdx';
...
<PlatformWrapper platform="web,react-js ,android, ios, macos">
<ProjectImplement />
</PlatformWrapper>

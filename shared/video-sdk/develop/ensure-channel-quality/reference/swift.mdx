...
- <Link to="{{Global.API_REF_IOS_ROOT_RTC_KIT}}/agoralastmileproberesult">AgoraLastmileProbeResult</Link>

- <Link to="{{Global.API_REF_IOS_ROOT_RTC_KIT}}/agorartcremotevideostats">AgoraRtcRemoteVideoStats</Link>

- <Link to="{{Global.API_REF_IOS_ROOT_RTC_KIT}}/agorartclocalvideostats">AgoraRtcLocalVideoStats</Link>

- <Link to="{{Global.API_REF_IOS_ROOT_RTC_KIT}}/agoravideosourcetype">AgoraVideoSourceType</Link>
</PlatformWrapper>
<PlatformWrapper platform="macos">
- <Link to="{{Global.API_REF_MACOS_ROOT_RTC_KIT}}/agoralastmileproberesult">AgoraLastmileProbeResult</Link>

- <Link to="{{Global.API_REF_MACOS_ROOT_RTC_KIT}}/agorartcremotevideostats">AgoraRtcRemoteVideoStats</Link>

- <Link to="{{Global.API_REF_MACOS_ROOT_RTC_KIT}}/agorartclocalvideostats">AgoraRtcLocalVideoStats</Link>

- <Link to="{{Global.API_REF_MACOS_ROOT_RTC_KIT}}/agoravideosourcetype">AgoraVideoSourceType</Link>
</PlatformWrapper>

...
Before using a feature of <Vpd k="NAME"/>, subscribe to a [pricing plan](./pricing) that enables the feature.

# Investigation Tool

## Call Inspector

**Call Inspector** helps you search calls and analyze quality issues. See [Call Inspector](../analyze/call-inspector/call-search) for details.
...
Big Channel helps you monitor and analyze quality issues of Big Channels in real time, improving the operational efficiency of user activities in Big Channels. For details, see [Big Channel](../analyze/call-inspector/big-channel).
...
**Data Insights** provides statistics on the usage and quality of your project over a specified period of time. See [Data Insights](../analyze/data-insight) for details.
...
**Real-time Monitoring** provides visualized data for multiple call metrics in real time. See [Real-time Monitoring](../analyze/monitor) for details.
...
-   Data synchronization with [Call Inspector](../analyze/call-inspector/call-search) and [Data Insights](../analyze/data-insight), so that you can easily dive into problem analysis.

![1635496901316](https://web-cdn.agora.io/docs-files/1635496901316)

# Alert Notifications

**Alert Notifications** sends alerts to you when abnormal metrics or events are detected in your Agora <Vg k="VSDK" /> projects. See [Alert Notifications](../analyze/alarm) for details.

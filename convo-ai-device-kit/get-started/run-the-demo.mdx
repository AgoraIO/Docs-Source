...
description: >
  Run the Agora Convo AI Device Kit demo project.
---

Agora has partnered with Wi-Fi chip manufacturers to release the R1 open-source development kit based on RiseLink's BK7258 chip. To try the sample or review the source code, view the GitHub repository.
...
1. **Wake the device**: Short press the middle button (S2) to start a conversation with the AI agent.

1. **End the conversation**: After the conversation, short press the middle button (S2) to exit the conversation with the AI Agent.
...
[Convo AI Device Kit sample](https://github.com/AgoraIO-Community/Conversational-AI-IOT-Sample)

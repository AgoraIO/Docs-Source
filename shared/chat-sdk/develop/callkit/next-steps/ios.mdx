...
To enhance communication security, Agora recommends that you authenticate app users with the <Vg k="VSDK" /> token before they join a call. To do this, you need to make sure that the [Primary Certificate of your project is enabled](../reference/manage-agora-account#enable-the-primary-certificate), and `enableRTCTokenValidate` in the AgoraChatCallKit is set to `YES`.

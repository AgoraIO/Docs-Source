...
To create the environment necessary to integrate custom audio in your <Vpl k="CLIENT" />, open the <Link to="../get-started/get-started-sdk">Get Started with <Vpd k="NAME"/></Link>. project you created previously.

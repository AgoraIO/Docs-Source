...
- `value`: Object. Contains the following fields:
    ...
    ![Avatar dress up tab1](https://web-cdn.agora.io/doc-cms/uploads/1708415768849-dress1.png)
    
    </TabItem>
    <TabItem value="v2" label="Set 2">
    ...
    [Avatar dress up tab2](https://web-cdn.agora.io/doc-cms/uploads/1708415915330-dress2.png)
    </TabItem>
    </Tabs>

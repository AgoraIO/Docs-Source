...
1.  Point your AI assistant to `skills/agora/`. 
    ...
    - **Claude Code (project-level, shared with team):**
    ...
    - **Cursor:** Copy or symlink `skills/agora/` into `.cursor/rules/`.
    ...
    - **Any other tool:** The skill files are plain markdown. Point your tool to `skills/agora/` or load individual files directly. Use `SKILL.md` as the entry point.

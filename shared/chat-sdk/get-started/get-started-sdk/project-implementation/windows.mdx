...
To add the UI framework to your <Vpl k="NAME"/> project, In Solution Explorer, open `<project-name>` **>** `MainWindow.
  xaml`, then replace the file contents with the following:

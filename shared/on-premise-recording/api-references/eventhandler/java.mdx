...
| API | Description |
|---|---|
| [`onConnected`](#onconnected) | Triggered when the connection state changes to `CONNECTION_STATE_CONNECTED(3)`. |
| [`onDisconnected`](#ondisconnected) | Triggered when the connection state changes to `CONNECTION_STATE_DISCONNECTED(1)`. |
| [`onReconnected`](#onreconnected) | Triggered when the connection is re-established (`CONNECTION_STATE_CONNECTED(3)`). |
...
| [`onAudioVolumeIndication`](#onaudiovolumeindication) | Reports active speakers, their volumes, and whether the local user is speaking. |
| [`onActiveSpeaker`](#onactivespeaker) | Triggered when an active speaker is detected. |
| [`onRemoteVideoStats`](#onremotevideostats) | Reports remote video statistics. |
| [`onRemoteAudioStats`](#onremoteaudiostats) | Reports remote audio statistics. |
| [`onRecorderInfoUpdated`](#onrecorderinfoupdated) | Triggered when recording information is updated. |
| [`onEncryptionError`](#onencryptionerror) | Triggered when an encryption error occurs. |
| [`onError`](#onerror) | Reports error messages and error codes. |
| [`onTokenPrivilegeWillExpire`](#ontokenprivilegewillexpire) | Triggered 30 seconds before the Token expires. |
| [`onTokenPrivilegeDidExpire`](#ontokenprivilegedidexpire) | Triggered when the Token has expired. |

...
1. Retrieve the following information:
    ...
    - The secret assigned to the callback rule. You can find it on the callback rule list on the **Callback** page on the [Agora console](https://console.agora.io/).
		...
		![](https://agora-doc.s3.us-east-1.amazonaws.com/images/chat/callback_secret.png)
...
3. Choose **Features** > **Callback** and click **Add Callback Address** on the **Callback** page.
	  ...
	  ![](https://agora-doc.s3.us-east-1.amazonaws.com/images/chat/callback_addr_list.png)
		
4. To add a rule for pre-delivery callbacks, fill the following fields under the **Pre Send** tab and then click **Save**:

     ![](https://agora-doc.s3.us-east-1.amazonaws.com/images/chat/pre-delivery-callback.png)
...
5. To add a rule for post-delivery callbacks, fill the following fields under the **Post Send** tab and then click **Save**:
     ...
     ![](https://agora-doc.s3.us-east-1.amazonaws.com/images/chat/post-delivery-callback.png)

     ![](https://agora-doc.s3.us-east-1.amazonaws.com/images/chat/post-delivery-callback-advanced.png)
...
![](https://agora-doc.s3.us-east-1.amazonaws.com/images/chat/pre_delivery_callback.png)
</details>
...
![](https://agora-doc.s3.us-east-1.amazonaws.com/images/chat/post_delivery_callback.png)
</details>

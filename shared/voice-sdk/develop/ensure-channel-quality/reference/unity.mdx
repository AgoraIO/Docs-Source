...
<Vg k="SDK" /> provides the following audio profile options:


#### List of audio scenarios

<Vg k="SDK" /> provides the following audio scenarios to choose from:
...
- <Link to="{{global.API_REF_UNITY_ROOT_VOICE_SDK}}/class_irtcengine.html#ariaid-title118">SetAudioProfile</Link>

- <Link to="{{global.API_REF_UNITY_ROOT_VOICE_SDK}}/rtc_api_data_type.html#class_lastmileprobeconfig">LastmileProbeConfig</Link>

- <Link to="{{global.API_REF_UNITY_ROOT_VOICE_SDK}}/class_irtcengine.html#api_startlastmileprobetest">StartLastmileProbeTest</Link>

- <Link to="{{global.API_REF_UNITY_ROOT_VOICE_SDK}}/class_irtcengineeventhandler.html#callback_onlastmilequality">OnLastmileQuality</Link>

- <Link to="{{global.API_REF_UNITY_ROOT_VOICE_SDK}}/class_irtcengineeventhandler.html#ariaid-title56">OnRtcStats</Link>

- <Link to="{{global.API_REF_UNITY_ROOT_VOICE_SDK}}/class_irtcengineeventhandler.html#ariaid-title45">OnNetworkQuality</Link>

- <Link to="{{global.API_REF_UNITY_ROOT_VOICE_SDK}}/class_irtcengineeventhandler.html#ariaid-title37">OnLastmileProbeResult</Link>

- <Link to="{{global.API_REF_UNITY_ROOT_VOICE_SDK}}/class_irtcengineeventhandler.html#ariaid-title22">OnConnectionStateChanged</Link>

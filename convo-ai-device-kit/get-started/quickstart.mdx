...
The device connects to the hotspot automatically. For complete network configuration options, including connecting to your existing WiFi network, see [Network configuration](../get-started/#network-configuration).
...
1. Say "Hi, AGORA"
2. Wait 3-5 seconds for eye screen activation. When the device is ready, the red LED stops blinking.
3. Use the following sample voice commands to test the device:
    • "Tell me about Agora?"
    • "Who is Bill Gates?"

...
Call invitation is a communication protocol based on the peer-to-peer messaging functionality of the Agora RTM SDK. Call invitation supports starting, ending, accepting, and refusing calls. 

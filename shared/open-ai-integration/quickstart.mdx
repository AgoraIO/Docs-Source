...
This guide will walk through the [Agora Conversational Ai Demo](https://github.com/AgoraIO/agora-openai-converse) core elements of Integrating Agora's Python SDK with OpenAi's Realtime API:

1. Download the [Agora Conversational Ai Demo code](https://github.com/AgoraIO/agora-openai-converse).

1. The project is structured:

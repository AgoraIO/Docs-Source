...
3. To launch a classroom, call [AgoraEduSDK.config](../../client-api/classroom-sdk#config) and [AgoraEduSDK.launch](../../reference/classroom-sdk#launch) in the JavaScript code of the project.

...
If the API call fails, the SDK reports an error code and description through the `errorCode` and `reason` properties of <code>{config.errorinfo[props.ag_platform]}</code>. Refer to the [error codes table](/signaling/reference/error-codes) to get more information about the error.
...
The `errorCode` and `reason` properties report the error code and description, respectively. Refer to the [error codes table](/signaling/reference/error-codes) to get more information about the error.
...
To find the cause of the error and get the corresponding solution, lookup the `ErrorCode` value in the [error codes table](/signaling/reference/error-codes).
...
<PlatformWrapper platform="linux-cpp, windows">
Refer to the [error codes table](/signaling/reference/error-codes) to get more information about the error.
</PlatformWrapper>

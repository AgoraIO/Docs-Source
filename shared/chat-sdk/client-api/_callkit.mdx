...
import Understand from '@docs/shared/chat-sdk/client-api/callkit/understand/index.mdx';
import Prerequisites from '@docs/shared/chat-sdk/client-api/callkit/prerequisites/index.mdx';
import ProjectSetup from '@docs/shared/chat-sdk/client-api/callkit/project-setup/index.mdx';
import ProjectImplement from '@docs/shared/chat-sdk/client-api/callkit/project-implementation/index.mdx';
import NextSteps from '@docs/shared/chat-sdk/client-api/callkit/next-steps/index.mdx';
import Reference from '@docs/shared/chat-sdk/client-api/callkit/reference/index.mdx';

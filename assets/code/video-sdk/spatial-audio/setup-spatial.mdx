<PlatformWrapper platform={["ios","macos"]}>
    ...
    - <Link to="{{Global.API_REF_IOS_ROOT_RTC_KIT}}/agorartcenginekit/setaudioprofile(_:)">setAudioProfile(_:scenario:)</Link>
    - <Link to="{{Global.API_REF_IOS_ROOT_RTC_KIT}}/agorartcenginekit/enablespatialaudio(_:)">enableSpatialAudio(_:)</Link>
    ...
    - <Link to="{{Global.API_REF_IOS_ROOT_RTC_KIT}}/agorartcenginekit/mutelocalaudiostream(_:)">muteLocalAudioStream(_:)</Link>
    - <Link to="{{Global.API_REF_IOS_ROOT_RTC_KIT}}/agorartcenginekit/muteallremoteaudiostreams(_:)">muteAllRemoteAudioStreams(_:)</Link>
    ...
    - <Link to="{{Global.API_REF_MACOS_ROOT_RTC_KIT}}/agorartcenginekit/setaudioprofile(_:)">setAudioProfile(_:scenario:)</Link>
    - <Link to="{{Global.API_REF_MACOS_ROOT_RTC_KIT}}/agorartcenginekit/enablespatialaudio(_:)">enableSpatialAudio(_:)</Link>
    ...
    - <Link to="{{Global.API_REF_MACOS_ROOT_RTC_KIT}}/agorartcenginekit/mutelocalaudiostream(_:)">muteLocalAudioStream(_:)</Link>
    - <Link to="{{Global.API_REF_MACOS_ROOT_RTC_KIT}}/agorartcenginekit/muteallremoteaudiostreams(_:)">muteAllRemoteAudioStreams(_:)</Link>

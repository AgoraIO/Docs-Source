...
> If you use other Agora products or services in the web page being recorded, such as the [Agora Video SDK](../../video-calling/overview/product-overview), [Agora Interactive Whiteboard SDK](../../whiteboard/understand/overview), or [Agora <Vg k="MESS" /> SDK](../../real-time-messaging/understand/product-overview), expect additional charges. See the pricing documentations of each product or service for details.

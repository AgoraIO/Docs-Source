...
Providers marked **Beta** support only *text* mode and do not support *word* mode for [transcript rendering](/conversational-ai/reference/toolkit/android#transcriptrendermode).
</Admonition>
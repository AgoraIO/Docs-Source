...
- Implemented the [Realtime Communication](/realtime-communication/get-started/get-started-sdk) .
...
- Implemented the [Realtime Communication Quickstart](/realtime-communication/get-started/get-started-sdk).

    <Admonition type="info">
    For the best conversational experience, <Vg k="COMPANY" /> recommends using <Vpd k="NAME" /> with specific SDK versions. For details, [contact technical support](mailto:support@agora.io).
    </Admonition>

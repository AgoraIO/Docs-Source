...
Agora <Vg k = "VSDK"/> for Magic Leap allows you to integrate real-time <Vpd k="PRODUCT" /> features into your Magic Leap applications. You can enhance the overall user experience and add new possibilities for collaboration and interaction within Magic Leap environments. 
...
This section explains how you can integrate <Vpd k="PRODUCT" /> features into your magic leap project using <Vpd k="SDK" />. The following figure shows the workflow you need to integrate this feature into your <Vpl k="CLIENT" />.
...
This section shows how to use the <Vpd k="SDK" />  to implement <Vpd k="PRODUCT" /> into your magic leap project, step-by-step.

...
- <Link to="{{Global.API_REF_MACOS_ROOT}}/agorartckit/agorartcenginekit/pushexternalaudioframesamplebuffer(_:)">pushExternalAudioFrameSampleBuffer</Link>
...
3. **Spatial audio effects usability improvement**
   ...
   - This release optimizes the design of the <Link to="{{Global.API_REF_MACOS_ROOT}}/agorartckit/agorabasespatialaudiokit/setzones(_:)">setZones</Link> method, supporting the ability to set the `zones` parameter to `NULL`, indicating the clearing of all echo cancellation zones.

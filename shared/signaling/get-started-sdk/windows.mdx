...
Complete the following steps to integrate the Agora <Vg k="SIG_SDK" /> into your project.

1. Configure the project files.

- Go to [SDK Downloads](https://docs.agora.io/en/Agora%20Platform/downloads), download the latest version of the RTM C++ SDK for Windows, and unzip the downloaded SDK package.
...
int main(int argc, const char * argv[]) {
	...
	// Select the created RTM instance
	while (true) {
...
Generating a token by hand is not helpful in a production context. [Authenticate Your Users with Tokens](https://docs.agora.io/en/Real-time-Messaging/rtm_token?platform=Windows) shows you how to start real-time messaging with a token that you retrieve from your server.

## See also

### Sample project

Agora also provides an open-source [sample project](https://github.com/AgoraIO/RTM/tree/master/Agora-RTM-Tutorial-Windows) on GitHub for your reference.

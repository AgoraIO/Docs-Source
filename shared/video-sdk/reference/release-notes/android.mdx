...
This enables developers to facilitate developers to optimize the indicators and improve the user experience.
...
- The stability of the virtual background is improved depending on whether the portrait is still or moving, effectively eliminating the problem of background flickering and exceeding the range of the picture.
...
- A larger variety of postures are now recognized, when half of the body is motionless, the body is shaking, the hands are swinging, or there is a fine finger movement. This helps to achieve a good virtual background effect in conjunction with many different gestures.

...
Before you start troubleshooting, you should be familiar with [Call Details Breakdown](./call-inspector/call-search-detail).
...
1. Check whether the sender stopped the local video: Go to the [Call details homepage](./call-inspector/call-search-detail), find the **Key events** of the sender, and switch to the list view. Look for the **user stopped local video** event under the **Video sending** category. If you find such an event, contact the sender to confirm the operation.
 ![](https://web-cdn.agora.io/docs-files/1658831859143)

2. Check the sender's network conditions: Go to the [Sender details page](./call-inspector/call-search-detail), and find the network status and device status metrics.
...
2. Check the receiver's network conditions: Go to the [End-to-end details page](./call-inspector/call-search-detail), and find the network status and device status metrics.
...
1. Check whether the sender muted the local audio: Go to the [Call details homepage](./call-inspector/call-search-detail), find the **Key events** of the sender, and switch to the list view. Look for the **user muted local audio** event under the **Audio sending** category. If you find such an event, contact the sender to confirm the operation.
 ![](https://web-cdn.agora.io/docs-files/1658832926530)


2. Check the sender's network conditions: Go to the [Sender details page](./call-inspector/call-search-detail), and find the network status metrics.
...
2. Check the receiver's network condition: Go to the [End-to-end details page](./call-inspector/call-search-detail), and find the network status and audio freezing metrics.

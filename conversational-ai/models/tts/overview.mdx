...
1. Specify the configuration in the request body as `properties` > `tts` when [Starting a conversational AI agent](../../rest-api/join)
...
|----------|----------|
| [Microsoft](microsoft) | [Microsoft Azure TTS](https://learn.microsoft.com/en-us/azure/ai-services/speech-service/text-to-speech) |
| [ElevenLabs](elevenlabs) | [ElevenLabs TTS](https://elevenlabs.io/docs/capabilities/text-to-speech) |
| [Cartesia](cartesia) | [Cartesia TTS](https://docs.cartesia.ai/2025-04-16/build-with-cartesia/models/tts) |
| [OpenAI](openai) | [OpenAI TTS](https://platform.openai.com/docs/guides/text-to-speech) |

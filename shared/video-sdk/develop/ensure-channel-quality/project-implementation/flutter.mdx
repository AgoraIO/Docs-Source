...
To enable <Vpl k="CLIENT" /> users to see the network status, add `TextView`s to the user interface. To do this, open `/app/res/layout/activity_main.xml` and add the following lines after `ListView(...children: [`:

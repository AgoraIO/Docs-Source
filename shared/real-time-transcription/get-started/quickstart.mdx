...
--data '{
    ...
    "rtcConfig": {
        ...
        "subBotUid": "{<YourSubscribeBotUid>}",        // The unique UID for the audio subscription bot.
        ...
        "pubBotUid": "{{textUID}}",                // The unique UID for the text publishing bot. subBotUid and pubBotUid must be different.
        "subBotToken":"{{audioUIDChannelToken}}",  // The RTC token for pubBot to join the RTC channel. Use admin token. Optional, based on the RTC channel security configuration.
    },
}'
```

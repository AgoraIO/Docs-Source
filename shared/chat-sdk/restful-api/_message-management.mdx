...
The default time limit for recalling a message is two minutes. You can extend this time frame to up to 7 days in Agora Console. See [Enable and configure Chat](../../get-started/enable).

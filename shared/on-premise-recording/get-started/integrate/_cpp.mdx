...
4. If your firewall restricts access to the Agora services, use [cloud proxy service](https://docs.agora.io/en/Recording/cloudproxy_recording?platform=Linux).

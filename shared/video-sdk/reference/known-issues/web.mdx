...
- On Safari 16.x, screen sharing automatically changes the channel resolution to 1920 * 1080, even when the
  ...
  practice is to check the (User Agent)[https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/User-Agent] and
  suggest the user changes to a different browser.

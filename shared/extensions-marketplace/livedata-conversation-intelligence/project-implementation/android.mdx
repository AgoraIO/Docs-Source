...
2. **Integrate the extension**
    ...
    1. From the [Extensions Marketplace](https://console.agora.io/marketplace/list/all), download the <Vpl k="NAME" /> extension package of the <Vg k="RTEE_LDCI" /> extension. Unzip the package and save all `.aar` files to the `/app/libs` path in your project folder.

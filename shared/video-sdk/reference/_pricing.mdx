...
- **Host**: the price for audio and video minutes are:
...
- **Audience**:
  ...
  - **Low latency audience member**: A user with the audience user role and the low latency user level is an audience member. The price for audio and video minutes are:
  ...
  - **Ultra low latency audience**: A user with the audience user role and `audienceLatencyLevel` set to  `AUDIENCE_LATENCY_LEVEL_ULTRA_LOW_LATENCY` is charged at the same rate as the host.
...
<PlatformWrapper platform="android">
    In scenarios involving screen sharing, the unit price of the screen-sharing stream is calculated on the basis of the video dimension that you set in <Link to="{{Global.API_REF_ANDROID_ROOT_VOICE_SDK}}/rtc_api_data_type.html#class_screencaptureparameters2">ScreenCaptureParameters</Link>.
</PlatformWrapper>
<PlatformWrapper platform="ios">
    In scenarios involving screen sharing, the unit price of the screen-sharing stream is calculated on the basis of the video dimension that you set in <Link to="{{Global.API_REF_IOS_ROOT_VOICE_SDK}}/rtc_api_data_type.html#class_screencaptureparameters2">ScreenCaptureParameters</Link>.
</PlatformWrapper>
<PlatformWrapper platform="web">
In scenarios involving screen sharing, the unit price of the screen-sharing stream is calculated on the basis of the video dimension that you set in <Link to="{{Global.API_REF_WEB_ROOT_VOICE_SDK}}/interfaces/screenvideotrackinitconfig.html">ScreenVideoTrackInitConfig</Link>.
</PlatformWrapper>
<PlatformWrapper platform="macos">
    In scenarios involving screen sharing, the unit price of the screen-sharing stream is calculated on the basis of the video dimension that you set in <Link to="{{Global.API_REF_MAC_ROOT_VOICE_SDK}}/rtc_api_data_type.html#class_screencaptureparameters2">ScreenCaptureParameters</Link>.
</PlatformWrapper>
<PlatformWrapper platform="windows">
    In scenarios involving screen sharing, the unit price of the screen-sharing stream is calculated on the basis of the video dimension that you set in <Link to="{{Global.API_REF_CPP_ROOT_VOICE_SDK}}/rtc_api_data_type.html#class_screencaptureparameters2">ScreenCaptureParameters</Link>.
</PlatformWrapper>
<PlatformWrapper platform="electron">
    In scenarios involving screen sharing, the unit price of the screen-sharing stream is calculated on the basis of the video dimension that you set in <Link to="{{Global.API_REF_ELECTRON_ROOT_VOICE_SDK}}/rtc_api_data_type.html#class_screencaptureparameters">ScreenCaptureParameters</Link>.
</PlatformWrapper>
<PlatformWrapper platform="unity">
    In scenarios involving screen sharing, the unit price of the screen-sharing stream is calculated on the basis of the video dimension that you set in <Link to="{{Global.API_REF_UNITY_ROOT_VOICE_SDK}}/rtc_api_data_type.html#class_screencaptureparameters">ScreenCaptureParameters</Link>.
</PlatformWrapper>
<PlatformWrapper platform="flutter">
    In scenarios involving screen sharing, the unit price of the screen-sharing stream is calculated on the basis of the video dimension that you set in <Link to="{{Global.API_REF_FLUTTER_ROOT_VOICE_SDK}}/rtc_api_data_type.html#class_screencaptureparameters2">ScreenCaptureParameters</Link>.
</PlatformWrapper>
<PlatformWrapper platform="react-native">
    In scenarios involving screen sharing, the unit price of the screen-sharing stream is calculated on the basis of the video dimension that you set in <Link to="{{Global.API_REF_RN_ROOT_VOICE}}/rtc_api_data_type.html#class_screencaptureparameters2">ScreenCaptureParameters</Link>.
</PlatformWrapper>

...
Creates an instance of [`AgoraService`](agora-service) and initializes the native components.
...
Returns the native handle associated with this [`AgoraService`](agora-service) instance.

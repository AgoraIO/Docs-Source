...
Refer to the fully featured [AgoraChat-UIKit-flutter](https://github.com/AgoraIO-Usecase/AgoraChat-UIKit-flutter) demo app as an implementation reference.

To customize the UI Kit refer to the following:

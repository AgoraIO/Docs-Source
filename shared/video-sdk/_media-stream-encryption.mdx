...
To ensure that you have implemented <Vg k="COMPANY" /> media stream encryption in your <Vpl k="CLIENT" />, take the following steps:

1.  **Add the 32-byte encryption key to your <Vpl k="CLIENT" />**
    ...
    2.  Update the `encryptionKey` variable with the returned string.

2.  **Add the 32 byte, base 64 salt to your <Vpl k="CLIENT" />**

    To specify the base 64 encryption salt:
    ...
    2.  Update the `encryptionSaltBase64` variable with the returned string.

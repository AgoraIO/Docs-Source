...
## Get Agora Interactive Whitrboard SDK
...
>You can find the latest SDK version number in [Release Notes](/en/whiteboard/release_whiteboard_android).
...
- `appId`: The App Identifier of the whiteboard project in Agora Console. See [Get security credentials for your whiteboard project](/en/whiteboard/enable_whiteboard).

...
- The project integrates a version of the Agora Chat SDK later than v1.0.3 and has implemented the <Link to="../get-started/get-started-sdk?platform={{platform.PATH}}">basic real-time chat functionalities</Link>.
- You understand the API call frequency limit as described in [Limitations](../reference/limitations).

<div class="alert info">The reaction feature is supported by all types of [Pricing Plans](../reference/pricing-plan-details) and is enabled by default once you have enabled Chat in <a href="https://console.agora.io/">Agora Console</a>.</div>
...
Reactions are also supported in the [Chat Starter Kit](../get-started/get-started-uikit), which contains a wider range of emojis. You can also use the Starter Kit to implement reactions in your project.
</PlatformWrapper>
</PlatformWrapper>
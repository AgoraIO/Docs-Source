...
In addition to integrating the Agora Chat SDK into your project with mavenCentral, you can also manually download the [Chat SDK for Android](/sdks?platform=android).

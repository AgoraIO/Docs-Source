...
import Examples from '@docs/shared/cloud-recording/rest-api/start-examples.mdx';
...
<PathParameter name="mode" type="string" required={true} possibleValues="raw,mix,web">
The recording mode:

...
1. Log in to [iOS Developer Center](https://developer.apple.com/)，choose **Account** > **Certificates, Identifiers & Profiles** > **Identifiers**.
...
1. Open [iOS Developer Center](https://developer.apple.com/)，select **Account** > **Certificates, Identifiers & Profiles** > **Profiles*.

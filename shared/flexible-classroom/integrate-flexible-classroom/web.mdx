...
1. Add the following code to the HTML file in your project:
    ...
    ```html
    <!-- Replace X.Y.Z with the Flexible Classroom version number, such as 2.9.10.
...
<head>
    ...
    <!-- Introducing SDK, 2.9.10 is the sample version number, you can check the latest version number through the release notes or GitHub warehouse branch  -->
...
1. [Checkout the latest release branch](https://github.com/AgoraIO-Community/flexible-classroom-desktop/tree/release/2.9.10).
...
<html lang="en">
  <head>
    ...
    <script src="https://download.agora.io/edu-apaas/release/proctor_sdk@1.0.10.bundle.js"></script>
    ...
    <script src="https://download.agora.io/edu-apaas/release/proctor_widget@1.0.10.bundle.js"></script>
  </head>

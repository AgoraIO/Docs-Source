...
This section is based on v3.7.0 and introduces the main changes of v4.0.0 compared to v3.7.0 in the following categories. You need to update the code of your app according to your business use-case.
    ...
    If the version before upgrading is a version before v3.7.0, please check the [v3.x release notes](../../3.x/realtime-communication/introduction/release-notes?platform=windows-cpp) to obtain the changes between this version and v3.7.0.
    </Admonition>

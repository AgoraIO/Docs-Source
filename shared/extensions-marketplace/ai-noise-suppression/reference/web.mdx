...
- `LEVEL26`: (Recommended) Light level of noise suppression.
- `LEVEL40`: Medium level of noise suppression. At this level, the audio quality of human voices might be considerably affected.
</PlatformWrapper>

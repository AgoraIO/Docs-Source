...
- When you use the [Agora <Vg k="VSDK" />](../reference/glossary#agora-video-sdk) to communicate with the <Vpd k="NAME" />, set the channel scenario of the <Vg k="VSDK" /> to `LIVE_BROADCASTING`.

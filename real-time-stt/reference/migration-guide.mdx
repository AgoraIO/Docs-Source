...
![STT version comparison](https://agora-doc.s3.us-east-1.amazonaws.com/images/real-time-stt/stt-v5-config.png) 
...
![Go script](https://agora-doc.s3.us-east-1.amazonaws.com/images/real-time-stt/go-script-for-v6.x.png)

...
You can create <code>{config.rtm[props.ag_platform]}</code> instances in the following way:
...
| `areaCode` | <code>{enumv.areacode[props.ag_platform]}</code> | Optional | <code>{enumv.areacodeglob[props.ag_platform]}</code> | Service area code, you can choose according to the region where your business is deployed. See [<code>{enumv.areacode[props.ag_platform]}</code>](#enumvareacodepropsag_platform). |
...
<h4 className="index-api-logconfig" id={config.log[props.ag_platform]}>{config.log[props.ag_platform]}</h4>
...
| `level` | <code>{enumv.loglevel[props.ag_platform]}</code> | Optional | <code>{enumv.loglevelinfo[props.ag_platform]}</code> | Output level of log information. See [<code>{enumv.loglevel[props.ag_platform]}</code>](#enumvloglevelpropsag_platform). |

<h4 className="index-api-proxy" id={config.proxy[props.ag_platform]}>{config.proxy[props.ag_platform]}</h4>
...
<h4 className="index-api-encryption" id={config.encryption[props.ag_platform]}>{config.encryption[props.ag_platform]}</h4>
...
<h4 id="adding-during-initialization">Adding During Initialization</h4>
...
<h4 id="adding-at-any-time">Adding at Any Time</h4>
...
<h4 className="index-api-messageevent" id={config.messageevent[props.ag_platform]}>{config.messageevent[props.ag_platform]}</h4>
...
<h4 className="index-api-presenceevent" id={config.presenceevent[props.ag_platform]}>{config.presenceevent[props.ag_platform]}</h4>
...
<h4 className="index-api-topicevent" id={config.topicevent[props.ag_platform]}>{config.topicevent[props.ag_platform]}</h4>
...
<h4 className="index-api-storageevent" id={config.storageevent[props.ag_platform]}>{config.storageevent[props.ag_platform]}</h4>
...
| `data` | <code>{storage.metadata[props.ag_platform]}</code> | Metadata item. See <a href="../storage#Metadata"><code>{storage.metadata[props.ag_platform]}</code></a>. |

<h4 className="index-api-lockevent" id={config.lockevent[props.ag_platform]}>{config.lockevent[props.ag_platform]}</h4>
...
You can destroy the <code>{channel.irtmclient[props.ag_platform]}</code> instance in the following way:

    ...
    implements ChatMultiDeviceEventListener
{
    onContactEvent?(
        ...
        switch (event) {
            ...
            case CONTACT_DECLINE:
                break;
            // The current user adds friends to the blacklist on other devices.
            case CONTACT_BAN:
                break;
            // The current user removes friends from the blacklist on other devices.
            case CONTACT_ALLOW:
                break;
        }
    }
    ...
    onThreadEvent?(
        ...
        //Multi-device notification of sub-area messages.
        switch (event) {
            case THREAD_CREATE:
                //The current user creates a sub-area on other devices.
                break;
            case THREAD_DESTROY:
                //The current user destroys a sub-area on other devices.
                break;
            case THREAD_JOIN:
                //The current user joins a sub-area on other devices.
                break;
            case THREAD_LEAVE:
            ...
            case THREAD_UPDATE:
                ...
                break;
            case THREAD_KICK:
                //The current user kicks members out of the sub-area on other devices.
                break;
        }
    }

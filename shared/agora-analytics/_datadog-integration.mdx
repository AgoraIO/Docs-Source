...
1.  In <Vg k="CONSOLE" />, subscribe to a [pricing plan](https://console.agora.io/aa/pricing). You need to subscribe to the premium or enterprise <Vg k="AA" /> package to avail this feature.

2.  In [<Vpd k="NAME"/>](https://analytics-lab.agora.io/), click **Integration > Datadog**.

3. Press **Apply**. This initiates Datadog enablement.

    ![](/images/analytics/apply-datadog-package.png)
    [<Vg k="COMPANY" /> support](support@agora.io) reach out to you once the feature is enabled. You can only use Datadog in <Vg k="AA" /> when the Datadog Integration is enabled in your Datadog package. Customers with premium and enterprise <Vg k="AA" /> package can also contact sales to enable this feature.

...
This page shows how to manage a chat room block list by calling the Chat RESTful APIs. Before calling the following methods, ensure that you understand the call frequency limit described in [Limitations](../reference/limitations).

...
1. In your browser, open `http://127.0.0.1:5173` and select the **Store channel and user data** project from the navigation bar.
...
1. In another browser tab, load `http://127.0.0.1:5173/src/storage/index.html` and log in using a different **User ID**. Enter the same channel name as before, and press **Subscribe**. You see that both User IDs appear in the user lists in both tabs.

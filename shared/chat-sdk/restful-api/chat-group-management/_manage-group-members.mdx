...
Group member management involves operations such as member creation and deletion. <Vg k="CHAT"/> provides multiple APIs for adding and retrieving group members, adding a group administrator, and transferring the group owner.

This page shows how to manage group members by calling the <Vg k="CHAT"/> RESTful APIs. Before calling the following methods, ensure that you understand the call frequency limit described in <Link to="/agora-chat/reference/limitations#call-limit-of-server-sides">Limitations</Link>.
...
Retrieves the member list of the specified <Vg k="CHAT_GROUP_LOWER"/> with pagination.
...
## Adding a user to the <Vg k="CHAT_GROUP_LOWER"/>

Adds the specified user to the <Vg k="CHAT_GROUP_LOWER"/>.  If the user is already a member of the <Vg k="CHAT_GROUP_LOWER"/>, an error is returned.
...
| Parameter | Type | Description |
| :------ | :------ | :------------------------------------------------ |
| `result` | Boolean | Whether the user is successfully added to the <Vg k="CHAT_GROUP_LOWER"/>. <li>true: Yes.</li><li>false: No.</li> |
| `groupid` | String | The group ID. |
| `action` | String | The request method. |
| `user` | String | The username added to the <Vg k="CHAT_GROUP_LOWER"/>. |
...
## Adding multiple users to the <Vg k="CHAT_GROUP_LOWER"/>

Adds multiple users to the specified <Vg k="CHAT_GROUP_LOWER"/>. You can add a maximum of 60 users into a <Vg k="CHAT_GROUP_LOWER"/> each time. If the users are already members of the <Vg k="CHAT_GROUP_LOWER"/>, an error is returned in the response body.
### HTTP request
...
| Parameter | Type | Description | Required |
| :-------- | :---- | :------------------------ | :------- |
| `usernames` | Array |  The usernames to add to the <Vg k="CHAT_GROUP_LOWER"/>. You can pass in a maximum of 60 usernames each time. | Yes |
...
## Removing a <Vg k="CHAT_GROUP_LOWER"/> member

Removes the specified user from the <Vg k="CHAT_GROUP_LOWER"/>. If the specified user is not in the <Vg k="CHAT_GROUP_LOWER"/>, an error is returned.

Once a member is removed from a <Vg k="CHAT_GROUP_LOWER"/>, they are also removed from all the threads they have joined in this <Vg k="CHAT_GROUP_LOWER"/>.
...
| Parameter | Type | Description |
| :------ | :------ | :------------------------------------------------ |
| `result` | Boolean | Whether the user is successfully removed from the <Vg k="CHAT_GROUP_LOWER"/>. <li>true: Yes.</li><li>false: No.</li> |
| `groupid` | String | The group ID. |
| `action` | String | The request method. |
| `user` | String | The usernames removed from the <Vg k="CHAT_GROUP_LOWER"/>. |
...
Removes multiple users from the <Vg k="CHAT_GROUP_LOWER"/>. You can remove a maximum of 60 members from the <Vg k="CHAT_GROUP_LOWER"/> each time. If the specified users are not in the group, an error is returned.
...
| `result` | Boolean | Whether the user is successfully removed from the <Vg k="CHAT_GROUP_LOWER"/>. <li>true: Yes.</li><li>false: No.</li> |
| `groupid` | String | The group ID. |
| `reason` | String | The reason why the users fail to be removed from the <Vg k="CHAT_GROUP_LOWER"/>. |
| `action` | String | The request method. |
| `user` | String | The usernames removed from the <Vg k="CHAT_GROUP_LOWER"/>. |
...
Retrieves the list of the <Vg k="CHAT_GROUP_LOWER"/> admins.
...
If the returned HTTP status code is 200, the request succeeds， and the `data` field in the response body contain the information of the <Vg k="CHAT_GROUP_LOWER"/> admins. For other fields and descriptions, see [Common parameters](#common-parameters).
...
Adds a regular group member to the group admin list. A <Vg k="CHAT_GROUP_LOWER"/> admin has the privilege to manage the <Vg k="CHAT_GROUP_LOWER"/> block list and mute <Vg k="CHAT_GROUP_LOWER"/> members. You can add a maximum of 99 <Vg k="CHAT_GROUP_LOWER"/> admins.
...
| Parameter | Type | Description | Required |
| :------- | :----- | :---------------------------- | :------- |
| `newadmin` | String | The username of the <Vg k="CHAT_GROUP_LOWER"/> admin. | Yes |
...
Removes the specified user from the <Vg k="CHAT_GROUP_LOWER"/> admin list.
...
| Parameter | Type | Description |
| :------- | :------ | :---------------------------------------------- |
| `newowner` | Boolean | Whether the user is successfully set as the <Vg k="CHAT_GROUP_LOWER"/> owner. true: Yes; false: No. |

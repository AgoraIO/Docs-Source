...
3. **Set the APP ID**
    ...
    In `video-sdk-samples-windows/config.json`, set `appId` to the [AppID](../reference/manage-agora-account?platform=android#get-the-app-id) of your project.
...
5.  **Run the <Vpl k="NAME" /> sample**
    ...
    1. Double-click on `video-sdk-samples-windows/agora_manager/agora_manager.sln`. It will open the solution in
  Visual Studio.

...
3.  **Add the media stream encryption method**
    ...
    To enable media stream encryption in your <Vpl k="CLIENT" />, create a `EncryptionConfig` object and specify a key, salt, and encryption mode. Call `enableEncryption` and pass the `EncryptionConfig` object as a parameter.
    ...
    public void enableEncryption()
    {
      ...
      // A object to specify encryption configuration.

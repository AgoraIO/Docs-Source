...
1. Drag **Text** from the **Common** section of the **Palette Panel** and drop it over `voiceEffectButton`.
...
1. Select the **Text** widget of `voiceEffectButton`, then in **Details** change the **Text** field to `Play Audio Effect`.

...
Creates an [`IAgoraService`](agora-service) object and returns a pointer to it.
...
* On success: A pointer to the [`IAgoraService`](agora-service) object.
* On failure: A null pointer.

## `initialize`

Initializes the [`IAgoraService`](agora-service) object.
...
| --------- | ---------------------------------- | -------------------------------------------------------------------------------------------------- |
| `config`  | `const AgoraServiceConfiguration&` | Initialization configuration. See [`AgoraServiceConfiguration`](struct#agoraserviceconfiguration). |
...
Releases the [`IAgoraService`](agora-service) object.
...
To ensure complete log output, call this method immediately after calling [`initialize`](agora-service#initialize).
</Admonition>

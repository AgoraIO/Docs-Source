...
1. **Install necessary modules into your project**

    To call `HTTP` methods that start, stop, and query a speech-to-text task, you add the `axios` module to your project. To generate the base-64 authorization header, you add the `Buffer` module. Run the following commands in the terminal:
...
1. **Import necessary modules into your project**

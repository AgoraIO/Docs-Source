...
<CodeItem language="bash" name="curl">{`curl --request POST \\
  ...
  }' | http POST https://api.sd-rtn.com/dev/v1/kicking-rule \\
...
try {
  ...
  <CodeItem language="js" name="XMLHTTPRequest">{`const url = 'https://api.sd-rtn.com/dev/v1/kicking-rule';
const options = {
  method: 'POST',
  headers: {
    Authorization: '',
...
const req = unirest('POST', 'https://api.sd-rtn.com/dev/v1/kicking-rule');\n
req.headers({
  Authorization: '',
  'Content-Type': 'application/json',
  Accept: 'application/json'
...
client.prepare("POST", "https://api.sd-rtn.com/dev/v1/kicking-rule")
...
<CodeItem language="java" name="Unirest">{`HttpResponse<String> response = Unirest.post("https://api.sd-rtn.com/dev/v1/kicking-rule")
  .header("Authorization", "")
  \.header("Content-Type", "application/json")
  \.header("Accept", "application/json")
  \.body("{\\n  \\"appid\\": \\"4855xxxxxxxxxxxxxxxxxxxxxxxxeae2\\",\\n  \\"cname\\": \\"channel1\\",\\n  \\"uid\\": 589517928,\\n  \\"ip\\": \\"\\",\\n  \\"time\\": 60,\\n  \\"privileges\\": [\\"join_channel\\"]\\n}")
...
$response = $client->request('POST', 'https://api.sd-rtn.com/dev/v1/kicking-rule', [
    'json' => [
        'appid' => '4855xxxxxxxxxxxxxxxxxxxxxxxxeae2',
        'cname' => 'channel1',
        'uid' => 589517928,
...
$response = Invoke-WebRequest -Uri 'https://api.sd-rtn.com/dev/v1/kicking-rule' -Method POST -Headers $headers -ContentType 'application/json' -Body '{
  "appid": "4855xxxxxxxxxxxxxxxxxxxxxxxxeae2",
  "cname": "channel1",
  "uid": 589517928,
  "ip": "",
...
$headers.Add("Content-Type", "application/json")
$headers.Add("Accept", "application/json")
$response = Invoke-RestMethod -Uri 'https://api.sd-rtn.com/dev/v1/kicking-rule' -Method POST -Headers $headers -ContentType 'application/json' -Body '{
  "appid": "4855xxxxxxxxxxxxxxxxxxxxxxxxeae2",
  "cname": "channel1",
  "uid": 589517928,
  "ip": "",
...
(client/post "https://api.sd-rtn.com/dev/v1/kicking-rule" 

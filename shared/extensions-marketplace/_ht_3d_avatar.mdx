...
To implement <Vg k="RTEE_HT3D" /> features in your <Vpl k="CLIENT" />, open the <Link to="../../../video-calling/get-started/get-started-sdk"><Vg k="GET_STARTED"/> for <Vg k="VIDEO"/></Link> project you created previously, and take the following steps:

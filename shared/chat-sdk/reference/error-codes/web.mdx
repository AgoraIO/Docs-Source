...
| 27 | `WEBIM_CONNCTION_APPKEY_NOT_ASSIGN_ERROR` |  The App Key is invalid. Log in again using a valid App Key. For how to get the App Key, see [Get the information of theAgora Chat project](../get-started/enable?platform=RESTful). |

...
| ⇒⇒`enable_aivad` | boolean | Optional    | Whether to enable the graceful interruption function (AIVAD). This feature is a value-added service, please refer to [pricing](../overview/pricing) for details. Default value `false`|

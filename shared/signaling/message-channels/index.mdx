...
<Vg k="SIG" /> provides message channels for implementing publish-subscribe (pub/sub) messaging in your <Vpl k="CLIENT" />. In a message channel, you subscribe to a channel to receive messages. However, you do not need to join the channel to publish messages. This page shows you how to use <Vg k="MESS_SDK" /> pub/sub messaging to implement various communication model into your <Vpl k="CLIENT" />. 

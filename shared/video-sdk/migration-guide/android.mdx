...
-   [Function gaps](#function-gaps): Introduces functions that were supported in v<Vg k="VSDK_PREVIOUS_RELEASE" /> but are not supported in <Vg k="VSDK_PREVIOUS_RELEASE" />. However, these functions are intended to be added in a future release.

-   [Removed APIs](#removed-apis): Introduces APIs that were supported in v<Vg k="VSDK_PREVIOUS_RELEASE" /> but removed in <Vg k="VSDK_PREVIOUS_RELEASE" />. Most of these APIs have alternatives in <Vg k="VSDK_PREVIOUS_RELEASE" />. Modifying the related implementation should require less time.

...
Enable and configure Chat in the Console as follows:

1. Log into Console and navigate to the [Project Management](https://console.agora.io/projects) page.
...
1. Back in the **Features** section of the **Edit Project** page, click **Config** next to **Flexible Classroom**.

1. In the **Chat** section, complete the following required fields:

...
- <Link to="{{global.API_REF_ANDROID_ROOT}}/rtc_api_data_type.html#class_logconfig">LogConfig</Link>

- <Link to="{{global.API_REF_ANDROID_ROOT}}/class_irtcengine.html#api_irtcengine_setlocalaccesspoint">setLocalAccessPoint</Link>

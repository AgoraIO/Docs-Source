...
import Understand from '@docs/shared/chat-sdk/develop/user-attributes/understand/index.mdx';
import ProjectImplement from '@docs/shared/chat-sdk/develop/user-attributes/project-implementation/index.mdx';
import Reference from '@docs/shared/chat-sdk/develop/user-attributes/reference/index.mdx';
import NextStep from '@docs/shared/chat-sdk/develop/user-attributes/next-steps/index.mdx';

...
v4.4.0  was released on July x, 2024.
...
**Attention:** Starting from v4.4.0, the SDK provides an API sunset notice, which includes information about deprecated and removed APIs in each version. See <Link to="{{Global.API_REF_IOS_ROOT}}/agorartckit">API reference</Link>.
...
1. **Lite SDK**
   ...
   - For the list of APIs supported by the Lite SDK, see <Link to="{{Global.API_REF_IOS_ROOT}}/agorartckit">API reference</Link>.
   - For the limitations and precautions when using the Lite SDK to play media files, refer to [Which audio file formats does the Agora Video SDK support?](../../help/general-product-inquiry/audio_format)

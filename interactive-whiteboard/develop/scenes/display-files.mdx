...
When using the whiteboard, users may need to present files in DOC, DOCX, PDF, PPT, or PPTX format. The Agora Interactive Whiteboard SDK supports inserting and displaying an image or web page in each scene by specifying a URL.
...
To display a file on the Agora Interactive Whiteboard, do the following:
...
- Ensure the format of the converted images or web pages is supported by the Agora Interactive Whiteboard SDK.
  The Agora Interactive Whiteboard SDK supports inserting and displaying images or web pages in the following formats:

  - Static images in PNG, JPG/JPEG, and WEBP formats.
  - Static images in PNG, JPG/JPEG, and WEBP formats converted from PPT, PPTX, DOC, DOCX, and PDF files. You can convert them yourself or use the [static-file conversion service](../reference/whiteboard-api/file-conversion#static-file-conversion) of Agora Interactive Whiteboard.
...
- Understand the basic concepts and operations of scenes. See [Scene Overview](/en/whiteboard/scene_overview?platform=Web&versionId=32fa0c50-1b59-11ec-8e65-856920855d60) and [Manage Scenes](/en/whiteboard/manage_scenes?platform=Web&versionId=2bed1400-1b6f-11ec-8e65-856920855d60). 
- Integrate the Agora Interactive Whiteboard SDK into your project and implement joining a room. For details, see [Join a Whiteboard Room](https://docs.agora.io/en/whiteboard/join_whiteboard_room_web?platform=Web).

## Implementation

The following section extends the [Join a Whiteboard Room](https://docs.agora.io/en/whiteboard/join_whiteboard_room_web?platform=Web) sample code to show the creation of multiple scenes and the display of a six-page, animated PPTX file.

1. Upload the PPTX source file to a third-party cloud storage service, and call the [Start file conversion](https://docs.agora.io../reference/whiteboard-api/file-conversion#start-file-conversion-post) API to create a dynamic-file conversion task that converts the PPTX file to HTML web pages.

2. Call the [Query file conversion progress](https://docs.agora.io../reference/whiteboard-api/file-conversion#query-file-conversion-progress-get) API to get the URLs of the converted HTML web pages from the `conversionFileUrl` parameter in the response body.
...
APIs of the Agora Interactive Whiteboard SDK for Web:

- [joinRoom](https://docs.agora.io/en/whiteboard/API%20Reference/whiteboard_web/classes/whitewebsdk.html#joinroom)
- [putScenes](https://docs.agora.io/en/whiteboard/API%20Reference/whiteboard_web/interfaces/room.html#putscenes)
- [setScenePath](https://docs.agora.io/en/whiteboard/API%20Reference/whiteboard_web/interfaces/room.html#setscenepath)
- [setSceneIndex](https://docs.agora.io/en/whiteboard/API%20Reference/whiteboard_web/interfaces/room.html#setsceneindex)
- [SceneState](https://docs.agora.io/en/whiteboard/API%20Reference/whiteboard_web/globals.html#scenestate)

RESTful APIs of the file conversion feature:

- [Start file conversion (POST)](https://docs.agora.io../reference/whiteboard-api/file-conversion#start-file-conversion-post)
- [Query file conversion progress (GET)](https://docs.agora.io../reference/whiteboard-api/file-conversion#query-file-conversion-progress-get)

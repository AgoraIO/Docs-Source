...
**Caution:** The code provided in this section is for demonstration purposes only. <Vg k="COMPANY" /> does not recommend hardcoding the Customer Secret in the <Vpl k="CLIENT" />. Best practice is to implement a server to manage your Real-Time Transcription tasks.

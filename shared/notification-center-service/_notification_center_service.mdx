...
import MediaPullEvents from './media-pull-events.mdx'
import MediaPushEvents from './media-push-events.mdx'
...
![](/images/notification-center-service/ncs-cloud-recording-workflow.svg)
</ProductWrapper>

<ProductWrapper product="media-pull">
![media-pull](https://web-cdn.agora.io/docs-files/1585759402952)
</ProductWrapper>

<ProductWrapper product="media-push">
![media-push](https://web-cdn.agora.io/docs-files/1585759402952)
</ProductWrapper>
...
<ProductWrapper notAllowed="cloud-recording, media-pull, media-push">

...
**Alert Notifications** sends alerts to you when abnormal metrics or events are detected in your Agora RTC projects. See [Alert Notifications](../analyze/alarm) for details.

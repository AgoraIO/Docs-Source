...
The device connects to your hotspot automatically. 

For complete network configuration options, including connecting to your existing WiFi network, see [Network configuration](../get-started/basics/#network-configuration).

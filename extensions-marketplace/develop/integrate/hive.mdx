...
Hive content moderation enables you to monitor images and videos in near real-time, for inappropriate content such as nudity, violence, and hate imagery. Using Hive, you can identify and remove any type of undesirable content. This page introduces you to the use of Hive Visual Moderation API in <Vg k="VSDK"/> to empower your apps with accurate content moderation for live video streams.
...
4. Implement your own business logic based on audit results.

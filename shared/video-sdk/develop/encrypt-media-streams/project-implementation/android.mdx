...
1. Implement client-side logic:
    ...
    1. Before joining the channel, call [enableEncryption](https://api-ref.agora.io/en/video-sdk/android/4.x/API/class_irtcengine.html#api_irtcengine_enableencryption) to set the `AES_128_GCM2` or `AES_256_GCM2` encryption mode, and pass the key and salt into the SDK.

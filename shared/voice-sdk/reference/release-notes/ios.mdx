...
After upgrading the SDK, you need to update the code in your app according to your business scenarios. For details, see [Migrate from v3.7.0 to v4.0.0](https://docs.agora.io/en/live-streaming-premium-4.x/migration_guide_ios_ng).

...
The following steps show how to implement playing a video in the [Join the whiteboard room](../../fastboard-sdk/get-started/get-started-uikit#join-the-whiteboard-room) project:
...
The following steps show how to implement presenting a three-page, animated PPTX file in the [Join the whiteboard room](../../fastboard-sdk/get-started/get-started-uikit#join-the-whiteboard-room) project:
...
3. Open the [Join the whiteboard room](../../fastboard-sdk/get-started/get-started-uikit#join-the-whiteboard-room) project, and add the following lines to the `main.js` file:
    ```javascript

...
<ParameterList title="BODY" required={true}>
  ...
  <Parameter name="sip" type="object" required={true}>
    ...
    <Parameter name="rtc_uid" type="string" required={true}>
      The RTC UID used by the SIP gateway. All UIDs within a channel must be unique. Ensure no other user or service bot is using this UID in the same channel.
    </Parameter>
    
    <Parameter name="rtc_token" type="string" required={true}>

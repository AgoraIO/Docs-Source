...
- You understand the call frequency limit of the Chat RESTful APIs as described in <Link to="../reference/limitations?platform={{platform.PATH}}#call-limit-of-server-sides">Limitations</Link>.

...
Take the following steps to configure your Alibaba Cloud OSS account:

* Set the read and write permissions to `public read`.

* Set the cross-domain rule configuration:

   * Source and allow Headers can be configured according to your actual situation.
   
   * Exposed Headers must be filled in strictly according to the following figure.

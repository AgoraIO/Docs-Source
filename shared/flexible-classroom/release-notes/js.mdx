...
v2.8.0 provides the Agora Proctor SDK for online exam proctoring scenarios. For details, see the [Agora Proctor SDK API reference](/flexible-classroom/client-api/proctor-sdk).

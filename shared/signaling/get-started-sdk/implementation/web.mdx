...
1.  **Send a messages**
    ...
    Messages are sent directly to the UID of another user. You setup the event handlers for messages received from
        other users during <Vg k="MESS_ENGINE" /> initiation.

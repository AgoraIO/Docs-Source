...
1. **Configure your project properties**
   ...
   Right-click the project name In **Solution Explorer**, right-click your project, then click **Properties** to configure the following project properties, and click **OK**.

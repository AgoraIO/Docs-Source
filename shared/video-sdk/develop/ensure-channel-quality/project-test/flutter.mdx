...
5. From the main screen of the <Vpl k="CLIENT" />, choose **<Vpd k="NAME" />** from the dropdown and then select **Call quality best practice**.

1. **Initialization best practice**

    When the <Vpl k="CLIENT" /> initializes the <Vg k="ENGINE" />, it does the following:

    * Sets the log file size, and logging level according to your preference.
    * Enables the dual-stream mode.
    * Sets the audio profile.
    * Sets the video video encoder configuration.

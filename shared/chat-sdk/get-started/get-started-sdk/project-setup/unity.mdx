...
1. Go to the [SDK download page](https://docs.agora.io/en/agora-chat/downloads?platform=All%20Platforms), and download the latest version of the Chat SDK package for Unity, and decompress it.

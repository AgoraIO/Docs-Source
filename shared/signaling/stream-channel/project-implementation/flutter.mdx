...
<Admonition type="info">
To facilitate testing of your <Vpl k="CLIENT" /> during development, set the **Authentication mechanism** to **Debugging mode** when creating the project, and use the app ID in the `token` parameter when joining a channel.
</Admonition>

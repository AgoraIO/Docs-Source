...
For more detailed information, about the connection state and reasons, see <Link to="{{Global.API_REF_FLUTTER_ROOT}}/class_irtcengineeventhandler.html#callback_onconnectionstatechanged">IRtcEngineEventHandler.onConnectionStateChanged</Link>.
...
- <Link to="{{global.API_REF_FLUTTER_ROOT}}/class_irtcengine.html#api_setvideoencoderconfiguration">setVideoEncoderConfiguration</Link>

- <Link to="{{global.API_REF_FLUTTER_ROOT}}/class_irtcengineeventhandler.html#callback_onlocalvideostats">onLocalVideoStats</Link>

- <Link to="{{global.API_REF_FLUTTER_ROOT}}/class_irtcengineeventhandler.html#callback_onremotevideostats">onRemoteVideoStats</Link>
...
- <Link to="{{global.API_REF_FLUTTER_ROOT}}/class_irtcengine.html#api_setremotevideostreamtype">setRemoteVideoStreamType</Link>

...
|------------------|-------------|-------------------|
| [OpenAI](openai)         | `openai`      | https://platform.openai.com/docs/api-reference/responses/create    |
| [Azure OpenAI](azure-openai)      | `openai`      | https://learn.microsoft.com/en-us/azure/ai-services/openai/reference              |
| [Google Gemini](gemini)     | `gemini`      | https://cloud.google.com/docs/authentication/rest   |
| [Google Vertex AI](google-vertex-ai)  | `gemini`      | https://cloud.google.com/vertex-ai/generative-ai/docs/learn/prompts/system-instructions |
| [Claude](claude)            | `anthropic`   | https://docs.anthropic.com/en/api/messages          |
| [Dify](dify)              | `dify`        | [Agora Conversational AI - Dify Marketplace](https://marketplace.dify.ai/plugins/plutoless/convoai)          |

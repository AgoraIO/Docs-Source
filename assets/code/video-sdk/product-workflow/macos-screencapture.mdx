...
1. **Get available screens and windows**
    ...
    - <Link to="{{Global.API_REF_MACOS_ROOT_RTC_ENGINE_KIT}}/getscreencapturesources(withthumbsize:iconsize:includescreen:)">getScreenCaptureSources(withThumbSize:iconSize:includeScreen:)</Link>
    - <Link to="{{Global.API_REF_MACOS_ROOT_RTC_KIT}}/agorascreencapturesourceinfo">AgoraScreenCaptureSourceInfo</Link>
...
1. **Start capturing the screen or window**
    ...
    - <Link to="{{Global.API_REF_MACOS_ROOT_RTC_KIT}}/agorascreencaptureparameters">AgoraScreenCaptureParameters</Link>
    - <Link to="{{Global.API_REF_MACOS_ROOT_RTC_ENGINE_KIT}}/startscreencapture(bywindowid:regionrect:captureparams:)">startScreenCapture(byWindowId:regionRect:captureParams:)</Link>
    - <Link to="{{Global.API_REF_MACOS_ROOT_RTC_ENGINE_KIT}}/startscreencapture(bydisplayid:regionrect:captureparams:)">startScreenCapture(byDisplayId:regionRect:captureParams:)</Link>
...
1. **Listen for screenshare update events**
    ...
    - <Link to="{{Global.API_REF_MACOS_ROOT_RTC_KIT}}/agorartcenginedelegate/rtcengine(_:localvideostatechangedof:error:sourcetype:)">rtcEngine(_:localVideoStateChangedOf:error:sourceType:)</Link>
...
1. **Stop sharing**
    ...
    - <Link to="{{Global.API_REF_MACOS_ROOT_RTC_ENGINE_KIT}}/stopscreencapture()">stopScreenCapture()</Link>
...
8. Click **Voice Effect**. 
    ...
    Put on headphone and microphone connected to your <Vpl k="CLIENT"/> and speak into the microphone. You hear your voice through the headphones with the voice effect name displayed on the button. Press the button again to test all the implemented voice effects one by one.

...
<div class="alert note"><ul><li>User attributes are stored on the Chat server. If you have security concerns, <Vg k="COMPANY"/> recommends that you manage user attributes yourself.</li><li>To ensure information security, app users can only modify their own user attributes. Only app admins can modify the user attributes of other users.</li></ul></div>

...
Leap app. You can enhance the overall user experience and add new possibilities for collaboration and
...
- To ensure communication security in a test or production environment, using a token server to generate token is recommended to ensure communication security, see [Secure authentication with tokens](../develop/authentication-workflow).

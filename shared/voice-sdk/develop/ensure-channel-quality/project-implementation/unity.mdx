...
To implement call quality features in your <Vpl k="CLIENT" />, you a label to display last-mile network quality. To add a label to the UI, take the following steps:
    ...
    1. Right-click **Sample Scene**, then click **UI** > **Text**. A label appears in the **Scene** Canvas.

    2. In **Inspector**, rename **Text** to **networkStatus**, then set the **Pos Y** coordinate to `170`.

...
8. Click **Voice effect**.
    ...
    Put on headphones connected to your web browser app and speak into the microphone of your Android device. You hear your voice through the headphones with the voice effect name displayed on the button. Click the button again to test all the implemented voice effects one by one.

...
<Admonition type="info">
If your business use-case requires more refined streaming permission control, refer to the [Co-host token authentication](../get-started/authentication-workflow#co-host-token-authentication) guide.
</Admonition>

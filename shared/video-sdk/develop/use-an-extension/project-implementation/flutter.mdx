...
1.  **Enable the extension**
    ...
    To enable multiple extensions, call `enableExtension` as many times. The sequence of enabling extensions determines the order of these extensions in the transmission pipeline. For example, if you enable extension A before extension B, extension A processes data from the <Vg k="VSDK" /> before extension B.

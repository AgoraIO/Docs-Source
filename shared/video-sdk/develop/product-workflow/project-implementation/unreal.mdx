...
2. **Add a button to start and stop screen sharing**
    ...
    1. Add a **Text** for the button. Drag **Text** from the **Common** section of the **Palette Panel** to the canvas panel.

    1. In **Details**, update the **Text** field to `Share Screen`, then change the following properties:
...
3. **Add a Check Box**
    ...
    1. Add a text widget for `muteCheckBox`. Drag **Text** from **Palette Panel** to the canvas panel, then change the **Text** field to `Mute`.


    1. To adjust the text widget position, in **Details**, change the following coordinates:

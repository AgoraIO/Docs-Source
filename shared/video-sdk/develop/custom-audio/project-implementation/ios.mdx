...
3. Call `pushExternalAudioFrameSampleBuffer` or `pushExternalAudioFrameRawData` to send audio frames to the SDK.
...
To retrieve audio data for playback, implement collection and processing of raw audio data. Refer to [Raw audio processing](./develop/stream-raw-audio).

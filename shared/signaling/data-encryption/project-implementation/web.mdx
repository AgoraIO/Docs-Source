...
4.  **Setup encryption and add the variables to your configuration**
...
1.  **Pass the configuration to the <Vg k="MESS_ENGINE" />**

    ``` javascript
      // Signaling Manager creates the signaling engine and channel for you

...
The `screenshotToCanvasAsync` method is added to generate a screen snapshot and write it to a specified rendering context after the image in the target scene has finished loading. This feature is currently in the experimental stage. If you encounter any issues while using it, please [contact technical support](tickect@agora.io).

...
This version was released on March 6, 2025.
...
- **Live subtitles**: This version supports real-time text output of conversations between users and the AI agent, for displaying subtitles on your app's UI.

- **Pricing**: This version adds pricing information for the Agora <Vpd k="NAME" />. For more information, see [Pricing](../overview/pricing).

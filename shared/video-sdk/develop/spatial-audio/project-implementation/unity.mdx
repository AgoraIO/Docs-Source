...
2. **Add an event listener to the button**
    ...
    Call `updateSpatialAudioPosition` when the game player presses **Update Spatial Audio Position**. To add an event listener to the button, in your script file, add the following at the end of `SetupUI`:

...
-   If an exclamation mark ![1650255317903](https://web-cdn.agora.io/docs-files/1650255317903) appears in the upper right corner, the user might encounter an issue that significantly affects the user experience. Click the exclamation mark to enter this user’s [Call diagnosis (Beta)](call-search#user-content-analyze-quality-issues) page.

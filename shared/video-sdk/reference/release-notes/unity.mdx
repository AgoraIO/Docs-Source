...
After upgrading the SDK, you need to update the code in your app according to your business use-cases. For details, see [Migration guide](../overview/migration-guide).

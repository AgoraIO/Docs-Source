...
- `sceneState`: The information of the current scene, including the name, index, and path of the scene. See [SceneState](https://docs.agora.io/en/whiteboard/API%20Reference/whiteboard_web/globals.html#scenestate). By modifying the `sceneState` value of the current room, you can switch the scene. See [Manage Scenes](../develop/scenes/manage-scenes).
...
The following section extends the [Join a whiteboard room](../get-started/get-started-uikit#join-the-whiteboard-room) sample code to show the implementation of getting or listening for room states.

...
Depending on your business scenario, choose either of the following methods to implement <Vg k="SCR_SHR" />:
...
Depending on the actual application scenario, choose one of the following <Vg k="SCR_SHR" /> methods.

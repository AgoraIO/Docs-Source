...
- `roomUUID`: String. The room UUID, that is, the unique identifier of a room. See the value of the `uuid` parameter in the response body after a successful call of [Create a room (POST)](../whiteboard-api/room-management#create-a-room-post).

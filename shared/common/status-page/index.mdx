...
This section explains the [Status Page](https://status.agora.io/) interface layout and functions. 
...
The Status Page interface is divided into the following functional areas:
...
The health banner at the top of the page provides buttons for event RSS subscription and viewing details of historical events.

#### RSS subscription

The RSS feed provides updates on incidents and historical events related to Agora's services, such as service quality degradation and interruptions. Each incident includes details such as investigation, identification, resolution steps, and a summary. 

When you click the **Event RSS feed** button, the raw RSS feed opens in your browser. To use the feed in an RSS feed reader, copy the URL from the address bar and paste it into your feed reader's subscriptions or **Add feed** section.

#### Historical events

To see a list of historical events for selected products & services during the past year, click the **Events** button in the health banner.

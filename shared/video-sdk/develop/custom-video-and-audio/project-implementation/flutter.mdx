...
1. **Add an image file**
    ...
    Create a folder named `assets` in the root folder of your project. Add an image file to this folder. Your <Vpl k="CLIENT" /> loads this file and pushes it as a video frame.

...
- Obtained API keys for:
  ...
  <Admonition type="tip">
  If you don't yet have API keys from a third-party LLM or TTS provider, [Use presets](../develop/use-presets) to start your first agent without ASR, LLM, and TTS credentials.
  </Admonition>

...
After logging in to <Link to="{{Global.AGORA_CONSOLE_URL}}"><Vg k="CONSOLE" /></Link>, you can see your account balance in the **Billing Center** panel on the **Overview** page.
...
1.  In <Link to="{{Global.AGORA_CONSOLE_URL}}/billing">Billing</Link>, click **Credit Card**.
...
1.  In <Link to="{{Global.AGORA_CONSOLE_URL}}/billing">Billing</Link>, click **Bank Transfer**.

2.  Follow the on-screen instructions to complete.

#### View transactions

In <Link to="{{Global.AGORA_CONSOLE_URL}}/billing">Billing</Link>, click **Transactions**. You can see all the transactions in your account.

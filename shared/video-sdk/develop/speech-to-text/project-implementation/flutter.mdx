...
To create a simple interface for testing speech-to-text functionality, add buttons to start and query speech-to-text. Open `/lib/main.dart` and add the following code to the `build` method after `ListView(...children: [`:

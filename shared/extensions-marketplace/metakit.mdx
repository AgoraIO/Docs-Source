...
- Integrated the v4.2.x or v4.3.x of the Video SDK and implemented basic real-time audio and video functions in your app. See [SDK quickstart](../../video-calling/get-started/get-started-sdk).
...
To implement <Vg k="RTEE_MK"/> effects in your <Vpl k="CLIENT" />, open the <Link to="../../../video-calling/get-started/get-started-sdk"><Vg k="GET_STARTED"/> for <Vg k="VIDEO"/></Link> project and take the steps described below.

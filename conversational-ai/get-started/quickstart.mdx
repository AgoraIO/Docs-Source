...
The easiest way to launch your first agent is by using one of the starter projects below. Click **Use this template** on GitHub and follow the instructions in the project's README.
  ...
  recipes={[
    {
      ...
      link: "https://github.com/AgoraIO-Community/agent-quickstart-python"
    },  
    {
      title: "Next.js Quickstart",
      description: "Next.js voice AI quickstart with managed STT, LLM, and TTS. Includes token generation, agent lifecycle routes, and live transcript streaming.",
      icon: Zap,
      categories: ["backend", "python"],

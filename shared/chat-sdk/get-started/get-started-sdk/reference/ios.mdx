...
3. Open the `Podfile` file and add the Chat SDK. Remember to replace ``Your project target` with the target name of your project.
...
1. Download the latest Chat SDK and decompress it.
...
For details, see the [sample code](https://github.com/AgoraIO/Agora-Chat-API-Examples/tree/main/Chat-iOS/ChatQuickStart)  and [demo  <Vpl k="CLIENT" />](../reference/downloads) to get started with <Vg k="CHAT" />.

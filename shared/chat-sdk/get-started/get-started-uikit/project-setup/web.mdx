...
This sections introduces how to create an app and add the Chat UI sample to the project.
...
2. Run one of the following commands to add the Chat UI sample to your project.

   To add the UI sample using npm:

   ```shell
   npm install agora-chat-uikit --save
   ```

   To add the UI sample using yarn

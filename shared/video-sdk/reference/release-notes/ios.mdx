...
v4.4.0 was released on July 25, 2024.
...
1. **<Vpd k="SDK_LITE"/>**
   ...
   - For the list of APIs supported by <Vpd k="SDK_LITE"/> , see <Link to="{{Global.API_REF_IOS_ROOT}}/agorartckit">API reference</Link>.

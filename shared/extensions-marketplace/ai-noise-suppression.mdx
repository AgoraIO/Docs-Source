...
* <Link to = "{{global.API_REF_IOS_ROOT}}/class_irtcengine.html#api_irtcengine_setainsmode">setAINSMode</Link>
</PlatformWrapper>
<PlatformWrapper platform="macos">
* <Link to = "{{global.API_REF_MACOS_ROOT}}/class_irtcengine.html#api_irtcengine_setainsmode">setAINSMode</Link>
</PlatformWrapper>
...
<PlatformWrapper platform="electron">
  * <Link to = "{{global.FC_API_REF_ELECTRON_ROOT}}/class_irtcengine.html#api_irtcengine_setainsmode">setAINSMode</Link>
</PlatformWrapper>

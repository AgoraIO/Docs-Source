...
- `appId`: String. App Identifier for the interactive whiteboard project. For details, see [Get security credentials for your whiteboard project](../whiteboard-sdk/get-started/enable-whiteboard#get-security-credentials-for-your-whiteboard-project).
...
- `converterType`: enumeration. The version of the document conversion service, the values are as follows:
   - `Projector`: new version. For details, see [New version of document conversion service](../whiteboard-sdk/develop/file-conversion-overview).

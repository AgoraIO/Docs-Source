...
| `-10019` | <code>{code.invalidchanneltype[props.ag_platform]}</code> | The channel type is invalid. SDK only supports the following channel types. Please fill in the correct value: <ul> <li> `MESSAGE`: Message Channel </li> <li>` STREAM`: Stream Channel </li> </ul> |

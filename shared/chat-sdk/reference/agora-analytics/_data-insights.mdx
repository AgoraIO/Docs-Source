...
[Agora Analytics](/agora-analytics/overview/product-overview) provides periodic analysis of usage and quality data for [Chat](/agora-chat/overview/product-overview), helping you keep track of the usage trends and quality details.
...
After [enabling and configuring Chat Service](/agora-chat/get-started/enable), the Chat-related features in Agora Analytics are enabled by default and are free to use. No additional operation is required. 

...
- [`WatermarkLitera`](/on-premise-recording/api-references/struct#watermarklitera)
- [`enableAndUpdateVideoWatermarks`](/on-premise-recording/api-references/agora-media-rtc-recorder#enableandupdatevideowatermarks)
- [`WatermarkTimestamp`](/on-premise-recording/api-references/struct#watermarktimestamp)
- [`WatermarkOptions`](/on-premise-recording/api-references/struct#watermarkoptions)
- [`Rectangle`](/on-premise-recording/api-references/struct#rectangle)
- [`WatermarkRatio`](/on-premise-recording/api-references/struct#watermarkratio)

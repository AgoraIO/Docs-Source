...
4. Import the Agora Classroom SDK in the HTML file and launch a classroom.
    ...
    <head>
        ...
        <!-- Introduce the SDK, 2.9.0 is the sample version number, you can check the latest version number through the release notes or GitHub warehouse branch -->
...
1. Switch to the latest branch.
    ...
    For example, if you want to switch to the branch of v2.9.0, just run the following command:

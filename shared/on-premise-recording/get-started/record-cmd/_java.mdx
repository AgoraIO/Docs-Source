...
- `appId`: The App ID must be the same as that of the Agora RTC SDK. For details, see [Getting an App ID](../reference/manage-agora-account#get-the-app-id).
...
- `triggerMode`: Sets whether to start recording automatically or manually.
  ...
  - `1`: Manually. Start and stop recording by commands. See [FAQ](http://docs.agora.io/en/help/integration-issues/cmd_control_record) for details.
...
- `mixedVideoAudio`：When `isMixingEnabled` is 1, you can set this parameter to mix the audio and video in an MP4 file in real time.
  ...
  - `7`: Mixes the audio and video in real time into an MP4 file and a TS file. The SDK deletes the TS file after recording. See [FAQ](http://docs.agora.io/en/help/integration-issues/recording_player) for the supported players.
...
If any error or warning occurs during the recording, see <Link to= "{{global.OPREC_SDK_API_JAVA}}/interfaces/enumio_1_1agora_1_1recording_1_1common_1_1_common_1_1_e_r_r_o_r___c_o_d_e___t_y_p_e.html">Error code</Link> and <Link to= "{{global.OPREC_SDK_API_JAVA}}/interfaces/enumio_1_1agora_1_1recording_1_1common_1_1_common_1_1_w_a_r_n___c_o_d_e___t_y_p_e.html">Warning code</Link>.


If any error or warning occurs during the recording, see [Error codes](https://api-ref.agora.io/en/on-premise-recording-sdk/linux-java/3.x/enumio_1_1agora_1_1recording_1_1common_1_1_common_1_1_e_r_r_o_r___c_o_d_e___t_y_p_e.html) and [Warning codes](https://api-ref.agora.io/en/on-premise-recording-sdk/linux-java/3.x/enumio_1_1agora_1_1recording_1_1common_1_1_common_1_1_w_a_r_n___c_o_d_e___t_y_p_e.html).

...
Before using <Vg k="CHAT" />, you need to enable and configure it through [<Vg k="CONSOLE" />](https://console.agora.io/#onboarding).
...
- A <Vg k="CHAT" /> pricing plan. For details on how to subscribe, see <Link to="../reference/pricing#subscribe-to-the-pricing-plan">Subscribe to the pricing plan</Link>.
...
1. Find your <Vg k="CHAT" />-enabled project on the [Project management](https://console.agora.io/projects) page at <Vg k="CONSOLE" /> and click **Config**.

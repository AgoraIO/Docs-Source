...
To create the environment necessary to integrate processing of raw audio and video data in your <Vpl k="CLIENT" />, open the <Link to="../get-started/get-started-sdk">Get Started with <Vpd k="NAME"/></Link> project you created previously.

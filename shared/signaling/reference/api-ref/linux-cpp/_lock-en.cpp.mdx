...
```cpp 
// Method call
rtm_client->getLock()->setLock("channel_name", RTM_CHANNEL_TYPE_STREAM, "lock_name", 30, req_id);
if (ret != RTM_ERROR_OK) {
...
```cpp 
// Method call
ret = rtm_client->getLock()->acquireLock("channel_name", RTM_CHANNEL_TYPE_STREAM, "lock_name", false, req_id);
if (ret != RTM_ERROR_OK) {
...
```cpp 
// Method call
ret = rtm_client->getLock()->releaseLock("channel_name", RTM_CHANNEL_TYPE_STREAM, "lock_name", req_id);
if (ret != RTM_ERROR_OK) {
...
```cpp 
// Method call
ret = rtm_client->getLock()->revokeLock("channel_name", RTM_CHANNEL_TYPE_STREAM, "lock_name", "tony", req_id);
if (ret != RTM_ERROR_OK) {
...
```cpp 
// Method call
ret = rtm_client->getLock()->getLocks("channel_name", RTM_CHANNEL_TYPE_STREAM, req_id);
if (ret != RTM_ERROR_OK) {
...
```cpp 
// Method call
ret = rtm_client->getLock()->removeLock("channel_name", RTM_CHANNEL_TYPE_STREAM, "lock_name", req_id);
if (ret != RTM_ERROR_OK) {

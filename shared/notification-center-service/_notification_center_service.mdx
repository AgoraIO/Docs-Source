            ...
            String eventDetails(int eventType, JSONObject details) {
                ...
                switch (eventType) {
                    ...
                    case 41: // recorder_leave
                        ...
                        break;
                    case 43: // recorder_audio_stream_state_changed
                        info = "Recorder audio stream state: " + details.get("state").toString();
                        break;
                    case 44: // recorder_video_stream_state_changed
                        info = "Recorder video stream state: " + details.get("state").toString();
                        break;
                    default:

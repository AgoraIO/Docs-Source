...
- Switching between different [AudioProfile](../reference/restful-api#start#transcoding-configuration) configuration at the streaming sender during a recording is not supported.

...
Before using an Agora RESTful API, you need to set up REST authentication.
...
-   **HMAC HTTP authentication**
    ...
    You need to generate a signature through the HMAC-SHA256 algorithm and pass the signature and related information to the `Authorization` parameter in the request header.
</ProductWrapper>

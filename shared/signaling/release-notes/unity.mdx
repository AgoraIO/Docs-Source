...
- Error codes
    ...
    This release adds the following error codes: `INVALID_CHANNEL_TYPE`, `INVALID_ENCRYPTION_PARAMETER`, and `OPERATION_RATE_EXCEED_LIMITATION`. For error code descriptions and solutions, see [Error Codes](/signaling/reference/error-codes).

...
<PathParameter name="page_index" type="integer" required={false} defaultValue="1">
  The page number. Starts from 1. 
</PathParameter>
<PathParameter name="page_size" type="integer" required={false} defaultValue="50" possibleValues="[10,200]">
...
- If the returned status code is `200`, the request was successful. 
  ...
  <ParameterList title="response">
    ...
    <Parameter name="total_turn_count" type="integer">
      The total number of dialogue turns in the current session.
    </Parameter>
    <Parameter name="pagination" type="object">
      Pagination information.

      <Parameter name="page_index" type="integer">
        The current page number; starts from 1.
      </Parameter>
      <Parameter name="total_pages" type="integer">
        The total number of pages.
      </Parameter>
      <Parameter name="is_last_page" type="boolean">

...
- If you are using the RTC SDK token, make sure you are using AccessToken2 in order to use the ActiveFence video content moderation extension. See [Upgrade AccessToken2](./signaling/develop/authentication-workflow?platform=android#upgrade-accesstoken2).

...
- An <Vg k="COMPANY" /> [account](../get-started/manage-agora-account#create-an-agora-account) and [project](../get-started/manage-agora-account#create-an-agora-project).
- [Enabled <Vg k="SIG" />](../get-started/manage-agora-account#enable-and-configure-) in <Vg k="CONSOLE" />
</ProductWrapper>
...
- React Native 0.70 or later. For more information, see [Setting up the development environment](https://reactnative.dev/docs/environment-setup).
- Node.js 16 or later
- For iOS
...
- For Android
  ...
  - [Java Development Kit (JDK) 17](https://openjdk.org/projects/jdk/17/) or later
  - Android Studio
  - A physical or virtual mobile device running Android 6.0 (API level 23) or later
</PlatformWrapper>
...
<PlatformWrapper platform="linux-c, linux-cpp">

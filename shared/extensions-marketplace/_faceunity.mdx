...
1. [Download](https://apprtcio-my.sharepoint.com/:u:/g/personal/liushiqin_agora_io/ER32VVKhzuRAjpmiK3DO1z4BIDvdyGbb5meqC2LSuruwjA) the <Vg k="RTEE_FU" /> resource package.

1. [Contact <Vg k="COMPANY" />](support@agora.io) for activation and obtain the `authpack` certificate file.

...
1. Log into <Vg k="CONSOLE"/> and navigate to the [Project Management](https://console.agora.io/projects) page.
...
1. In <Vg k="CONSOLE"/>, navigate to [Project Management](https://console.agora.io/projects).

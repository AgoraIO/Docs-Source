...
1. **Other features**
   ...
   - A new method <Link to="{{Global.API_REF_ANDROID_ROOT_VOICE_SDK}}/class_irtcengineex.html#api_irtcengineex_enableencryptionex">enableEncryptionEx</Link> is added for enabling media stream or data stream encryption in multi-channel scenarios.
   ...
   - A new method <Link to="{{Global.API_REF_ANDROID_ROOT_VOICE_SDK}}/class_irtcengineex.html#api_irtcengineex_getcallidex">getCallIdEx</Link> is introduced for retrieving call IDs in multi-channel scenarios.
...
After upgrading the SDK, you need to update the code in your app according to your business scenarios. For details, see [Migrate from v3.7.x to v<Vg k = "VSDK_RELEASE"/>](./overview/migration-guide).

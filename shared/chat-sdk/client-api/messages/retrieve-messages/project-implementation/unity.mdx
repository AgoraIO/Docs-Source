...
The server stores 100 conversations for 7 days by default. To increase the two upper limits, contact [support@agora.io](support@agora.io). <Vg k="COMPANY"/> Chat server can store up to 3,000 conversation per end user.

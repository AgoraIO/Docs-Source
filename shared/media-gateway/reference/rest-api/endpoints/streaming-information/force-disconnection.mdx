...
1. Call to [kick the user out of the channel](/realtime-communication/channel-management-api/endpoint/ban-user-privileges/create-rules). This API can also force the user to disconnect. If the kicking API has been integrated, you can continue to use it to disconnect the stream.

...
Pub-sub is the simplest form of messaging. Your <Vpl k="CLIENT" /> creates a channel when a user publishes a message to
it. Other users subscribe the channel. Your <Vpl k="CLIENT" /> listens for the channel events which contain the messages
users publish to it.

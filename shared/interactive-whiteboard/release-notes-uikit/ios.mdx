...
- [Display Files](/interactive-whiteboard/develop/display-files): Describes how to call the UI Kit's APIs to insert images, play audio and video, and present documents on the whiteboard.

- [API Reference](/interactive-whiteboard/reference/fastboard-api): Provides a detailed API reference for the UI Kit.
</PlatformWrapper>
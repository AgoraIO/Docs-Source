...
The API references for the Signaling SDK introduce the interface description, interface methods, basic usage example codes, and return values of Signaling APIs.

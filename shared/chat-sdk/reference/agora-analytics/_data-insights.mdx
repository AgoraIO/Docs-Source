...
|| Description | Notes |
| :----------- | :----------------------------------------------------------- | :----------------------------------------------------------- |
| Message Count Trends | Line charts showing how the total numbers of messages change within a certain time range. For a detailed description of each metric, see [Message metrics](data-metrics). | <li>The maximum time range to query is the past 6 months.</li><li>Each metric in this section is calculated at an interval of a day, and the data has a one minute delay.</li> |

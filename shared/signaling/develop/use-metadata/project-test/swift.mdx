...
1. On each device, enter the user ID corresponding to the RTM token, and tap **Login** to connect to the <Vpd k="PRODUCT" /> server.
...
1. Tap **Leave** to exit the channel and then **Logout**  of the <Vpd k="PRODUCT" /> server.

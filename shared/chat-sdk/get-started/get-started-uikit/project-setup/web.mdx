...
This sections introduces how to create an app and add the Chat Starter Kit to the project.
...
2. Run one of the following commands to add the Chat Starter Kit to your project.

   To add the Starter Kit using npm:

   ```shell
   npm install agora-chat-uikit --save
   ```

   To add the Starter Kit using yarn

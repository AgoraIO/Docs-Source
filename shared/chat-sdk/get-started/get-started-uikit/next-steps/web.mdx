...
In scenarios where you want to add your own business logic, you can use the various callback events provided by the Chat Starter Kit, as shown in the following steps:

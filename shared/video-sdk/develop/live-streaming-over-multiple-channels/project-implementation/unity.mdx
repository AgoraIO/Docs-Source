...
2.  **Add the required UI namespace**
    ...
    To import the required <Vpl k="NAME" /> UI namespace, in `Assets/Agora-RTC-Plugin/Agora-Unity-RTC-SDK/Code/JoinChannelVideo.cs`, add the following to the list of namespace declarations:
...
1.  **Add the required UI namespace**
    ...
    To import the required Uinty UI namespace, in `Assets/Agora-RTC-Plugin/Agora-Unity-RTC-SDK/Code/JoinChannelVideo.cs`, add the following to the list of namespace declarations:

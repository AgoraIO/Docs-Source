...
class ViewController: NSViewController {
    ...
    func initViews() {
        ...
        remoteView = NSView()
        remoteView.frame = CGRect(x: self.view.bounds.width - 90, y: 30, width: 90, height: 160)
        self.view.addSubview(remoteView)
        localView = NSView()
        localView.frame = CGRect(x: self.view.bounds.width - 10, y: 30, width: 90, height: 160)
        self.view.addSubview(localView)

        joinButton = NSButton()
        joinButton.frame = CGRect(x: 300 , y:50, width:80, height:30)

...
For details, see [Sign up for an <Vg k="COMPANY" /> account](#sign-in-and-sign-up).
...
1.  In <Vg k="CONSOLE" />, open the [Project Management](https://console.agora.io/projects) page.
...
Applicable products of RTM tokens include <Vg k="SIG"/> and Flexible Classroom.

...
This guide will help you to run the Storyteller use-case with Large Language Model in the TEN-Agent Playground.
...
The story_teller_realtime use case is pre-configured to use `openai_image_generate_tool`, so usually you don't need to change anything.
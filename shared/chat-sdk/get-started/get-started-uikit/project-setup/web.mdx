...
This sections introduces how to create an app and add the Chat <Vg k="UIK" /> to the project.
...
2. Run one of the following commands to add the Chat <Vg k="UIK" /> to your project.

   To add the <Vg k="UIK" /> using npm:

   ```shell
   npm install agora-chat-uikit --save
   ```

   To add the <Vg k="UIK" /> using yarn

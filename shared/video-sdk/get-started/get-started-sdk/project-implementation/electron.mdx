...
<ProductWrapper product="broadcast-streaming">
    ...
    For <Vg k="BS" /> choose `AudienceLatencyLevelLowLatency`. Low latency is a feature of <Vg k="BS" /> and its use is subject to special [pricing](../reference/pricing#unit-pricing).

  ...
  <Parameter name="properties" type="object" required={true}>
    ...
    <Parameter name="asr" type="object" required={false}>
      ...
      <Parameter name="language" type="string" defaultValue="en-US" required={false}>
        The language used by users to interact with the agent. Refer to [supported languages](/real-time-stt/develop/supported-languages) for details.
      </Parameter>

      <Parameter name="vendor" type="string" defaultValue="agora" possibleValues="agora,microsoft,deepgram" required={false}>
      ASR provider:
      - `agora`: [Agora](/conversational-ai/models/asr/agora)
      ...
      <Parameter name="params" type="object" required={true}>
        The configuration parameters for the ASR vendor. See [ASR Overview](/conversational-ai/models/tts/overview) for details.
      </Parameter>
    </Parameter>

...
1. Create the UMG
   ...
   Create a button control named **Btn_StartEchoTest** that you click to start the voice call loop test.
    ...
    ![Create UMG](https://agora-doc.s3.us-east-1.amazonaws.com/images/video-sdk/connection-status-mng-blueprint-lastmile-quality-startechotest-umg.png)
...
1. Bind UI events
    ...
    ![Bind UI Events](https://agora-doc.s3.us-east-1.amazonaws.com/images/video-sdk/connection-status-mng-blueprint-lastmile-quality-startechotest-bind-ui-events.png)
...
1. Implement the UI event
    ...
    ![Implement UI Events](https://agora-doc.s3.us-east-1.amazonaws.com/images/video-sdk/connection-status-mng-blueprint-lastmile-quality-startechotest-impl-ui-events.png)
...
1. Create UMG
    ...
    ![Create UMG](https://agora-doc.s3.us-east-1.amazonaws.com/images/video-sdk/connection-status-mng-blueprint-lastmile-quality-stopechotest-umg.png)
...
1. Bind UI events
    ...
    ![Bind UI Events](https://agora-doc.s3.us-east-1.amazonaws.com/images/video-sdk/connection-status-mng-blueprint-lastmile-quality-stopechotest-bind-ui-events.png)
...
1. Implement the UI event
    ...
    ![Implement UI Events](https://agora-doc.s3.us-east-1.amazonaws.com/images/video-sdk/connection-status-mng-blueprint-lastmile-quality-stopechotest-impl-ui-events.png)

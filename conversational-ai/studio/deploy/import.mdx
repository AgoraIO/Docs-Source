...
Import phone numbers to use as caller IDs for outbound campaigns with your deployed agents. Currently, <Vpd k="STUDIO" /> supports importing numbers from Twilio's Elastic SIP Trunk.
...
- An active Twilio account with Elastic SIP Trunk configured. See [Set up Twilio SIP trunk](twilio-sip).
...
1. Fill in the required information:
   ...
   - **Transport Protocol**: Select the protocol for SIP communication (**TCP**, **UDP**, or **TLS**)

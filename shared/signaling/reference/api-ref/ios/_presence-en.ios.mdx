...
<h2
  className="anchor index-group-item-rtmpresence index-api-getonlineusers"
  id="getOnlineUsers"
>
  getOnlineUsers
</h2>
...
<h2
  className="anchor index-group-item-rtmpresence index-api-getuserchannels"
  id="getUserChannels"
>
  getUserChannels
</h2>
...
<h2
  className="anchor index-group-item-rtmpresence index-api-setstate"
  id={presence.setstate[props.ag_platform]}
>
...
<h2
  className="anchor index-group-item-rtmpresence index-api-getstate"
  id={presence.getstate[props.ag_platform]}
>
...
<h2
  className="anchor index-group-item-rtmpresence index-api-removestate"
  id={presence.removestate[props.ag_platform]}
>
...
<span className="index-desc-removestate">
  ...
  notification. See
  <a href="../toc-configuration/configuration#eventlisteners">
    Event Listeners
  </a>
  .
</span>

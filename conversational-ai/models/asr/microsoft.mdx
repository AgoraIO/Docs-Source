...
For advanced configuration options, language models, and detailed parameter descriptions, see the [Microsoft Azure Speech-to-Text documentation](https://learn.microsoft.com/en-us/azure/ai-services/speech-service/speech-to-text).
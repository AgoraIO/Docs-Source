...
- Implemented <Link to="../../../interactive-live-streaming/get-started/get-started-sdk"><Vg k="GET_STARTED"/></Link> using <Vg k="VSDK" /> `4.2.0` or greater.
- You must use the most secure `AccessToken2` for your implementation. Either use the development authentication
  server from [Secure authentication with tokens](../../../interactive-live-streaming/get-started/authentication-workflow), or use the latest libraries in your [token generator](/en/video-calling/develop/integrate-token-generation).

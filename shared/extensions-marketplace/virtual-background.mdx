...
|  Feature  |  Example |
| ---- | ---- |
| Blurred background and image background   |   ![](https://agora-doc.s3.us-east-1.amazonaws.com/images/extensions-marketplace/blurred-background.jpg)   |
...
| Portrait-in-picture   | ![portrait-in-picture](https://agora-doc.s3.us-east-1.amazonaws.com/images/extensions-marketplace/portrait-in-picture.jpg) Allows the presenter to use slides as the virtual background while superimposing their video. The effect is similar to a weather news cast on television, preventing interruptions during a layout toggle.   |
|Together Mode | ![together-mode](https://agora-doc.s3.us-east-1.amazonaws.com/images/video-sdk/together-mode.png) Allows the presenter to segment the portrait in the remote video, transmit it locally, and customize the display. |
...
![web extensions](https://agora-doc.s3.us-east-1.amazonaws.com/images/extensions-marketplace/virtual-background.svg)
</details>

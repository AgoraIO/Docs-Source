...
The <Vg k="RTEE_HT3D" /> extension encapsulates the Hongtu HTAvatar core API. By setting appropriate parameters, you can quickly and seamlessly integrate 3D portrait special effects capabilities into your <Vpl k="CLIENT" />.

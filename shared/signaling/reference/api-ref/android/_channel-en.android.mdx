...
You can call the <code>{channel.release[props.ag_platform]}</code> method in the following way:
...
This operation returns the <code>RtmErrorCode</code> data type. For details, see <a href="/doc/rtm2/android/error-codes">Error code</a >.
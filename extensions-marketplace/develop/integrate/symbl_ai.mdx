...
Learn more about the Agora required credentials in <Link to="/realtime-communication/get-started/authentication-workflow">Secure authentication</Link>.
...
- **Android Mobile Application**: This guide assumes you have an Android mobile application with the Agora Video SDK enabled. Follow the steps in the <Link to="/realtime-communication/get-started/get-started-sdk"><Vg k="GET_STARTED"/></Link> to set it up.

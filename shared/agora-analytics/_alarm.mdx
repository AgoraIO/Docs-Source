...
-   Data synchronization with [Call Inspector](call-search) and [Data Insights](./data-insight), so that you can easily dive into problem analysis.
...
3.  (Optional) To further analyze an alert record, click **Call details** to use the [Call Inspector](call-search) service.

...
This version was released on November 26, 2024.
...
1. **Other features**
   ...
   - A new method <Link to="{{Global.API_REF_CPP_ROOT_VOICE_SDK}}/class_irtcengineex.html#api_irtcengineex_enableencryptionex">enableEncryptionEx</Link> is added for enabling media stream or data stream encryption in multi-channel scenarios.
   ...
   - A new method <Link to="{{Global.API_REF_CPP_ROOT_VOICE_SDK}}/class_irtcengineex.html#api_irtcengineex_getcallidex">getCallIdEx</Link> is introduced for retrieving call IDs in multi-channel scenarios.
...
1. **Other improvements**
   ...
   - In <Link to="{{Global.API_REF_CPP_ROOT_VOICE_SDK}}/enum_audioeffectpreset.html">AUDIO_EFFECT_PRESET</Link>, a new enumeration `ROOM_ACOUSTICS_CHORUS` (chorus effect) is added, enhancing the spatial presence of vocals in chorus scenarios.
...
- <Link to="{{Global.API_REF_CPP_ROOT_VOICE_SDK}}/enum_audioeffectpreset.html">AUDIO_EFFECT_PRESET</Link> adds `ROOM_ACOUSTICS_CHORUS`, enhancing the spatial presence of vocals in chorus scenarios.

...
<ParameterList title="params" required={true}>
  ...
  The WebSocket URL endpoint for the OpenAI TTS service. See [How to use data residency](https://platform.openai.com/docs/guides/your-data#how-to-use-data-residency).
  </Parameter>

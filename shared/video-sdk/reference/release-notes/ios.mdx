...
1. **Local video rendering**
   ...
   This version adds the following members to <Link to="{{Global.API_REF_IOS_ROOT}}/agorartckit/agorartcvideocanvas">AgoraRtcVideoCanvas</Link> to support more local rendering capabilities:
...
1. **Other features**
   ...
   - New method <Link to="{{Global.API_REF_IOS_ROOT}}/">enableEncryptionEx</Link> is added for enabling media stream or data stream encryption in multi-channel scenarios.
   - New method <Link to="{{Global.API_REF_IOS_ROOT}}/">setAudioMixingPlaybackSpeed</Link> is introduced for setting the playback speed of audio files.
   - New method <Link to="{{Global.API_REF_IOS_ROOT}}/">getCallIdEx</Link> is introduced for retrieving call IDs in multi-channel scenarios.

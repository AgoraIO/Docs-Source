...
The way video is displayed on the playing device depends on the `orientationMode` used on the encoding device, orientation of the capturing device, orientation of the playing device, and whether screen rotation is enabled on the playing device. The following images show how the video is finally oriented based on these factors.

#### Orientation mode: _Adaptive_

* Screen rotation: _Disabled_
* Capturing device orientation: _Landscape_
    ![orientation_adaptive_locked_landscape](/images/video-calling/orientation_adaptive_locked_landscape.png) 

* Screen rotation: _Disabled_
* Capturing device orientation: _Portrait_
    ![orientation_adaptive_locked_portrait](/images/video-calling/orientation_adaptive_locked_portrait.png) 

* Screen rotation: _Enabled_
* Capturing device orientation: _Landscape_
    ![orientation_adaptive_unlocked_landscape](/images/video-calling/orientation_adaptive_unlocked_landscape.png) 

* Screen rotation: _Enabled_
* Capturing device orientation: _Portrait_
    ![orientation_adaptive_unlocked_portrait](/images/video-calling/orientation_adaptive_unlocked_portrait.png) 

#### Orientation mode: _Landscape_

* Capturing device orientation: _Landscape_
    ![orientation_landscape_landscape](/images/video-calling/orientation_landscape_landscape.png) 

* Capturing device orientation: _Portrait_
    ![orientation_landscape_portrait](/images/video-calling/orientation_landscape_portrait.png) 

#### Orientation mode: _Portrait_

* Capturing device orientation: _Portrait_
    ![orientation_portrait_portrait](/images/video-calling/orientation_portrait_portrait.png) 

* Capturing device orientation: _Landscape_
    ![orientation_portrait_landscape](/images/video-calling/orientation_portrait_landscape.png) 

...
v4.20.1 was released on February X, 2024.
...
v4.20.1 introduces the `"video-state-changed"` event, which enables real-time monitoring of the video states of receivers, such as freezing and recovery, thereby facilitating prompt responses. For more information, see the [API documentation](../../api-reference).

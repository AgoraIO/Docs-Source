...
-   Data synchronization with [Call Inspector](call-inspector/call-search) and [Data Insights](./data-insight), so that you can easily dive into problem analysis.

## Getting started

To access the Alert Notifications page, do the following:

1.  Subscribe to a [pricing plan](../understand/pricing) to enable the **Alert Notifications** service.
...
<td><p>A publicly accessible URL that receives HTTP requests. You can take further action according to the alert information in these requests. See <a href="#_alert_callback_parameters">Alert callback parameters</a>.</p></td>
<td><p>See <a href="#_alert_callback_parameters">Alert callback parameters</a>.</p></td>
</tr>
</tbody>
</table>
...
3.  (Optional) To further analyze an alert record, click **Call details** to use the [Call Inspector](./call-inspector/call-search) service.

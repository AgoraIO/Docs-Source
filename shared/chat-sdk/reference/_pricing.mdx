...
- The end user is considered logged in when you call the “open” function in step 6 during the user authentication process [here](h../develop/authentication#use-tokens-for-user-authentication).

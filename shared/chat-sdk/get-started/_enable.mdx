...
- A Chat pricing plan. For how to subscribe to a plan, see <Link to="../reference/pricing?platform={{platform.PATH}}#subscribe-to-the-pricing-plan">Subscribe to the pricing plan</Link>.
...
![](https://web-cdn.agora.io/docs-files/1665386519450)
...
- <Link to="../develop/offline-push?platform={{platform.PATH}}">Offline Message Push (Advanced)</Link>
...
3. On the **Subscribe** tab, you can change your Chat plan by clicking **Subscribe** on other plans.
   ![](https://web-cdn.agora.io/docs-files/1665389469534)
   **Note:** 
...
3. On the **Subscribe** tab, scroll down to the bottom and click **Unsubscribe**.
   ![](https://web-cdn.agora.io/docs-files/1665389814916)
    **Note:**
...
4. On the **Application Information** page, switch off the toggle in the **Chat Service Status** section.
   **Note:** When you disable the Chat service, the Chat-related data are still stored in the Chat data center, and you are still charged for the plan activation fee.
   ![](https://web-cdn.agora.io/docs-files/1665387330975)

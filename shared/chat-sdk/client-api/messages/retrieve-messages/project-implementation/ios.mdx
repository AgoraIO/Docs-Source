...
Other devices logged in to the account will receive the `EMMultiDevicesDelegate` callback `multiDevicesMessageBeRemoved`, and the deleted messages will be automatically removed from the device locally.

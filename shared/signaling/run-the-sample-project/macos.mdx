...
1.  Download the [RTM](https://github.com/AgoraIO/RTM) repository on Github, and locate the `Agora-RTM-Tutorial-macOS` folder or the `Agora-RTM-Tutorial-macOS-Objective-C` folder.

    Agora-RTM-Tutorial-macOS is implemented in Swift; Agora-RTM-Tutorial-macOS-Objective-C is implemented in Objective-C.

2.  Download the latest version of [Real time Messaging SDK (macOS)]({rootdir}/{local_product}/reference/downloads.html) and extract the files.

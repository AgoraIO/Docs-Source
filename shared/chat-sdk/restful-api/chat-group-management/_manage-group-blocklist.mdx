...
```shell
curl -X GET -H 'Accept: application/json' -H 'Authorization: Bearer <YourAppToken>' 'https://XXXX/app-id/XXXX/chatgroups/66XXXX85/blocks/users?pageSize=2'
```
...
```shell
curl -X POST -H 'Content-Type: application/json' -H 'Accept: application/json' -H 'Authorization: Bearer <YourAppToken>' 'http://XXXX/app-id/XXXX/chatgroups/66016455491585/blocks/users/user1'
```
...
```shell
curl -X DELETE -H 'Accept: application/json' -H 'Authorization: Bearer <YourAppToken>' 'http://XXXX/app-id/XXXX/chatgroups/66016455491585/blocks/users/user1'
```
...
```shell
curl -X DELETE -H 'Accept: application/json' -H 'Authorization: Bearer <YourAppToken>' 'http://XXXX/app-id/XXXX/chatgroups/66016455491585/blocks/users/user1%2Cuser2'
```

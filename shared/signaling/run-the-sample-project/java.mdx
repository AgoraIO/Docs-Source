...
1. Download the [<Vg k="SIG" />](https://github.com/AgoraIO/RTM) repository on Github, and locate the `Agora-RTM-Tutorial-Java` folder.
2.  Download the latest version of [<Vg k="MESS_SDK" /> (Linux Java)](../reference/downloads.html) and extract the files.

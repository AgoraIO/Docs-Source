...
<CodeItem language="shell" name="HTTPie">{`http GET https://api.sd-rtn.com/dev/v1/channel/appid \\
...
<CodeItem language="shell" name="wget">{`wget --quiet \\
  ...
  --header 'Accept: application/json' \\
  --output-document \\
  \- https://api.sd-rtn.com/dev/v1/channel/appid`}</CodeItem>
</CodeGroup>

<CodeGroup label="Javascript">
<CodeItem language="js" name="Fetch">{`const url = 'https://api.sd-rtn.com/dev/v1/channel/appid';
...
xhr.addEventListener('readystatechange', function () {
  ...
  \}
\});\n
xhr.open('GET', 'https://api.sd-rtn.com/dev/v1/channel/appid');
...
const req = unirest('GET', 'https://api.sd-rtn.com/dev/v1/channel/appid');\n
req.headers({
  Authorization: '',
  Accept: 'application/json'
});\n
...
const url = 'https://api.sd-rtn.com/dev/v1/channel/appid';
const options = {method: 'GET', headers: {Authorization: '', Accept: 'application/json'}};\n
try {
  const response = await fetch(url, options);
  const data = await response.json();
...
\{
    ...
    RequestUri = new Uri("https://api.sd-rtn.com/dev/v1/channel/appid"),
    Headers =
    \{
        \{ "Authorization", "" },
        \{ "Accept", "application/json" },
...
<CodeItem language="csharp" name="RestSharp">{`var client = new RestClient("https://api.sd-rtn.com/dev/v1/channel/appid");
...
client.prepare("GET", "https://api.sd-rtn.com/dev/v1/channel/appid")
...
<CodeItem language="java" name="Unirest">{`HttpResponse<String> response = Unirest.get("https://api.sd-rtn.com/dev/v1/channel/appid")
  .header("Authorization", "")
  .header("Accept", "application/json")
  .asString();`}</CodeItem>
</CodeGroup>
...
curl_setopt_array($curl, [
  CURLOPT_URL => "https://api.sd-rtn.com/dev/v1/channel/appid",
...
$response = Invoke-WebRequest -Uri 'https://api.sd-rtn.com/dev/v1/channel/appid' -Method GET -Headers $headers`}</CodeItem>
<CodeItem language="shell" name="RestMethod">{`$headers=@{}
$headers.Add("Authorization", "")
$headers.Add("Accept", "application/json")
$response = Invoke-RestMethod -Uri 'https://api.sd-rtn.com/dev/v1/channel/appid' -Method GET -Headers $headers`}</CodeItem>
</CodeGroup>
...
curl_easy_setopt(hnd, CURLOPT_URL, "https://api.sd-rtn.com/dev/v1/channel/appid");\n
...
NSDictionary *headers = @{ @"Authorization": @"",
                           @"Accept": @"application/json" };\n
NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:[NSURL URLWithString:@"https://api.sd-rtn.com/dev/v1/channel/appid"]
...
open Cohttp
open Lwt\n
let uri = Uri.of_string "https://api.sd-rtn.com/dev/v1/channel/appid" in
...
(client/get "https://api.sd-rtn.com/dev/v1/channel/appid" {:headers {:Authorization ""}
...
require 'net/http'\n
url = URI("https://api.sd-rtn.com/dev/v1/channel/appid")\n
...
let headers = [
  ...
  "Accept": "application/json"
\]\n
let request = NSMutableURLRequest(url: NSURL(string: "https://api.sd-rtn.com/dev/v1/channel/appid")! as URL,

...
import LinkStateEvent from '../shared/_linkstateevent.mdx'
...
<span className="index-desc-create">Call the `AgoraRtmClientKit` initializer to create and initialize the Signaling Client instance.</span>
...
<span className="index-group-rtmeventlistener">AgoraRtmClientDelegate</span>

<span className="index-desc-rtmeventlistener" >Signaling event notifications.</span>

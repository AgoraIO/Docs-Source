...
<PlatformWrapper platform="android">
1. In [Agora Console](https://console.agora.io/), download the Android package of **BytePlus Effects**.
...
1. Create a `Resource` folder under your project folder, as follows:
    ...
    └── Resource
    ```
2. In [Agora Console](https://console.agora.io/), download the iOS package of **BytePlus Effects**.

...
4. The app client initializes a <Vg k="WHITE_SDK" /> instance with the App Identifier got from the <Vg k="CONSOLE" />.
...
- `appId`: The App Identifier of the <Vg k="WHITE" /> project in <Vg k="CONSOLE" />. See [Get security credentials for your <Vg k="WHITE" /> project](../develop/enable-whiteboard).

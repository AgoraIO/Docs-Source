...
description: >
   Acquire a builder token to start a cloud recording task.
---
...
Before starting cloud recording, call this endpoint to get a resource ID. One resource ID can be used for only one recording session.
...
<ParameterList title="BODY" required={true}>
  ...
  <Parameter name="clientRequest" type="object" required={true}>
    ...
    <Parameter name="scene" type="number" required={false} defaultValue="0">
      ...
      Configuration for extended services. Only applicable in web page recording mode.
        ...
        <Parameter name="extensionServices" type="array[object]" required={true}>
          ...
          Specific configuration for the extension service.
            ...
            <Parameter name="maxRecordingHour" type="number" required={true} possibleValues="1 to 720">
            ...
            <Parameter name="videoFps" type="number" required={false} defaultValue="15" possibleValues="5 to 60">
            ...
            <Parameter name="maxVideoDuration" type="number" required={false} defaultValue="120" possibleValues="30 to 240">
            ...
            <Parameter name="readyTimeout" type="number" required={false} defaultValue="0" possibleValues="0 to 60">

...
To enable Call Inspector, subscribe to an Agora Analytics pricing plan. For details, see [Pricing Plans](/agora-analytics/reference/pricing).
...
1. Log in to [Agora Console](https://console.agora.io/) and click **Agora Analytics** > **Call Inspector** on the left navigation menu.
...
1. Subscribe to the Premium or Enterprise pricing plan. See [Subscribe to a plan](/agora-analytics/reference/pricing#subscribe). Other pricing plans do not provide access to the Call Overview page.
...
- Alternatively, you can use the Call Inspector service through the RESTful API. For details, see [Agora Analytics RESTful API](/agora-analytics/reference/agora-console-rest-api).
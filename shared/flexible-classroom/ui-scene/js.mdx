This page provides the TypeScript API reference of Agora Flexible Classroom Education Scenario.

<a id="fcruiscene"></a>

## FcrUIScene

The `FcrUIScene` is the basic interface for common Flexible Classroom scenarios. It provides the core methods.
...
| `userUuid`                | The user ID, which is the unique identifier of the user. **Ensure that this parameter is the same as the UID that you use to generate the RTM token. ** The maximum data length is 64 bytes. Supported charaters include:<ul><li>26 lowercae letters: a-z</li><li>26 upper-case letters: A-Z</li><li>10 Arabic numbers: 0-9</li><li>The empty space</li><li>"!", "#", "$", "%", "&", "(", ")", "+", "-", ":", ";", "&lt", "=", ".", ">", "?", "@", "[", "]", "^", "\_", " {", "}", "\|", "~", ","</li></ul>                                  |
| `userName`                | The user name, which is displayed in the classroom UI. The maximum data length is 64 bytes. Supported charaters include:<ul><li>26 lowercae letters: a-z</li><li>26 upper-case letters: A-Z</li><li>10 Arabic numbers: 0-9</li><li>The empty space</li><li>"!", "#", "$", "%", "&", "(", ")", "+", "-", ":", ";", "&lt", "=", ".", ">", "?", "@", "[", "]", "^", "\_", " {", "}", "\|", "~", ","</li></ul>                                                                                                                                   |
| `roleType`                | The role of the user in the classroom. See [`EduRoleTypeEnum`](#eduroletypeenum).                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `token`                   | The RTM Token. See [Secure your classrooms](https://docs.agora.io/en/flexible-classroom/develop/classroom-security).                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `roomUuid`                | The classroom ID, which is the unique identifier of the classroom. The maximum data length is 64 bytes. Supported charaters include:<ul><li>26 lowercae letters: a-z</li><li>26 upper-case letters: A-Z</li><li>10 Arabic numbers: 0-9</li><li>The empty space</li><li>"!", "#", "$", "%", "&", "(", ")", "+", "-", ":", ";", "&lt", "=", ".", ">", "?", "@", "[", "]", "^", "\_", " {", "}", "\|", "~", ","</li></ul>                                                                                                                       |
| `roomName`                | The classroom name, which is displayed in the classroom UI. The maximum data length is 64 bytes. Supported charaters include:<ul><li>26 lowercae letters: a-z</li><li>26 upper-case letters: A-Z</li><li>10 Arabic numbers: 0-9</li><li>The empty space</li><li>"!", "#", "$", "%", "&", "(", ")", "+", "-", ":", ";", "&lt", "=", ".", ">", "?", "@", "[", "]", "^", "\_", " {", "}", "\|", "~", ","</li></ul>                                                                                                                              |
...
| `courseWareList`          | (Optional) The courseware list specified by the education provider. Users cannot change the value from app clients. See [`CourseWareList`](#coursewarelist)。Once the courseware list is specified, the SDK downloads the specified coursewares from cloud drive to the local device.                                                                                                                                                                                                                                                        |
...
| `virtualBackgroundImages` | (Optional) The URL of the virtual background image. The domain if the image should be the same with `webrtcExtensionBaseUrl`. Supported formats include PNG and JPG.                                                                                                                                                                                                                                                                                                                                                                         |
...
| `uiMode`                  | (Optional) The theme of the classroom UI. See [`FcrMultiThemeMode`](#fcrmultithememode)。                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `shareUrl`                | (Optional) The URL for sharing.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `widgets`                 | (Optional) The widget list, which extends the capabilities of the classroom.See [Embed a custom plugin](https://docs.agora.io/en/flexible-classroom/develop/embed-custom-plugin).                                                                                                                                                                                                                                                                                                                                                            |
...
| Parameter | Description                                                                                                                                                                       |
| :-------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `mode`    | The encryption mode. See [`MediaEncryptionMode`](#mediaencryptionmode). All the teachers and students in the same classroom need use the same encryption mode and encryption key. |
...
The channel profile set in [`LaunchMediaOptions`](#launchmediaoptions).

| Parameter          | Description                                                                                                                                    |
| :----------------- | :--------------------------------------------------------------------------------------------------------------------------------------------- |
| `Communication`    | `0`: The communication mode, which is used in one-to-one or small online classes.                                                              |
| `LiveBroadcasting` | `1`: The live-broadcasting profile. Compared with the communication profile, the live-broadcasting profile costs lower and has higher latency. |
...
The theme of the classroom UI set in [`LaunchOption`](#launchoption).
...
| Parameter | Description                                  |
| :-------- | :------------------------------------------- |
| `teacher` | `1`: The teacher or the proctor.             |
| `student` | `2`: The student, who takes the online exam. |
...
| Parameter        | Description                                                                                                                                               |
| :--------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `RoomSmallClass` | `4`: Small online classes, where a teacher teaches online and multiple students watch and listen. The maximum number of students in a small class is 200. |

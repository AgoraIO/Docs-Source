...
Before you begin, make sure you have downloaded the latest Cloud Gateway. See [Integrate the Java SDK](integrate_java_sdk).
...
Refer to [Cloud Gateway Java API Reference](/en/server_gateway/API%20Reference/linux_server_java/index.html) to find detailed API and parameter descriptions.

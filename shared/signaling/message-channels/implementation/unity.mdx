...
Use the `SubscribeAsync` method to subscribe to a message channel. After you subscribe, you receive `OnMessageEvent` and other event notifications within the channel.

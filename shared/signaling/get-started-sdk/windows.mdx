...
- Go to [SDK Downloads](/sdks), download the latest version of the RTM C++ SDK for Windows, and unzip the downloaded SDK package.
...
Generating a token by hand is not helpful in a production context. [Authenticate Your Users with Tokens](../develop/authentication) shows you how to start real-time messaging with a token that you retrieve from your server.

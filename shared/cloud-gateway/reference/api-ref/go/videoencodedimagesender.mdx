...
<span className="index-desc-videoencodedimagesender">`VideoEncodedImageSender` Class.</span>

<h2 className="anchor index-group-item-videoencodedimagesender index-api-newvideoencodedimagesender" id="newvideoencodedimagesender">NewVideoEncodedImageSender</h2>
...
<span className="index-desc-newvideoencodedimagesender">Creates a video encoded data sender module. This method creates a `VideoEncodedImageSender` object, which can be used in the [`NewCustomVideoTrackEncoded`](./localaudiotrack#newcustomvideotrackencoded) method.</span>
...
<h2 className="anchor index-group-item-videoencodedimagesender index-api-sendencodedvideoimage" id="sendencodedvideoimage">SendEncodedVideoImage</h2>

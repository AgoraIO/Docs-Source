...
To initialize the SDK after a user agrees to the app's privacy policy, use the following code. Call `sharedEngineWithConfig` to create and initialize an instance of `AgoraRtcEngineKit`:

...
- **Agora credentials from <Vg k="CONSOLE" />** 
    ...
    - [App ID](/realtime-communication/get-started/manage-agora-account#create-an-agora-project)
    - [App Certificate](/realtime-communication/get-started/manage-agora-account#create-an-agora-project) 

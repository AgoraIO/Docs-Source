...
When you need to [create and manage Agora projects](#manage-projects) or [check usage](#check-usage), besides using the graphic user interface at Agora Console, you can also call the Agora Console RESTful API.
...
| Parameter | Type   | Description                                                                                                   |
|-----------|--------|---------------------------------------------------------------------------------------------------------------|
| `id`      | String | (Required) The project ID, which can be obtained by calling the [Gets all projects](#_gets_all_projects) API. |

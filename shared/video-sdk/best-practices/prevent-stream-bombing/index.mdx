...
| Characters and scenarios  | Authentication steps  |
|:--------------------------|:---------------------------------------------|
...
<Admonition>
If your business scenario requires more refined streaming permission control, refer to the [Co-host token authentication](../get-started/authentication-workflow#co-host-token-authentication) guide.
</Admonition>

...
- An [Agora project](/agora-chat/reference/manage-agora-account#create-an-agora-project) with the [App Certificate](/agora-chat/reference/manage-agora-account#get-the-app-certificate) and Agora Chat enabled. See [Enable and Configure Chat Service](../get-started/enable) for details.

...
- The Agora <Vg k="MESS_SDK" /> supports creating multiple <Link to="{{Global.SIGNALING_API_REF_CPP_ROOT}}/classagora_1_1rtm_1_1_i_rtm_service.html">IRtmService</Link> instances that are independent of each other.

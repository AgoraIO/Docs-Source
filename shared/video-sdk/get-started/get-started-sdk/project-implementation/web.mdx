    ...
    async function startBasicCall()
{
    ...
    For <Vg k="BS" /> choose `Level: 1` for audience roles. This ensures low latency, which is a feature of <Vg k="BS" /> and its use is subject to special [pricing](../reference/pricing#unit-pricing).
    </ProductWrapper>

...
1. Open the `xcworkspace` file in Xcode.
 ...
 The Agora Chat iOS SDK provides the `PrivacyInfo.xcprivacy` file that contains the required reasons for the APIs used by the SDK. To add the privacy manifest to your app in Xcode, follow these steps:
...
1. Create a privacy manifest in your app project:
   ...
   The default file name is `PrivacyInfo.xcprivacy` which is the required file name for bundled privacy manifests.

...
- **Write the integration document for your extension**
    ...
    The easier it is for other developers to integrate your extension, the more it will be used. Follow the guidelines and create the best [Integration guide for your extension](../develop/implementation-guide)

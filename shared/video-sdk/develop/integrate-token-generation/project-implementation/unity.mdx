...
1.  **Add the NuGet package**
    ...
    To generate a token, <Vg k="COMPANY" /> uses the `Crc32` algorithm. To add [NuGET](https://www.nuget.org/packages/Crc32.NET) **NuGet package** to your project, open a terminal window in your project folder, then run the following command:

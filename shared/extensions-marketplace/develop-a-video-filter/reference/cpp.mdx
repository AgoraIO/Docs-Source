...
- [IExtensionVideoFilter](#iextensionvideofilter): Implement receiving, processing, and delivering video data.
- [`IExtensionProvider`](#iextensionprovider): encapsulate your `IExtensionVideoFilter` implementation into an extension.

...
![Extension Marketplace-FaceUnity](Images/faceunity_extension_marketplace_1.png)

Then, Copy the <u>authpack.h</u> file to agora-live project's directory(<u>/agora-live/iOS/FULib/</u>).

![AuthPack](Images/authpack_ios_1.png)
![AuthPack](Images/authpack_ios_2.png)
...
![AuthPack](Images/authpack_ios_3.png)
...
![Agora Live iOS Project](Images/agoralive_ios_project.png)
...
![Agora Live Pod Install](Images/agoralive_podInstall.png)
...
![Agora Live iOS Project -1 ](Images/aogralive_ios1.png)
![Agora Live iOS Project -2 ](Images/aogralive_ios2.png)
![Agora Live iOS Project -3 ](Images/aogralive_ios3.png)
...
![iOS Known Issue -1](Images/ios_known_issue_1.png)
...
![iOS Known Issue -2](Images/ios_known_issue_2.png)
...
In the meantime, use the [CLI + SDK quickstart](/conversational-ai/get-started/quickstart-cli)
...
<Admonition type="info" title="Coming soon">
The Go backend walkthrough is not yet available. It will mirror the Python path: a standalone backend on port 8000, a Next.js web client on port 3000, and the same three HTTP endpoints. In the meantime, see the [Run the starter project](quickstart-clone) guide to get started with Go.
</Admonition>
...
[Run the starter project](quickstart-clone) guide in the meantime.
</Admonition>

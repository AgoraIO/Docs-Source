...
| `roomProperties.schedule.duration`                   | Integer | (Optional) The duration of the class (s).                                                                                                                                                                                 |
| `roomProperties.schedule.closeDelay`                 | Integer | (Optional) The delay of the class end time (s).                                                                                                                                                                           |
...
| `roomProperties.processes.handsUp.defaultAcceptRole` | String  | (Optional) The default user on the stage. If you hope to set the student on the stage, set it as `"audience"`. If not, set is as `""` or do not set this parameter.                                                       |
| `roomProperties.flexProps`                           | Object  | (Optional) The initial properties of the classroom.                                                                                                                                                                       |

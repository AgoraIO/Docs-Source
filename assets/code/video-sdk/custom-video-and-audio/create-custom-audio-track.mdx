<PlatformWrapper platform="react-js">
    ...
    const createCustomAudioTrack = () => {
        ...
        .then((stream) => {
            ...
            // For demonstration purposes, we used the default audio device. In a real-time use-case, you can use the dropdown to select the audio device of your choice.

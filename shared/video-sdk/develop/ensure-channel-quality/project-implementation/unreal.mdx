...
1. Add a text widget for the echo test button. Drag **Text** from **Palette** > **Common** to the canvas panel. In **Details**, change the **Text** field to `Echo Test`, then change the following properties in **Details**:
...
1. Add a text widget for the video quality button, change the **Text** field to `Video Quality`, then change the following properties in **Details**:

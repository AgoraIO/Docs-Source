...
<ParameterList title="BODY" required={true}>
  ...
  <Parameter name="preset" type="string" required={false} deprecated>
    Deprecated. Use `credential_mode: "managed"` within the `asr`, `llm`, or `tts` block instead. See [Use managed mode](/conversational-ai/develop/managed-mode).
  ...
  <Parameter name="pipeline_id" type="string" required={false}>
    The unique ID of a published agent in [<Vpd k="STUDIO" />](/conversational-ai/studio/overview). When provided, the saved agent configuration is used as the base configuration. Any fields specified in `properties` override the corresponding agent settings. When you specify a `pipeline_id`, the `asr`, `tts`, and `llm` fields in `properties` are optional.
  </Parameter>
  ...
  <Parameter name="properties" type="object" required={true}>
    ...
    <Parameter name="idle_timeout" type="integer" defaultValue="30" possibleValues="[0,259200]" required={false}>
    ...
    <Parameter name="advanced_features" type="object" required={false}>
      ...
      <Parameter name="enable_mllm" type="boolean" deprecated defaultValue="false" required={false}>
    ...
    <Parameter name="asr" type="object" required={false}>
      ...
      <Parameter name="credential_mode" type="string" possibleValues="managed, byok" defaultValue="byok" required={false}>
        The credential mode for this provider:

        - `managed`: Use Agora-managed credentials. You do not need to provide an API key. See [Use managed mode](/conversational-ai/develop/managed-mode).
      ...
      <Parameter name="vendor" type="string" defaultValue="ares" possibleValues="ares,microsoft,deepgram,openai,google,amazon,assemblyai,sarvam,xai" required={false}>
      ASR provider:
      ...
      - `openai`: [OpenAI](/conversational-ai/models/asr/openai)
      ...
      - `amazon`: [Amazon Transcribe](/conversational-ai/models/asr/amazon)
      - `google`: [Google](/conversational-ai/models/asr/google)
      - `sarvam`: [Sarvam](/conversational-ai/models/asr/sarvam)
      - `xai`: [xAI](/conversational-ai/models/asr/xai)
    ...
    <Parameter name="tts" type="object" required={true}>
      ...
      <Parameter name="vendor" type="string" required={true} possibleValues="microsoft,elevenlabs,minimax,deepgram,cartesia,openai,humeai,rime,fishaudio,google,amazon,sarvam,xai">
        TTS provider. 
        ...
        - `deepgram`: [Deepgram](/conversational-ai/models/tts/deepgram)
        - `murf`: [Murf](/conversational-ai/models/tts/murf)
        ...
        - `rime`: [Rime](/conversational-ai/models/tts/rime)
        - `fishaudio`: [Fish Audio](/conversational-ai/models/tts/fish-audio)
        - `google`: [Google](/conversational-ai/models/tts/google)
        - `amazon`: [Amazon Polly](/conversational-ai/models/tts/amazon)
        - `sarvam`: [Sarvam](/conversational-ai/models/tts/sarvam)
        - `xai`: [xAI](/conversational-ai/models/tts/xai)
    ...
    <Parameter name="llm" type="object" required={true}>
      ...
      <Parameter name="greeting_configs" type="object" required={false}>
        ...
        <Parameter name="delay_ms" type="integer" required={false} possibleValues="[0,5000]">
        ...
        <Parameter name="audio_download_timeout_ms" type="integer" required={false} defaultValue="1000" possibleValues="[200, 10000]">
          The timeout in milliseconds for downloading the greeting audio file. Only takes effect when `greeting_audio_url` is configured. If the download times out, the system falls back to TTS synthesis using `greeting_message`.
        </Parameter>

        <Parameter name="audio_pcm_sample_rate" type="integer" required={false} defaultValue="16000">
          The sample rate in Hz of the greeting audio file when the format is PCM. Only takes effect when `greeting_audio_url` is configured and the audio format is PCM. Not required for `mp3` or `wav` files.
        </Parameter>
      </Parameter>

      <Parameter name="greeting_audio_url" type="string" required={false}>
        The URL of a pre-recorded audio file to play as the agent's greeting. When configured, the system downloads and plays this recording instead of synthesizing the greeting via TTS.
        ...
        <Admonition type="info">
        - You must also configure `greeting_message` as a fallback when using `greeting_audio_url`; otherwise the request returns a `400` error.
        - If the recording fails to download, decode, or is in an unsupported format, the system automatically falls back to TTS synthesis using `greeting_message`.
        </Admonition>
      </Parameter>      

      <Parameter name="greeting_message" type="string" required={false}>
        Agent greeting text. This field serves the following purposes:
      ...
      <Parameter name="vendor" type="string" required={false} possibleValues="openai,azure,xai,custom">
        LLM provider, supports the following settings:
        - `openai`: [OpenAI](/conversational-ai/models/llm/openai)
        - `azure`: [Azure OpenAI](/conversational-ai/models/llm/azure-openai)
        - `xai`: [xAI Grok](/conversational-ai/models/llm/xai)
        - `custom`: [Custom LLM](/conversational-ai/develop/custom-llm). When you set this option, the agent includes the following fields, in addition to `role` and `content` when making requests to the custom LLM:
    ...
    <Parameter name="mllm" type="object" required={false}>
      ...
      <Parameter name="vendor" type="string" required={false} possibleValues="openai,gemini,vertexai,xai">
        MLLM provider. Currently supports:
        - `openai`: [OpenAI Realtime API](/conversational-ai/models/mllm/openai)
        - `gemini`: [Google Gemini Live](/conversational-ai/models/mllm/gemini)
        - `vertexai`: [Google Gemini Live (Vertex AI)](/conversational-ai/models/mllm/google-vertex-ai)
        - `xai`: [xAI Grok](/conversational-ai/models/mllm/xai)
      </Parameter>
    ...
    <Parameter name="avatar" type="object" required={false}>  
      ...
      <Parameter name="vendor" type="string" possibleValues="akool,liveavatar,anam,generic" required={false}>  
        Avatar vendor. Supports the following values:  
        - `akool`: [Akool](/conversational-ai/models/avatar/akool)
        - `liveavatar`: [LiveAvatar](/conversational-ai/models/avatar/heygen)
        - `anam`: [Anam](/conversational-ai/models/avatar/anam)
        - `generic`: [Generic](/conversational-ai/models/avatar/generic)
      </Parameter> 
    ...
    <Parameter name="turn_detection" type="object" required={false} collapse={false}>
      ...
      <Parameter name="config" type="object" required={false}>
        ...
        <Parameter name="start_of_speech" type="object" required={false}>
          ...
          <Parameter name="mode" type="string" required={true} possibleValues="vad, keywords, disabled, manual">
          ...
          <Parameter name="{mode}_config" type="object" required={false}>
            ...
            <Parameter name="interrupt_duration_ms" type="integer" required={false} defaultValue="160" possibleValues="[120,1200]">
            ...
            <Parameter name="speaking_interrupt_duration_ms" type="integer" required={false} defaultValue="160" possibleValues="[120,1200]">
            Interruption duration in milliseconds while the agent is speaking.
            </Parameter>

            <Parameter name="prefix_padding_ms" type="integer" required={false} defaultValue="800" possibleValues="[0,5000]">
            ...
            <Parameter name="triggered_keywords" type="array[string]" required={false}>
            ...
            <Parameter name="strategy" type="string" required={false} possibleValues="append, ignore">
        ...
        <Parameter name="end_of_speech" type="object" required={false}>
          ...
          <Parameter name="mode" type="string" required={false} possibleValues="vad, semantic, manual">
          ...
          <Parameter name="{mode}_config" type="object" required={false}>
            ...
            **Configuration examples:**
            ...
            <Parameter name="silence_duration_ms" type="integer" possibleValues="[120, 2000]" required={false}>
            ...
            <Parameter name="max_wait_ms" type="integer" defaultValue="3000" possibleValues="[500, 10000]" required={false}>
              `-1` means forever.  
            ...
            <Parameter name="pause_state_enabled" type="boolean" defaultValue="true" required={false}>
    ...
    <Parameter name="interruption" type="object" required={false}>
      Interruption control configuration. Provides unified management of the agent's behavior when interrupted by the user.

      <Parameter name="enable" type="boolean" defaultValue="true" required={false}>
      ...
      <Parameter name="mode" type="string" defaultValue="start_of_speech" possibleValues="start_of_speech, keywords" required={false}>
      ...
      <Parameter name="content" type="object" required={false}>
        ...
        <Parameter name="{mode}_config" type="object" required={false}>
          ...
          **Static filler word configuration example:**
          ...
          <Parameter name="phrases" type="array[string]" required={true}>
    ...
    <Parameter name="parameters" type="object" required={false}>
      ...
      <Parameter name="audio_scenario" type="string" defaultValue="default" required={false}possibleValues="default,chorus,aiserver">
      ...
      <Parameter name="opt_out" type="boolean" required={false} defaultValue="false">
...
- If the returned status code is `200`, the request was successful. The response body contains the result of the request.
  ...
  <ParameterList title="OK">
    ...
    <Parameter 
      name="status" 
      type="string" 
      possibleValues="IDLE, STARTING, RUNNING, STOPPING, STOPPED, FAILED"
    >
      Current status.
      <ul>

...
- **Live captions**: Supports real-time text output of conversations between users and the AI agent for caption display in your app's UI. Agora provides an open-source caption processing module. Simply integrate the module and call its API to implement live captions. For details, see [Display live captions](../develop/captions).

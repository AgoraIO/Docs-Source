...
-   The Agora <Vg k="SIG_SDK" /> supports creating multiple <Link to="{{Global.SIGNALING_API_REF_OC_ROOT}}/Classes/AgoraRtmKit.html">AgoraRtmKit</Link>/) instances that are independent of each other.

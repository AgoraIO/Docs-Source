...
1. Configure SAML settings in Agora Console
   ...
   In the **SAML Configuration** section on the [SSO Management](https://console.agora.io/settings/m_sso) page in Agora Console, enter the following information from Oksa Console:

...
* Changes to [**Start a conversational AI agent**](/conversational-ai/rest-api/agent/join)
    ...
    * **Behavior changes**
        ...
        - When `turn_detection.end_of_speech.mode` is set to `semantic`, EOS detection now supports Chinese and English only. For unsupported languages, the engine automatically falls back to VAD.
    ...
    * **Removed fields**
        ...
        - `mllm.style` for OpenAI Realtime API and Gemini Live vendors.

...
v2.8.12 was released on February 3, 2023.

#### Issues fixed

This release fixes some known issues in the proctoring scenarios.
...
v2.8.10 was released on January 10, 2023.
...
See [UI Builder quickstart](../get-started/get-started-uibuilder).
...
v2.7.x was released on August 5, 2022.

#### New features

**New UI theme**

v2.7.x enables you to set the display theme of the classroom UI to light or dark.

**New language supported**

v2.7.x supports setting the language of the classroom UI to Chinese or English.
...
v2.7.x enhanced the UI layer code for developers to customize the classroom UI.

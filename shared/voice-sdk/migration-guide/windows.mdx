...
See the [LiveBroadcasting](https://github.com/AgoraIO/API-Examples/tree/4.0.0-beta/windows/APIExample/APIExample/Basic/LiveBroadcasting) sample project to update the code in your app.
...
-   Custom video source/Custom video renderer: [CustomVideoCapture](https://github.com/AgoraIO/API-Examples/tree/4.0.0-beta/windows/APIExample/APIExample/Advanced/CustomVideoCapture)

-   Switching video source: [ScreenCapture](https://github.com/AgoraIO/API-Examples/blob/4.0.0-beta/windows/APIExample/APIExample/Advanced/ScreenShare)
...
See the [Beauty](https://github.com/AgoraIO/API-Examples/tree/4.0.0-beta/windows/APIExample/APIExample/Advanced/Beauty) sample project to update the code in your app.

...
![Server settings](https://agora-doc.s3.us-east-1.amazonaws.com/images/media-gateway/obs-server-setting.png)
...
1. On the **Settings > Output > Live** page, configure the video profile, keyframe interval, and x264 options.
    ...
    ![Encoder settings](https://agora-doc.s3.us-east-1.amazonaws.com/images/media-gateway/obs-encoder-settings.png)

1. On the **Settings > Video** page, configure common frame rates.

    ![FPS settings](https://agora-doc.s3.us-east-1.amazonaws.com/images/media-gateway/obs-fps-setting.png)

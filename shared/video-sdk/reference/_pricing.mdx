...
The Agora [Pricing calculator](../overview/pricing-calculator) helps you estimate your usage costs based on the number of hosts, their published streams, and the number of audience members in a channel. Use this tool to understand the pricing policy and estimate your session costs or monthly expenses.
</Admonition>

...
For scenarios demanding high data security, this release introduces end-to-end media encryption in addition to [Secure channel encryption](../develop/media-stream-encryption?platform=web). This feature encrypts media streams on the sender's device and decrypts them on the receiver's device, ensuring that data remains inaccessible to third parties during transmission. To enable end-to-end media encryption, please contact technical support.

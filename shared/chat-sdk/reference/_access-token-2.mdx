...
## Prerequisites 
- You have built a token server based on Spring Framework and a Web client using Chat according to <Link to="../develop/generate-user-tokens">Authenticate Your Users with Tokens</Link>.

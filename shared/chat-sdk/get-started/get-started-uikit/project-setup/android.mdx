...
2. Integrate the Chat SDK into your project with Maven Central. 
   ...
   ```
	...
	b. In `/Gradle Scripts/build.gradle(Module: <projectname>.app)`, add the following lines to integrate the Chat UI sample into your Android project:
   ...
   dependencies {
       ...
       // Replace X.Y.Z with the latest version of the Chat UI sample. 

...
The following implementation steps apply to the latest version of the <Vg k="RTEE_NS" /> extension. Refer to the [extension release notes](/video-calling/overview/release-notes#ai-noise-suppression) for details.
</Admonition>

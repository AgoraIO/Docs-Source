...
Before proceeding, ensure that you have integrated the Agora <Vg k="MESS_SDK" /> into your project. To learn more about integration, refer to the [Quickstart](../develop/get-started-sdk).

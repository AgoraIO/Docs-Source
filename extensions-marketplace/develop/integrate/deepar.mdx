...
This is the DeepAR Agora extension for Web.

DeepAR Extension is just a wrapper around the [DeepAR Web](https://www.npmjs.com/package/deepar) that simplifies the integration with the Agora RTC platform.
For more information on DeepAR visit https://www.deepar.ai.

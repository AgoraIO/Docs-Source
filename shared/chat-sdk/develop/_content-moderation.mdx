...
1. Under **My Projects**, locate the project that has Chat enabled and click the **Edit** ✎ button.

1. On the project config page, select **Chat > Features** > **Overview** and scroll to the **Moderation Feature Configuration**.

1. Configure specific moderation options, as shown in the following figure:

    ![Chat Moderation](/images/chat/configure-moderation.png)
...
1. To enter the **Message Report** page, under **My Projects**, locate the project that has Chat enabled and click the **Edit** ✎ button. On the project config page, select **Chat > Message Report**:
	 
	 ![report_en](/images/chat/configure-message-report.png)
...
1. Under **My Projects**, locate the project that has Chat enabled and click the Edit ✎ button. On the project config page, select **Chat > Operation Management > User**:

    ![user_manage](/images/chat/configure-user-management.png)

2. To take action on a user, such as banning a user, deleting a user, or forcing a user to go offline, search for the user ID, and click **More**:

   ![user_manage_action](/images/chat/configure-user-action.png)

### Take actions on chat group members

1. Under **My Projects**, locate the project that has Chat enabled and click the Edit ✎ button. On the project config page, select **Chat > Operation Management > Group**, as shown in the following figure:

   ![group_manage](/images/chat/configure-group-management.png)

2. To take action on a group or its members, such as removing a member from the group or adding a user to the group blocklist, search for the group ID, and click **More**:

   ![group_manage_action](/images/chat/configure-group-action.png)
...
1. Under **My Projects**, locate the project that has Chat enabled and click the Edit ✎ button. On the project config page, select **Chat > Operation Management > Chatroom**, as shown in the following figure:

	 ![room_manage](/images/chat/configure-chatroom-management.png)

2. To take action on a Chatroom, such as removing a member from the room or adding a user to the room's blocklist, search for the room ID, and click **More**:

	 ![room_manage_action](/images/chat/configure-chatroom-action.png)

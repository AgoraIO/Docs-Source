...
| `channelType` | <code>{enumv.channeltype[props.ag_platform]}</code> | Required | - | Channel types. See <a href="../enumv#channeltype"><code>{enumv.channeltype[props.ag_platform]}</code></a>. |
| `options` | `GetOnlineUsersOptions` | Required | - | Query options. |
| `resultCallback` | `ResultCallback<GetOnlineUsersResult>` | Required | - | Callback of invocation result:<li>Success: Executes the `onSuccess` method and return the `GetOnlineUsersResult` query result.</li><li>Failure: Executes the `onFailure` method and return an error result.</li> |
...
| `resultCallback` | `ResultCallback<ArrayList<ChannelInfo>>` | Required | - | Callback of invocation result:<li>Success: Executes the `onSuccess` method and return the `ArrayList<ChannelInfo>` query result.</li><li>Failure: Executes the `onFailure` method.</li> |
...
| `channelType` | <code>{enumv.channeltype[props.ag_platform]}</code> | Channel types. See <a href="../enumv#channeltype"><code>{enumv.channeltype[props.ag_platform]}</code></a>. |
...
You can call the <code>{presence.setstate[props.ag_platform]}</code> method in the following way:
...
| `channelName` | String | Required | - | Channel name |
| `channelType` | <code>{enumv.channeltype[props.ag_platform]}</code> | Required | - | Channel types. See <a href="../enumv#channeltype"><code>{enumv.channeltype[props.ag_platform]}</code></a>. |
| `items` | `ArrayList<StateItem>` | Required | - | User state, an array of `StateItem`. |
...
You can call the <code>{presence.getstate[props.ag_platform]}</code> method in the following way:
...
| `channelType` | <code>{enumv.channeltype[props.ag_platform]}</code> | Required | - | Channel types. See <a href="../enumv#channeltype"><code>{enumv.channeltype[props.ag_platform]}</code></a>. |
| `userId` | String | Required | - | User ID. |
| `resultCallback` | `ResultCallback<UserState>` | Required | - | Callback of invocation result:<li>Success: Executes the `onSuccess` method and return the <code>{presence.userstate[props.ag_platform]}</code> query result.</li><li>Failure: Executes the `onFailure` method.</li> |
...
| `states` | `ArrayList<StateItem>` | Temporary user state, an array of `StateItem`. |
...
You can call the <code>{presence.removestate[props.ag_platform]}</code> method in the following way:

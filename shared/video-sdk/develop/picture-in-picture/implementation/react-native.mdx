...
Starting from <Vg k="VSDK" /> v4.6.2, <Vg k="COMPANY" /> provides the <Link to="{{global.API_REF_RN_ROOT}}/class_agorapip.html">`AgoraPip`</Link> controller and related configuration options for enabling and managing PiP on Android and iOS. This section describes how to implement Picture-in-Picture in your React Native project.

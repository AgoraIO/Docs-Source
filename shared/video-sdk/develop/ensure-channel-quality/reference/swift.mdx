...
- <Link to="{{Global.API_REF_IOS_ROOT_RTC_KIT}}/agoraaudioscenario">AgoraAudioScenario</Link>

- <Link to="{{Global.API_REF_IOS_ROOT_RTC_ENGINE_KIT}}/enabledualstreammode(_:)">enableDualStreamMode</Link>
...
- <Link to="{{Global.API_REF_IOS_ROOT_RTC_ENGINE_KIT}}/startlastmileprobetest(_:)">startLastmileProbeTest</Link>

- <Link to="{{Global.API_REF_IOS_ROOT_RTC_ENGINE_KIT}}/setremotevideostreamex(_:type:connection:)">setRemoteVideoStream</Link>

- <Link to="{{Global.API_REF_IOS_ROOT_RTC_KIT}}/agoralogconfig">AgoraLogConfig</Link>

- <Link to="{{Global.API_REF_IOS_ROOT_RTC_ENGINE_KIT}}/setlocalaccesspoint(withconfig:)">setLocalAccessPoint</Link>
</PlatformWrapper>
...
- <Link to="{{Global.API_REF_MACOS_ROOT_RTC_KIT}}/agoraaudioscenario">AgoraAudioScenario</Link>

- <Link to="{{Global.API_REF_MACOS_ROOT_RTC_ENGINE_KIT}}/enabledualstreammode(_:)">enableDualStreamMode</Link>
...
- <Link to="{{Global.API_REF_MACOS_ROOT_RTC_ENGINE_KIT}}/startlastmileprobetest(_:)">startLastmileProbeTest</Link>

- <Link to="{{Global.API_REF_MACOS_ROOT_RTC_ENGINE_KIT}}/setremotevideostreamex(_:type:connection:)">setRemoteVideoStream</Link>

- <Link to="{{Global.API_REF_MACOS_ROOT_RTC_KIT}}/agoralogconfig">AgoraLogConfig</Link>

- <Link to="{{Global.API_REF_MACOS_ROOT_RTC_ENGINE_KIT}}/setlocalaccesspoint(withconfig:)">setLocalAccessPoint</Link>
</PlatformWrapper>

...
This page introduces how to check your usage of Agora products in Agora Console, such as <Vg k="ILS" />, <Vg k="BS" />, Media Push, On-Premise Recording, Cloud Recording, and Interactive Whiteboard.
...
1.  Enter the <Link to="{{Global.AGORA_CONSOLE_URL}}/usage">Usage</Link> page in Console.

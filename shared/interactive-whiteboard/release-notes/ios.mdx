...
- [`insertText`](./API%20Reference/whiteboard_oc/Classes/WhiteRoom.html#//api/name/insertText:y:textContent:completionHandler:)
- [`getSceneFromScenePath`](./API%20Reference/whiteboard_oc/Classes/WhiteDisplayer.html#//api/name/getSceneFromScenePath:result:)
- [`setDrawOnlyApplePencil`](./API%20Reference/whiteboard_oc/Classes/WhiteRoom.html#//api/name/setDrawOnlyApplePencil:)
- [`drawOnlyApplePencil`](./API%20Reference/whiteboard_oc/Classes/WhiteRoomConfig.html?platform=iOS#/api/name/drawOnlyApplePencil)
- [`disableNewPencilStroke`](./API%20Reference/whiteboard_oc/Classes/WhiteSdkConfiguration.html?platform=iOS#/api/name/disableNewPencilStroke)
...
- [`initWithUuid:roomToken`](./API%20Reference/whiteboard_oc/Classes/WhiteRoomConfig.html#//api/name/initWithUuid:roomToken:)
- [`initWithUuid:roomToken:userPayload`](./API%20Reference/whiteboard_oc/Classes/WhiteRoomConfig.html#//api/name/initWithUuid:roomToken:userPayload:)
...
- To improve security, disables the `allowUniversalAccessFromFileURLs` function inside the whiteboard. After turning off this function, when you call [`getSceneSnapshotImage`](https://docs.agora.io/en/whiteboard/API%20Reference/whiteboard_oc/Classes/WhiteDisplayer.html#//api/name/getSceneSnapshotImage:completion:), cross-origin images might not be displayed in the generated screenshots.
...
- The hand tool was not restricted by the set [`WhiteCameraBound`](https://docs.agora.io/en/whiteboard/API%20Reference/whiteboard_oc/Classes/WhiteCameraBound.html).
- On some high-resolution devices, when the user was in the `Follower` of [`setViewMode`](https://docs.agora.io/en/whiteboard/API%20Reference/whiteboard_oc/Classes/WhiteRoom.html#/api/name/setViewMode:) view mode, the center point of the view was slightly shifted.
- The following issues with displaying dynamic PPT files in the whiteboard were fixed:
  ...
  - The slide was displayed incorrectly when the user called [`pptPreviousStep`](https://docs.agora.io/en/whiteboard/API%20Reference/whiteboard_oc/v2.13.15/Classes/WhiteRoom.html#/api/name/pptPreviousStep) to roll back a slide.
...
- Adds the `previewURL` parameter in `WhitePptPage`, which supports displaying dynamic PPT previews in the whiteboard. See [API reference](https://docs.agora.io/en/whiteboard/API%20Reference/whiteboard_oc/Classes/WhitePptPage.html#/api/name/previewURL).

...
<Admonition type="info" title="Note">Starting from v4.4.0, the SDK provides an API sunset notice, which includes information about deprecated and removed APIs in each version. See <Link to="{{Global.API_REF_IOS_ROOT_VOICE_SDK}}/agorartckit">API reference</Link>.</Admonition>
...
1. **<Vpd k="SDK_LITE"/>**
   ...
   - For the list of APIs supported by <Vpd k="SDK_LITE"/>, see <Link to="{{Global.API_REF_IOS_ROOT_VOICE_SDK}}/agorartckit">API reference</Link>.
...
1. **Other features**
   ...
   - A new method <Link to="{{Global.API_REF_IOS_ROOT_VOICE_SDK}}/agorartckit/agorartcenginekit/enableencryptionex(_:encryptionconfig:connection:)">enableEncryptionEx</Link> is added for enabling media stream or data stream encryption in multi-channel scenarios.
   ...
   - A new method <Link to="{{Global.API_REF_IOS_ROOT_VOICE_SDK}}/agorartckit/agorartcenginekit/getcallidex(_:)">getCallIdEx</Link> is introduced for retrieving call IDs in multi-channel scenarios.
...
1. **Other improvements**
   ...
   - In <Link to="{{Global.API_REF_IOS_ROOT_VOICE_SDK}}/agorartckit/agoraaudioeffectpreset">AgoraAudioEffectPreset</Link>, a new enumeration `AgoraAudioEffectPresetRoomAcousticsChorus` (chorus effect) is added, enhancing the spatial presence of vocals in chorus scenarios.
...
- <Link to="{{Global.API_REF_IOS_ROOT_VOICE_SDK}}/agorartckit/agoraaudioeffectpreset">AgoraAudioEffectPreset</Link> adds `AgoraAudioEffectPresetRoomAcousticsChorus`, enhancing the spatial presence of vocals in chorus scenarios

...
Integrate the Agora <Vg k="SIG_SDK" /> for Web into your project through npm, as follows:
...
-   The Agora <Vg k="SIG_SDK" /> supports creating multiple <Link to="{{Global.SIGNALING_API_REF_WEB_ROOT}}/classes/rtmclient.html">RtmClient</Link> instances that are independent of each other.

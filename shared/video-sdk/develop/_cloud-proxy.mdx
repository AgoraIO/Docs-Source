...
-   **Force UDP**
    ...
    <Vpd k="SDK" /> securely sends media over UDP only. Your end users’ firewall must be configured to trust a list of [allowed IP address](../reference/cloud-proxy-allowed-ips).

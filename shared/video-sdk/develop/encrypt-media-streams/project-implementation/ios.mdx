...
1. Implement client-side logic:
    ...
    1. Before joining the channel, call `enableEncryption`, set the `AgoraEncryptionModeAES128GCM2` or `AgoraEncryptionModeAES256GCM2` encryption mode, and pass the key and salt into the SDK.

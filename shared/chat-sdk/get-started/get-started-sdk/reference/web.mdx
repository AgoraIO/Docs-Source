...
In addition to integrating the Chat SDK into your project through npm, you can also manually download the [Chat SDK for Web](https://www.npmjs.com/package/agora-chat). 

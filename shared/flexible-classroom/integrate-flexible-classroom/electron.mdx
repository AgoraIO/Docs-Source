...
- If you want to customize the classroom UI based on the default UI of <Vg k="FC"/>, download and use the [source code](https://github.com/AgoraIO-Community/flexible-classroom-desktop) on GitHub to integrate <Vg k="FC"/>.

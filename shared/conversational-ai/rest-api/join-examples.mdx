...
<Tabs
  ...
  categories={[
    ...
    { value: "pipeline-id", label: "Saved agent configuration" },
    { value: "advanced", label: "Advanced configuration" },
    { value: "string-uid", label: "String UID" },
    { value: "mcp", label: "MCP server integration" },
...
<TabItem value="curl" label="curl" default category="pipeline-id">

```bash
curl -X POST 'https://api.agora.io/api/conversational-ai-agent/v2/projects/<your_app_id>/join' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: agora token=<your_token>' \
  -d '{
...
<TabItem value="python" label="Python" category="pipeline-id">
...
<TabItem value="node" label="Node.js" category="pipeline-id">
...
<TabItem value="curl" label="curl" category="preset">
...
<TabItem value="python" label="Python" category="preset">
...
<TabItem value="node" label="Node.js" category="preset">

```js
const appId = "<your_app_id>";
const credentials = "<your_base64_encoded_credentials>";

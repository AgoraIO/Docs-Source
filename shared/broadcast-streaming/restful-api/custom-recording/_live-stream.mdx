...
<div class="alert note">Before calling this API, ensure that you have called the <a href="./rest-api-start-recording-fls">Enable/Disable custom recording for an entry point</a> API to disable custom recording for the entry point that includes this live stream.</div>

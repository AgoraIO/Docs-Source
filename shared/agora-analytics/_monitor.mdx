...
Both the audio duration and video duration in the table above are [calculated by the number of streams](../reference/billing-policies#how-does-agora-calculate-service-minutes).

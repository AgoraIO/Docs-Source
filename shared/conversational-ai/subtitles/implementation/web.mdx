...
1. **Integrate the subtitle processing toolkit**
    ...
    Copy the [`conversational-ai-api`](https://github.com/Shengwang-Community/Conversational-AI-Demo/tree/main/Web/Scenes/VoiceAgent/src/conversational-ai-api) file to your project and import the toolkit before calling its API. Refer to [Toolkit Structure](#toolkit-structure) to understand the role of each file.
...
1. **Create a subtitle processing toolkit instance**
    ...
    Before joining a <Vg k="VSDK"/> channel, create video and chat SDK instances and pass in to the toolkit instance.

...
<Admonition type="info" title="Information">A best practice when managing your Agora Chat MAU is to authenticate your end users, create only one UID for each of them, and use UID persistently. Creating multiple UIDs for a unique end user will bloat your Agora Chat MAU.</Admonition>
...
By default, your subscription to Chat pricing plans is automatically renewed. You can unsubscribe at any time from Agora Console. Cancelling your subscription takes effect immediately and will delete all the Chat-related data.

### Switch to another plan

If you want to upgrade your present plan, you can click the **Subscribe** button of another plan. Reach out to our sales if you would like to subscribe to the Agora Chat Enterprise plan:

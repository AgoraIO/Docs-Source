...
The FaceUnity AR Filter extension encapsulates the core APIs of the FaceUnity Nama SDK. By calling the [setExtensionProperty](https://docs.agora.io/en/video-call-4.x/API%20Reference/java_ng/API/class_irtcengine.html#api_setextensionproperty) or [setExtensionPropertyWithVendor](https://docs.agora.io/en/video-call-4.x/API%20Reference/ios_ng/API/class_irtcengine.html#api_setextensionproperty) method of the [Agora Video SDK v4.0.0](https://docs.agora.io/cn/video-call-4.x/product_video_ng?platform=Android) and passing in the corresponding `key` and `value`, you can quickly integrate FaceUnity's AR filter capabilities.

<PlatformWrapper platform="web">
This extension is not provided for Web.
</PlatformWrapper>
...
Currently, the extension encapsulates part of the APIs of the FaceUnity Nama SDK. For details, see the <a href="#key-value">key overview</a>.
...
You can call the method as needed. For a full list of keys and values, see the [API Reference](./#key-value).
...
```
2. On the [Extensions Marketplace Downloads](https://docs.agora.io/en/extension_customer/downloads?platform=All%20Platforms) page, download the Android package of FaceUnity AR Filter. Unzip the package, and save all `.aar` files to the `FaceUnity/android/app/libs` path.
...
5. Open the `FaceUnity/android/app/src/main/java/io/Agora/rte/extension/FaceUnity/example/Config.java` file, and replace `<YOUR_APP_ID>` with your App ID. To get an App ID, see [Getting Started with Agora](https://docs.agora.io/en/Agora%20Platform/get_appid_token?platform=All%20Platforms).
...
```shell
	git clone https://github.com/AgoraIO-Community/AgoraMarketPlace.git
```
2. On the [Extensions Marketplace Downloads](https://docs.agora.io/en/extension_customer/downloads?platform=All%20Platforms) page, download the iOS package of FaceUnity AR Filter. Unzip the package, save all `.framework` files to `FaceUnity/ios/ExtensionExample`.
3. Contact Agora to get the certificate file and resource package.
...
4. Open the `Config.h` file and replace `<YOUR_APP_ID>` with your App ID. To get an App ID, see [Getting Started with Agora](https://docs.agora.io/en/Agora%20Platform/get_appid_token?platform=All%20Platforms).
...
- <Link to="{{Global.API_REF_ANDROID_ROOT}}/rtc_api_data_type.html#api_addextension">addExtension</Link> in the `RtcEngineConfig` class
- <Link to="{{Global.API_REF_ANDROID_ROOT}}/rtc_api_data_type.html#api_enableextension">enableExtension</Link> in the `RtcEngineConfig` class
- <Link to="{{Global.API_REF_ANDROID_ROOT}}/rtc_api_data_type.html#api_setextensionproperty">setExtensionProperty</Link> in the `RtcEngineConfig` class
- <Link to="{{Global.API_REF_ANDROID_ROOT}}/class_imediaextensionobserver.html#callback_onextensionevent">onEvent</Link> in the `IMediaExtensionObserver` class
</PlatformWrapper>
<PlatformWrapper platform="ios">
- <Link to="{{Global.API_REF_IOS_ROOT}}/rtc_api_data_type.html#api_addextension">addExtension</Link> in the `RtcEngineConfig` class
- <Link to="{{Global.API_REF_IOS_ROOT}}/rtc_api_data_type.html#api_enableextension">enableExtension</Link> in the `RtcEngineConfig` class
- <Link to="{{Global.API_REF_IOS_ROOT}}/rtc_api_data_type.html#api_setextensionproperty">setExtensionProperty</Link> in the `RtcEngineConfig` class
- <Link to="{{Global.API_REF_IOS_ROOT}}/class_imediaextensionobserver.html#callback_onextensionevent">onEvent</Link> in the `IMediaExtensionObserver` class
</PlatformWrapper>

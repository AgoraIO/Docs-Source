...
import AndroidImplementation from '@docs/shared/conversational-ai/audio-best-practice/implementation/android.mdx';
import SwiftImplementation from '@docs/shared/conversational-ai/audio-best-practice/implementation/swift.mdx';
import WebImplementation from '@docs/shared/conversational-ai/audio-best-practice/implementation/web.mdx';
...
When using the Android, iOS, or Web RTC SDK with the <Vpd k="NAME" />, follow the best practices in this guide to improve conversation fluency and reliability, especially in complex network environments.

## Server configuration

When calling the server API to create a <Vpd k="AGENT" />, use the default values for audio-related parameters to ensure the best audio experience.
...
- Integrate the `agora-extension-ai-denoiser` extension. Refer to [AI Noise Suppression](/extensions-marketplace/develop/integrate/ains?platform=web).
</TabItem>
</Tabs>
...
- Toolkit
    - [`loadAudioSettings`](/conversational-ai/reference/toolkit/android#loadaudiosettings)
...
- Toolkit
    - [`loadAudioSettings` [1/2]](/conversational-ai/reference/toolkit/ios#loadaudiosettings12)
    - [`loadAudioSettings` [2/2]](/conversational-ai/reference/toolkit/ios#loadaudiosettings22)

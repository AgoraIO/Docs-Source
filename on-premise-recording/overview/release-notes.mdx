...
v4.4.150 was released on June 30, 2025.
...
Version 4.4.150 includes the following key features:
...
<Admonition type="info" info="info">
With this release, the SDK versions 1.x–3.x have entered the retirement phase. For details, see the [Service Sunset Plans](/on-premise-recording/reference/sunset).
</Admonition>

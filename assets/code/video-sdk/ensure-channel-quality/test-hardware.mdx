...
<PlatformWrapper platform={["ios","macos"]}>
    ...
    - <Link to="{{Global.API_REF_IOS_ROOT_RTC_KIT}}/agorartcenginekit/setuplocalvideo(_:)">setupLocalVideo(_:)</Link>
    - <Link to="{{Global.API_REF_IOS_ROOT_RTC_KIT}}/agorartcenginekit/startechotest(withconfig:)">startEchoTest(withConfig:)</Link>
    </PlatformWrapper>
    ...
    - <Link to="{{Global.API_REF_MACOS_ROOT_RTC_KIT}}/agorartcenginekit/setuplocalvideo(_:)">setupLocalVideo(_:)</Link>
    - <Link to="{{Global.API_REF_MACOS_ROOT_RTC_KIT}}/agorartcenginekit/startechotest(withconfig:)">startEchoTest(withConfig:)</Link>
    </PlatformWrapper>

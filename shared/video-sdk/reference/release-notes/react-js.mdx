...
- Updates the built-in Web SDK to v4.24.1. For details on the changes between Web SDK v4.24.0 to v4.24.1, see the <a href="?platform=web">Web SDK release notes</a>.
...
- Updates the built-in Web SDK to v4.24.0. For details on the changes between Web SDK v4.23.2 to v4.24.0, see the <a href="?platform=web">Web SDK release notes</a>.

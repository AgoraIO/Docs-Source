...
In order to create the environment necessary to integrate Chat <Vg k="UIK" /> into your app, do the following:
...
5. Integrate the <Vg k="UIK" /> into your project.
   ...
   1. Create a Podfile for your project.
      ...
      pod init
      ```
   2. Add dependencies to the <Vg k="UIK" /> in the Podfile.
  ...
  The Chat <Vg k="UIK" /> is now added into your project.

...
[Data Insights Plus](../analyze/video-voice-sdk/data-insight-plus) Provides valuable insights into indicators, dimensions, and trends. Users can analyze data, view time series changes, examine distribution patterns, and compare data across different periods.
...
- Analyze data across multiple dimensions: This allows businesses to see how different dimensions of the RTC influence their data, and to identify quality and usage trends and patterns.
- Perform user sampling analysis: This allows businesses to drill down into their data and understand the impact areas with great granularity.
- Perform comparative analysis: This allows businesses to compare their data with historical data to identify areas for improvement.

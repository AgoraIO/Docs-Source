...
Standard and Premium, see [pricing](../../reference/pricing).
...
1. **Enable <Vpd k= "NAME" />**
    ...
    In [pricing](https://analytics-lab.agora.io/pricing), choose a package and press **Subscribe**.
...
You find the comparative analysis button in the upper right corner of the analysis area, click and select the desired analysis method to start the comparative analysis. Comparative analysis supports the following methods:

...
| `is_ack_read` | Bool | Whether to set the conversation as read. <ul><li>`true`: Yes.</li><li>`false`: No.</li></ul><br/> When a message is imported, the corresponding conversation is automatically created. | No |

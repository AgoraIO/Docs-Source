...
<PlatformWrapper platform="android, ios, macos, web, windows, unity, react-native, electron, flutter">
...
![CrossChannelMediaStreamForwarding](/images/rtc-sdk/cross-channel-forwarding.svg)
...
<PlatformWrapper notAllowed="android, ios, macos, web, windows, unity, react-native, electron, flutter">
<NotAvailable />
</PlatformWrapper>

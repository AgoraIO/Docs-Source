...
1. Call the [Start file conversion (POST) API](https://docs.agora.io/en/whiteboard/whiteboard_file_conversion?platform=RESTful#start-file-conversion-post) to convert the source document to a paginated set of images or web pages.

2. Call the [Query file conversion progress (GET) API](https://docs.agora.io/en/whiteboard/whiteboard_file_conversion?platform=RESTful#query-file-conversion-progress-get) to get the conversion result.
...
1. Upload the PPTX source document to a third-party cloud storage service, and call the [Start file conversion (POST) API](https://docs.agora.io/en/whiteboard/whiteboard_file_conversion?platform=RESTful#start-file-conversion-post) to create a dynamic-file conversion task that converts the PPTX file to HTML web pages.

2. Call the [Query file conversion progress (GET) API](https://docs.agora.io/en/whiteboard/whiteboard_file_conversion?platform=RESTful#query-file-conversion-progress-get) to get the file conversion result.

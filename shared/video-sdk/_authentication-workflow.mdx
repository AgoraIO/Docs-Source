...
4.  Test your server
    ...
    To retrieve a <Vpd k="SDK" /> token, send a request to the token server using a URL based on the [Token server GET request structure](#token-server-get-request-structure):

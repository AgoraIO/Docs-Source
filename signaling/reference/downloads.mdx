...
To manually install <Vg k="SIG_SDK" />, do one of the following:

## Through the Agora website

1. Download the Agora <Vg k="SIG_SDK" /> from https://download.agora.io/rtmsdk/release/Agora_RTM_SDK_for_Web_v1.5.0.zip. In the SDK folder, find the JS file in the libs folder, and save it to your project directory.
...
The iOS apps integrated with the <Vg k="SIG_SDK" /> v1.4.4 cannot be published on the App Store due to review issues. If you want to publish your app on the App Store, you must use other versions of the SDK.
...
1. Download the latest [<Vg k="SIG_SDK" /> for Linux Java](https://download.agora.io/rtmsdk/release/Agora_RTM_SDK_for_Linux_Java_v1_5_0.zip) and decompress the file. Copy the `*.so` file and the `*.jar` file to the `lib` folder.
...
1. Download the latest version of [<Vg k="SIG_SDK" /> (Linux C++)](https://download.agora.io/rtmsdk/release/Agora_RTM_SDK_for_Linux_v1_5_0.zip) and extract the files. Copy the `*.so` file in the SDK folder into your `lib` folder, and copy the `*.h` file in the SDK folder into your `include` folder.
...
1. Unzip the latest version of <Vg k="SIG_SDK" /> to a local directory.
    - **x86**: https://download.agora.io/rtmsdk/release/Agora_RTM_SDK_for_Windows_x86_v1.5.0.zip
    - **x64**: https://download.agora.io/rtmsdk/release/Agora_RTM_SDK_for_Windows_x64_v1.5.0.zip
...
1. Go to [GitHub](https://github.com/AgoraIO-Community/Agora-Unity-RTM-SDK/releases) to download the latest version of the Agora RTM Unity asset package and unzip it.
2. In the Unity Editor, select **Assets** > **Import Package** > **Custom Package**.
3. Select the Agora RTM Unity asset package and click **Open**.
4. All packages of the SDK are chosen by default. Uncheck the packages you do not need and click **Import**.

## Manually add the SDK files

1. Download and extract the latest version of the [Agora <Vg k="SIG_SDK" />](https://download.agora.io/sdk/release/Agora_Unity_RTM_SDK_1.4.10_20220726_163.zip).

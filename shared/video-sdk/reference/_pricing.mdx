...
[3D Spatial Audio](../enable-features/spatial-audio) brings theater-like effects to virtual communication, making it seem as if the sound originates from all around the user.
...
Media relay allows streaming from one source channel to multiple target channels at the same time. For details, see [Live streaming over multiple channels](../develop/live-streaming-over-multiple-channels).
...
|----------------------------|----------------------------------------------------------------------|----------------------------|
| Audio                      | -                                                                    | 7                          |
| High-definition (HD)       | Less than or equal to 921,600 (1280 × 720)                           | 28                         |
| Full High-definition (FHD) | From greater than 921,600 (1280 × 720) to 2,073,600 (1920 × 1080)    | 63                         |
| 2K                         | From greater than2,073,600 (1920 × 1080) to 3,686,400 (2560 × 1440)  | 112                        |
| 2K+                        | From greater than 3,686,400 (2560 × 1440) to 8,847,360 (4096 × 2160) | 252                        |
...
For example, imagine a 1280 × 720 video is streamed over 3 channels for 10 minutes. The total duration is 10 minutes x 3 channels = 30 minutes. The usage type based on the resolution is HD. The total cost is 30 minutes x __ USD = __ USD.

For an additional example, imagine an audio streamed over 3 target channels for 10 minutes. The total duration is 10 minutes x 3 channels = 30 minutes. The total cost is 30 minutes x __ USD = __ USD.
...
<PlatformWrapper platform="ios">
    In scenarios involving screen sharing, the unit price of the screen-sharing stream is calculated on the basis of the video dimension that you set in <Link to="{{Global.API_REF_IOS_ROOT_RTC_KIT}}/agorascreencaptureparameters2">ScreenCaptureParameters</Link>.
</PlatformWrapper>
...
<PlatformWrapper platform="macos">
    In scenarios involving screen sharing, the unit price of the screen-sharing stream is calculated on the basis of the video dimension that you set in <Link to="{{Global.API_REF_MACOS_ROOT_RTC_KIT}}/agorascreencaptureparameters2">ScreenCaptureParameters</Link>.
</PlatformWrapper>

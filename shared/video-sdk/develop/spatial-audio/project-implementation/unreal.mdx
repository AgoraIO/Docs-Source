...
To add the button to the UI, do the following:
    ...
    1. Add a text widget for the spatial audio button. Drag **Text** from **Palette** > **Common** and drop it over `spatialAudio`. Then, in **Details**, change the **Text** field to `Spatial Audio`.

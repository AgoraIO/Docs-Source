...
The `_mediaPLayerButton` widget displays a suitable caption on a button depending on the state of the media player. To define this widget, add the following method to the `_MyAppState` class:
...
**Declare the variables you need**
    ...
    String mediaLocation =
      ...
      "examples/Agora-Custom-VideoSource-Web/assets/sample.mp4";

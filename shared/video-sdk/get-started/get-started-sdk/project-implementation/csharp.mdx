...
8. **Manage the user role**
    ...
    1. Switch the user role between a host and an audience.
    When toggles are switched on, to switch user role and turn off the toggles, in your script file, add the following methods to `NewBehaviourScript`:

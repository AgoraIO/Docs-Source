...
Starting from version 4.22.0, in addition to the core modules, the SDK also provides multiple independent service modules for optional use, such as media stream relay, media push, and others, to meet the needs of different business scenarios.

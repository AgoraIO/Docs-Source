...
1. **Develop your extension**
    ...
    - [Develop an audio extension](/extensions-marketplace/develop/integrate/audio-filter)
    - [Develop a video extension](/extensions-marketplace/develop/integrate/video-filter)
...
1. **Help developers easily integrate your extension into their <Vpl k="CLIENT" />**.
    ...
    Write the [Implementation guide](/extensions-marketplace/develop/integrate/implementation-guide) for your extension

1. **Share provisioning, usage, and billing information with Agora**

    - [Provisioning API](/extensions-marketplace/develop/integrate/provisioning)
    - [Usage and billing API](/extensions-marketplace/develop/integrate/usage)

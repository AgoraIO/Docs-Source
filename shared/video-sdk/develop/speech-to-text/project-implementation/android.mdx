...
To create a simple interface for testing speech-to-text functionality, add buttons to start and query speech-to-text. Open `/app/res/layout/activity_main.xml` and add the following lines before `</RelativeLayout>`:

...
This page shows how to perform <Vg k="CHAT_ROOM_LOWER"/> member mute management by calling the Chat RESTful APIs, including muting and unmuting members in a <Vg k="CHAT_ROOM_LOWER"/>, and retrieving the list of muted members.
...
Mutes all <Vg k="CHAT_ROOM_LOWER"/> members. Once this method call succeeds, only the members on the <Vg k="CHAT_ROOM_LOWER"/> allow list can send messages. For details, see [Manage Chat Room Allow List](/agora-chat/restful-api/chatroom-management/manage-chatroom-mutelist).

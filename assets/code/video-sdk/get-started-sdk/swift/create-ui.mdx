...
class ViewController: NSViewController {
    ...
    func leaveChannel() {}
     ...
     func initViews() {
        ...
        remoteView = NSView()
        remoteView.frame = CGRect(x: 20, y: 60, width: 150, height: 200)
        self.view.addSubview(remoteView)
        localView = NSView()
        localView.frame = CGRect(x: 300, y: 60, width: 150, height: 200)
...
class ViewController: NSViewController {
    ...
    func initViews() {
        ...
        role.frame = CGRect(x: 20, y: 20, width: 160, height: 30)

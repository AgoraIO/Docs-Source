...
- Implemented <Link to="../../../video-calling/get-started/get-started-sdk"><Vg k="GET_STARTED"/> for <Vg
  k="VIDEO"/></Link> using the [4.1.1-special.9 release](https://download.agora.io/sdk/release/Agora_Native_SDK_for_Android_rel.v4.1.1.9_50523_FULL_20230621_1102_268666.zip).
</PlatformWrapper>
<PlatformWrapper platform="ios">
- Implemented <Link to="../../../video-calling/get-started/get-started-sdk"><Vg k="GET_STARTED"/> for <Vg
  k="VIDEO"/></Link> using the [4.1.1-special.9 release](https://download.agora.io/sdk/release/Agora_Native_SDK_for_iOS_rel.v4.1.1.9_64984_FULL_20230620_2207_268596.zip).
</PlatformWrapper>
...
1. **Setup your <Vg k="RTEE_AF" /> account**
    ...
    <Vg k="RTEE_AF" />, then click **Activate Your Account**.
        - Contact extensionsmarketplace@agora.io to activate the extension.

...
import Understand from '@docs/shared/chat-sdk/develop/reaction/understand/index.mdx';
import ProjectImplement from '@docs/shared/chat-sdk/develop/reaction/project-implementation/index.mdx';

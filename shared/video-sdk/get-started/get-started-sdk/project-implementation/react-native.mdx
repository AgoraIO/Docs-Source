...
1. **Implement a client for Video Call**
    ...
    1. Create an App Component
        ...
        - appId: The App ID of your Agora project. See [Get an App ID](../manage-agora-account#get-the-app-id) for details.
        ...
        - token: Pass a token that identifies the role and privilege of the user. The token must be generated using the preceding App ID and channel name. You can set it to one of the following values:
            A temporary token generated in Console. A temporary token is valid for 24 hours. For details, see [Get a Temporary Token](../reference/manage-agora-account#get-the-app-id).

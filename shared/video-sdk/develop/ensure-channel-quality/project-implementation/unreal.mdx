...
1. Use the same procedure and create a button called `echoTest`, then change the following properties in **Details**:
...
1. Add a text widget for the echo test button. Drag **Text** from the **Common** section of the **Palette** to the canvas panel. In **Details**, change the **Text** field to `Echo Test`, then change the following properties in **Details**:
...
1. Add a text widget for the video quality button. Drag **Text** from the **Common** section of the **Palette** to the canvas panel. In **Details**, change the **Text** field to `Video Quality`, then change the following properties in **Details**:
...
1. **Update the network status indication**
    ...
    To show the network quality result visually to the user, add the following to the `MyUserWidget.cpp` before `setupVideoSDKEngine`:
...
1. **Enable the user to test the network**
    ...
    1.  In `MyUserWidget.h`, add the following after `UMyUserWidget`:

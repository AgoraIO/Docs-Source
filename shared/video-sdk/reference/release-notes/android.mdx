...
**Attention:** Starting from v4.4.0, the SDK provides an API sunset notice, which includes information about deprecated and removed APIs in each version. See <Link to="{{Global.API_REF_ANDROID_ROOT}}/rtc_api_sunset.html">API Sunset Notice</Link>.
...
1. **Lite SDK**
   ...
   - For the list of APIs supported by the Lite SDK, see <Link to="{{Global.API_REF_ANDROID_ROOT}}/rtc_lite_api.html#rtc_lite_api">Lite SDK API</Link>.

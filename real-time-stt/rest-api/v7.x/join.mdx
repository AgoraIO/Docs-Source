...
<ParameterList title="BODY" required={true}>
  <Parameter name="languages" type="array[string]" required={true}>
    The transcription languages you want to recognize. You can specify up to four languages. For a complete list, see [Supported languages](/real-time-stt/develop/supported-languages). Choosing multiple transcription languages can affect both quality and cost. For best practices, see [Optimize transcription quality and cost](/real-time-stt/best-practice/optimize-quality).
  </Parameter>
  ...
  <Parameter name="uidLanguagesConfig" type="array" required={false}>
    ...
    <Parameter name="languages" type="array[string]" required={true}>
    The transcription languages to recognize. Each uid can support a maximum of 4 languages. Refer to [Supported Languages](/real-time-stt/develop/supported-languages) for details.
    </Parameter>
  </Parameter>
  ...
  <Parameter name="translateConfig" type="object" required={false}>
    ...
    <Parameter name="languages" type="array" required={false}>
      ...
      <Parameter name="source" type="string" required={true}>
        The source language for translation. Refer to [Supported Languages](/real-time-stt/develop/supported-languages#real-time-translation) for details.
      </Parameter>      
      <Parameter name="target" type="array[string]" required={true}>
        The target languages for translation. You can configure up to 10 target languages for each source language. Refer to [Supported Languages](/real-time-stt/develop/supported-languages#real-time-translation) for details.
      </Parameter>
    </Parameter>
  </Parameter>      
  ...
  <Parameter name="extensionParams" type="object" required={false}>
    ...
    The rclone backend type. For standard S3, set this to `s3`.
    </Parameter>
    ...
    <Parameter name="tagByRule" type="array[object]" required={false}>

...
1. On the project config page, select **Chat > Features** > **Push Certificate** and click **Add Push Certificate**.

1. On the project config page, select **Features** > **Push Template** and click **Add Push Template**, and configure the fields in the pop-up window, as shown in the following figure:

    ![Add push template](/images/chat/configure-add-push-template.png)

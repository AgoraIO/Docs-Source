...
To create a simple interface for testing Real-Time Transcription functionality, add buttons to start and query speech-to-text. Open `/app/res/layout/activity_main.xml` and add the following lines before `</RelativeLayout>`:
...
1. **Enable a user to start, query and stop a task**
    ...
    In this example, you use the following buttons to manage a speech-to-text task.

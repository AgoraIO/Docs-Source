...
1. **Set encryption parameters**
    ...
    You specify the media stream encryption method and the related parameters by calling `setParams`. Depending on your choice of the encryption method, add **one** of the following pieces of code to `joinChannel` before `agoraRtcService.joinChannel`:

...
In Web SDK, <Vg k="COMPANY"/> provides extensions like <Link
  to="/video-calling/enable-features/ai-noise-suppression">AI Noise Suppression</Link> and <Link
  to="/video-calling/enable-features/virtual-background">Virtual Background</Link> for pre-process and post-process phases.
</PlatformWrapper>
...
To create the environment necessary to integrate processing of raw audio and video data in your <Vpl k="CLIENT" />, open the [<Vg k="GET_STARTED"/>](../get-started/get-started-sdk) <Vpd k="NAME"/> project you created previously.

...
<ul><li>You have enabled <b>Docs to Picture</b> or <b>Docs to Web</b> and configured storage settings in <a href="https://console.agora.io/">Agora Console</a >. See <a href="../../../develop/enable-whiteboard#enable-whiteboard-server-side-features">Enable whiteboard server-side features</a >.</li><li>You have generated a URL address for the file you want to convert, and the address is publicly accessible.</li></ul></div>

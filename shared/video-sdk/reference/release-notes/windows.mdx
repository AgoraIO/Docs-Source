...
**1. Video SDK for CSharp**

This is the first release of the Video SDK for CSharp. It includes all major features of the Video SDK for Windows.
See an open-source [Agora CSharp implementation example](https://github.com/AgoraIO-Extensions/Agora-C_Sharp-SDK/tree/master/APIExample) on GitHub.

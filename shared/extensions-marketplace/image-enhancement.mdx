...
Releases all resources used by the extension, including Web Workers.

If `IBeautyProcessor` is repeatedly created without releasing the resources occupied by the extension, it may cause memory exhaustion.

...
When you deploy the web page to be recorded into your CDN, you can use the template HTML file `templates/record_page_prod.html` provided by Agora in the [Flexible-Classroom-ios](https://github.com/AgoraIO-Community/flexible-classroom-ios) GitHub repository.
</PlatformWrapper>

<PlatformWrapper platform="android">
When you deploy the web page to be recorded into your CDN, you can use the template HTML file `templates/record_page_prod.html` provided by Agora in the [CloudClass-Android](https://github.com/AgoraIO-Community/CloudClass-Android) GitHub repository.
</PlatformWrapper>

![record_page_prod.html](https://web-cdn.agora.io/docs-files/1673578454262)

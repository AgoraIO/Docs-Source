...
* Implemented the [<Vg k="GET_STARTED"/>](../get-started/get-started-sdk#project-setup) project for <Vpd k="NAME"/>.
</PlatformWrapper>
<PlatformWrapper platform="react-js" >
In order to view and test the code used in this page:
* View or install the [<Vpd  k="SDK" /> reference app](https://github.com/AgoraIO/video-sdk-samples-reactjs) for <Vpd
    k="NAME"/>.
</PlatformWrapper>
<Prerequites />

...
Refer to the following steps to register a Chat account, log in to Chat and send and receive a message.

1. On one device or simulator, enter a username and password, and click **SIGN UP** to register a Chat account.
2. Click **SIGN IN** to log in to Chat.
3. On a second device or simulator, repeat the above steps to create another account and log in to Chat. Ensure that you use a different user ID (username) on this device or simulator.

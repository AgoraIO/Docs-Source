...
To deliver messages only to online users, you need to set `Message#deliverOnlineOnly` to `true` when sending the message. The following is an example of sending a text message to only online users:

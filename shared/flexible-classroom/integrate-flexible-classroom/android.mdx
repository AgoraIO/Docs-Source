...
1. Call [AgoraOnlineClassroomSDK.launch](../reference/classroom-sdk#launch) to start the class. The parameters of `AgoraOnlineClassroomSDK` and `AgoraClassroomSDK` are the same. Refer to the following sample code:

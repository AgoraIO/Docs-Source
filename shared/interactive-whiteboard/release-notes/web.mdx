...
- [`insertText`](./API%20Reference/whiteboard_web/interfaces/room.html?platform=All%20Platforms#inserttext)
- [`updateText`](./API%20Reference/whiteboard_web/interfaces/room.html#updatetext)
- [`updateSelectedText`](./API%20Reference/whiteboard_web/interfaces/room.html#updateselectedtext)
- [`getScene`](./API%20Reference/whiteboard_web/interfaces/displayer.html#getscene)
- [`createScenesCallback`](./API%20Reference/whiteboard_web/interfaces/displayer.html#createscenescallback)
- [`onPPTMediaPlayError`](./API%20Reference/whiteboard_web/globals.html#displayercallbacks)
- The following properties in [`MemberState`](./API%20Reference/whiteboard_web/globals.html#memberstate):
  - `textColor`
  - `bold`
  - `italic`
  - `underline`
  - `lineThrough `
- The following properties in [`WhiteWebSdkConfiguration`](./API%20Reference/whiteboard_web/globals.html#whitewebsdkconfiguration):
  - `disableRotation`
  - `disableCurveAnimes`

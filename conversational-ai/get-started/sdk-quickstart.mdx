...
This page shows you how to build a server that starts and stops a voice AI agent using the Agora Conversational AI SDKs. The SDKs wraps the Conversational AI REST API with typed vendor configuration, automatic token generation, and a session lifecycle API.
...
<details>
<summary>Flask server example (sync)</summary>
```python
# Python sync complete example code
```
</details>

<details>
<summary>FastAPI server example (async)</summary>
```python
# Python async complete example code
```
</details>

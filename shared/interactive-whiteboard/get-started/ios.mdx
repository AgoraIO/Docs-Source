...
- An Agora project with the whiteboard service enabled. Get the app identifier and SDK token from the Agora Console. See [Enable and Configure Interactive Whiteboard Service](https://docs.agora.io/en/whiteboard/enable_whiteboard?platform=iOS).
...
The Agora Interactive Whiteboard SDK uses Objective-C. To use the Objective-C SDK in your Swift app, you need to create an Objective-C bridging header file, as follows:
...
## Get Agora Interactive Whiteboard SDK
...
Before an app client requests to join a room, you need to call the Interactive Whiteboard RESTful API on your app server to create a room. See [Create a room (POST)](https://docs.agora.io/en/whiteboard/whiteboard_room_management?platform=RESTful#create-a-room-post).
...
- Call the Interactive Whiteboard RESTful API. See [Generate a Room Token (POST)](/en/whiteboard/generate_whiteboard_token#generate-a-room-token-post).
...
- `appIdentifier`: If you use versions earlier than v2.15.0, do not pass in uid: The unique identifier of the whiteboard project. See [Get security credentials for your whiteboard project](/en/whiteboard/enable_whiteboard?platform=iOS#get-security-credentials-for-your-whiteboard-project).

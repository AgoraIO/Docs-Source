...
> Agora <Vg k="RTT" /> supports only integer `uid`s. Make sure you use an integer value to join a channel. The `uid`s specified in the body of the [start request](https://documenter.getpostman.com/view/6319646/SVSLr9AM#92041cab-1f45-4ff3-83a5-601fa06a0427) must also be unique integers enclosed in double quotation marks. 

...
Creates a PCM data sender module. This method creates an `AudioPcmDataSender` object, which can be used in the [`NewCustomAudioTrackPcm`](./localaudiotrack#newcustomaudiotrackpcm) method.

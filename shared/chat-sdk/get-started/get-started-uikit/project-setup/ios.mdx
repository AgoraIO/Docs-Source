...
In order to create the environment necessary to integrate Agora Chat Starter Kit into your app, do the following:
...
5. Integrate the Starter Kit into your project.
   ...
   1. Create a Podfile for your project.
      ...
      pod init
      ```
   2. Add dependencies to the Starter Kit in the Podfile.
  ...
  The Agora Chat Starter Kit is now added into your project.

...
2. Create a `WhiteWebSdk` instance and join the room. You need to pass in the following parameters:
 - `appIdentifier`: The App Identifier of the whiteboard project in <Vg k="CONSOLE" />. See [Get security credentials for your <Vg k="WHITE" /> project](../develop/enable-whiteboard#get-security-credentials-for-your-whiteboard-project).

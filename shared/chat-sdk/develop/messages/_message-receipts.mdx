...
import Understand from '@docs/shared/chat-sdk/develop/messages/message-receipts/understand/index.mdx';
import ProjectImplement from '@docs/shared/chat-sdk/develop/messages/message-receipts/project-implementation/index.mdx';

...
After upgrading the SDK, you need to update the code in your app according to your business use-cases. For details, see [Migrate from v3.7.x to v<Vg k = "VSDK_RELEASE"/>](./overview/migration-guide).

...
1. [Download](/sdks) the latest version of the <Vpd k="SDK"/> for <Vpl k="NAME"/>, and extract files from package to a local folder, `<unzipped_package>`.

1. Copy the following files and sub-folders from the `libs` folder of the downloaded SDK to the corresponding directory of your project.

    | File or sub-folder                                      | Path of your project                  |
    | ------------------------------------------------------ | ------------------------------------- |

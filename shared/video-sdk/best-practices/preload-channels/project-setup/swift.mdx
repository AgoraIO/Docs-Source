...
1. Copy the following folders and files from the repository to the same folder as your `*.xcodeproj` file:
    ...
    ![preload channels best practice](/images/rtc-sdk/preload-channels-ios-videoloader.png)
...
1. In the terminal, go to the directory where the `*.xcodeproj` file is located and execute `pod install` to install the dependencies.
    ...
    ![preload channels pod install](/images/rtc-sdk/preload-channels-ios-pod-install.png)

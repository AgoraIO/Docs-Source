...
- [`dispatchMagix``Event`](../reference/whiteboard-api/room-managementl#dispatchmagixevent)
- [`addMagixEventListener`](../reference/whiteboard-api/room-managementl#addmagixeventlistener)
- [`removeMagixEventListener`](../reference/whiteboard-api/room-managementl#removemagixeventlistener)

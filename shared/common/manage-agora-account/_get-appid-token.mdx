...
1. In your browser, navigate to [token builder](https://webdemo.agora.io/token-builder).

1.  Fill in *appID* and *appCertificate* with the details of your project from <Vg k="CONSOLE" />.
...
You use <Vg k="MESS" /> tokens for <Vg k="MESS" /> and Flexible Classroom.
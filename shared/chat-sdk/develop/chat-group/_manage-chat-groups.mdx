...
import Understand from '@docs/shared/chat-sdk/develop/chat-group/manage-chat-groups/understand/index.mdx';
import ProjectImplement from '@docs/shared/chat-sdk/develop/chat-group/manage-chat-groups/project-implementation/index.mdx';

...
If you call `logoutWithCompletion` to log out of the RTM system, the connection state changes to `AgoraRtmConnectionStateDisconnected`. The RTM system removes the user from the online user list and channel, and users in the same channel receive the `memberLeft` callback.
...
-   <Link to="{{Global.SIGNALING_API_REF_OC_ROOT}}/Protocols/AgoraRtmDelegate.html#//api/name/rtmKit:connectionStateChanged:reason:">connectionStateChanged</Link>

-   <Link to="{{Global.SIGNALING_API_REF_OC_ROOT}}/Constants/AgoraRtmConnectionState.htmlConstants/AgoraRtmConnectionState.html">AgoraRtmConnectionState</Link>

-   <Link to="{{Global.SIGNALING_API_REF_OC_ROOT}}/Constants/AgoraRtmConnectionChangeReason.html">AgoraRtmConnectionChangeReason</Link>
</PlatformWrapper>

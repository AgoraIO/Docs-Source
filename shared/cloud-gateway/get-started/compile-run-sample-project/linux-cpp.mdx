...
Agora provides a runnable sample project in the <Vpd k="NAME" /> SDK download package. This page shows you how to run the sample project to send and receive media streams.

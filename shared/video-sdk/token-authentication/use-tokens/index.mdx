...
![token authentication flow](https://agora-doc.s3.us-east-1.amazonaws.com/images/video-sdk/token-authentication.svg)
</details>
...
* Deployed a token server using either of the following guides:
    ...
    - [Deploy a middleware server](/video-calling/token-authentication/middleware-token-server)
    </ProductWrapper>    

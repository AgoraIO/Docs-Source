...
The FaceUnity AR Filter extension encapsulates the core APIs of the FaceUnity Nama SDK. By calling the <Link to="{{Global.API_REF_ANDROID_ROOT}}/class_irtcengine.html#api_setextensionproperty">setExtensionProperty</Link>
...
To quickly integrate FaceUnity's AR filter capabilities, call the  <Vg k="VSDK" /> <Link to="{{Global.API_REF_ANDROID_ROOT}}/class_irtcengine.html#api_setextensionproperty">setExtensionProperty</Link> method and pass the corresponding `key` and `value`.
</PlatformWrapper>
<PlatformWrapper platform="ios">
To quickly integrate FaceUnity's AR filter capabilities, call the  <Vg k="VSDK" /> <Link to="{{Global.API_REF_IOS_ROOT}}/class_irtcengine.html#api_setextensionproperty">setExtensionProperty</Link> method and pass the corresponding `key` and `value`.

This page provides the API reference for Agora Flexible Classroom SDK for Web and Electron.

<a id="fcruiscene"></a>

## FurUIScene

The `FcrUIScene` class provides the core methods of Flexible Classroom.

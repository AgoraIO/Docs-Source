...
<ParameterList title="params" required={true}>
  ...
  <Parameter name="rate" type="number">
    Indicates the speaking rate of the text. The rate can be applied at the word or sentence level and should be between
    0.5 and 2.0 times the original audio speed.
  </Parameter>

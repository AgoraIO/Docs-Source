...
You use Chat app tokens to make authenticated REST calls to Chat. To obtain an Chat app token, you retrieve an Agora app token from your app token server and convert it using the Agora app token obtained to an Chat app token.

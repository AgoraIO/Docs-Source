...
When using outbound PSTN, you can configure voice prompts to play after the call connects. The user can be required to press a digit to confirm connection, or you can use "lazy" mode to accept any DTMF input. You can also append DTMF digits to the destination number using the # symbol.
</Admonition>

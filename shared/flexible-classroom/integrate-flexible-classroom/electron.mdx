...
1. To copy an environment variable configuration file, run the following command:
...
1. After pulling the code to your local device, you are free to edit the code according to your needs. You can refer to the [Customize the Classroom UI guide](/en/agora-class/agora_class_custom_ui_web?platform=Electron).

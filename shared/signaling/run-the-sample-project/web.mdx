...
1.  Download the [<Vg k="MESS" />](https://github.com/AgoraIO/<Vg k="MESS" />) repository on Github, and locate the `Agora-<Vg k="MESS" />-Tutorial-Web` folder.

2.  Go to the directory of the `Agora-<Vg k="MESS" />-Tutorial-Web` folder, and run the following command to install dependencies:

...
Version 1.0.0 adds the `appliance-plugin`, which implements a high-performance whiteboard drawing tool and supports use in multi-window mode. For details, see [Appliance Plugin](../develop/appliance-plugin).
</Admonition>

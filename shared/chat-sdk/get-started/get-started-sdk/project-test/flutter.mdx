...
1. Create an <Vpl k="CLIENT" /> instance for the first user:
    ...
    1. In the `_MyHomePageState` class, update `appKey`, `token`, and `userId` with values from <Vg k="CONSOLE" />.  To get your app key, see [Get <Vg k="CHAT"/> project information](enable#get-chat-project-information).

...
<Vpd k="NAME" /> is a conversational AI agent powered by the TEN framework. It integrates LLMs such as Gemini and OpenAI with real-time audio and video communication and more. It delivers real-time capabilities to see, hear, and speak, with full compatibility with popular workflow platforms such as Dify and Coze.

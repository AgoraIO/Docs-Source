...
## Prerequisites
- Before proceeding, ensure that you have implemented basic real-time audio and video functionality in your project, that is, you have implemented the [SDK quickstart](../get-started/get-started-sdk) in your project.

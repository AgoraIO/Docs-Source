...
<div class="alert note">If your network has a firewall, make sure that you open the ports specified in [Firewall Requirements](/agora-chat/reference/firewall).</div>

...
Before an app client requests to join a room, you need to call the Interactive Whiteboard RESTful API on your app server to create a room. See [Create a room (POST)](../reference/whiteboard-api/room-management#create-a-room-post).
...
- Call the Interactive Whiteboard RESTful API. See [Generate a Room Token (POST)](/interactive-whiteboard/develop/generate-token-rest#generate-a-room-token-post).
...
- `appIdentifier`: If you use versions earlier than v2.15.0, do not pass in uid: The unique identifier of the whiteboard project. See [Get security credentials for your whiteboard project](../develop/enable-whiteboard#get-security-credentials-for-your-whiteboard-project).

...
- To receive notifications for other events, configure callbacks under **Chat > Features > Callbacks** for your project in [<Vg k="CONSOLE" />](https://console.agora.io/). See [Callbacks and events](/agora-chat/reference/callbacks-events) for details.

...
3. In **Solution Explorer**, open `CAgoraImplementationDlg.cpp` and update `APP_ID`, `ChannelName` and `Token` with the values from Agora Console.


5. In Visual Studio, click **Local Window Debugger**. A moment later, you see the app running on your development device.

...
- <Link to="{{global.API_REF_ELECTRON_ROOT}}/class_irtcengine.html#ariaid-title25">enableDualStreamMode</Link>

- <Link to="{{global.API_REF_ELECTRON_ROOT}}/class_irtcengine.html#ariaid-title88">setAudioProfile</Link>

- <Link to="{{global.API_REF_ELECTRON_ROOT}}/class_irtcengine.html#ariaid-title118">setVideoEncoderConfiguration</Link>
...
- <Link to="{{global.API_REF_ELECTRON_ROOT}}/class_irtcengineeventhandler.html#ariaid-title40">onLocalVideoStats</Link>

- <Link to="{{global.API_REF_ELECTRON_ROOT}}/class_irtcengineeventhandler.html#ariaid-title48">onRemoteVideoStats</Link>

...
When you have downloaded the Agora v4.0.0 RC Unity SDK, you see a `.unitypackage` file which can be imported directly into your project in Unity Editor. Once the SDK is successfully integrated, you see an Agora-<Vg k="VSDK" />-Plugin directory in the `Assets` of your project.

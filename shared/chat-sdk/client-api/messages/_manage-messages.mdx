...
<Admonition type="tip" title="Note">This feature supports Chrome, Firefox, Safari, and other browsers that use these engines (for example, Microsoft Edge). It does not support Internet Explorer.</Admonition>
</PlatformWrapper>

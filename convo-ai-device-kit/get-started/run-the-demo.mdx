...
1. **Wake the device**: Short press the **Middle button** to start a conversation with the AI agent.

1. **End the conversation**: After the conversation, short press the **Middle button** to exit the conversation with the AI agent.

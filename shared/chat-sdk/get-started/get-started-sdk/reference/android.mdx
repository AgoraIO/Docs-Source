...
In addition to integrating the Chat SDK into your project with mavenCentral, you can also manually download the [Chat SDK for Android](https://download.agora.io/sdk/release/Agora_Chat_SDK_for_Android_v1.0.0.zip). 
...
2. Copy the following files or subfolders from the **libs** folder of the downloaded SDK to the corresponding directory of your project.
   ...
   <div class="alert info"> X.Y.Z refers to the version number of the Chat SDK you downloaded.</div>

## Reference

For details, see the [sample code](https://github.com/AgoraIO/Agora-Chat-API-Examples/blob/main/Chat-Android/app/src/main/java/io/agora/agorachatquickstart/MainActivity.java) and [demo  <Vpl k="CLIENT" />](../reference/downloads) to get started with <Vg k="CHAT" />.

...
This section shows how to prepare the development environment necessary to integrate Chat into your game.
...
1. Go to the [SDK download page](https://docs-preprod.agora.io/en/agora-chat/downloads?platform=All%20Platforms), and download the latest version of the Chat SDK package for Unity, and decompress it.

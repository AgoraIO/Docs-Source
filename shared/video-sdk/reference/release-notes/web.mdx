...
v4.21.0 was released on May, 27, 2024.
...
- Optimizes the reconnection mechanism in specific scenarios, reducing the recovery time for reconnection.
...
- The crash of the rendering process caused by calling `replaceTrack` on specific versions of Electron (for example, version 11.5.0).

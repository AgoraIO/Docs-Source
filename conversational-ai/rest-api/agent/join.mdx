  ...
  <Parameter name="properties" type="object" required={true}>
    ...
    <Parameter name="asr" type="object" required={false}>
      ...
      <Parameter name="credential_mode" type="string" possibleValues="managed" required={false}>
        Set to `"managed"` to use Agora-managed credentials for this provider. When set, you do not need to provide an API key. See [Use managed mode](/conversational-ai/develop/managed-mode).
      </Parameter>

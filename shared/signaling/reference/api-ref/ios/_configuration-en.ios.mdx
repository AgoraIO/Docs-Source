...
| <code className="index-group-item-rtmeventlistener index-api-onconnection" id={config.onconnection[props.ag_platform]}>{config.onconnection[props.ag_platform]}</code> | <span class="index-desc-onconnection">(Deprecated) Receive event notifications when client connection status changes. See <a href="#enumvconnectionstatepropsag_platform"><code>{enumv.connectionstate[props.ag_platform]}</code></a > and <a href="#enumvconnectionreasonpropsag_platform"><code>{enumv.connectionreason[props.ag_platform]}</code></a >.</span> |
| <code className="index-group-item-rtmeventlistener index-api-onlinkstateevent" id={config.onlinkstateevent[props.ag_platform]}>{config.onlinkstateevent[props.ag_platform]}</code> | <span class="index-desc-onlinkstateevent">Receive event notifications when client connection status changes. For details, see <a href="#configlinkstateeventpropsag_platform"><code>{config.linkstateevent[props.ag_platform]}</code></a >.</span> |

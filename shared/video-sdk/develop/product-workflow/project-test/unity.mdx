...
3. In **Unity Editor**, in `Assets/Agora-<Vg k="VSDK" />-Plugin/Agora-Unity-<Vg k="VSDK" />-SDK/Code/JoinChannelVideo.cs`, update `_appID`, `_channelName` and `_token` with the values for your temporary token.

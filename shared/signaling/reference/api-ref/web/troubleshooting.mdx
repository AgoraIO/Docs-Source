...
| `-10015` | <code>{code.loginnotauthorized[props.ag_platform]}</code> | No RTM service permissions.  Possible reasons include:<br/> - Signaling is not enabled in Console. <br/> - Service payment overdue. <br/> - Account suspension. |

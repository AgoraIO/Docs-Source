...
-   The Agora <Vg k="MESS_SDK" /> supports creating multiple <Link to="{{Global.SIGNALING_API_REF_ANDROID_ROOT}}/classio_1_1agora_1_1rtm_1_1_rtm_client.html">RtmClient</Link> instances that are independent of each other.

...
<Link to = "{{Global.AGORA_CHAT_POSTMAN_APIS}}/9265552/2s7ZTAtiWP#f1b292de-e865-487d-8c84-f85532d244c3">The app super admin</Link> can call `createChatRoom` to create a chat room and set the chat room attributes such as the chat room subject, description, and the maximum number of members.

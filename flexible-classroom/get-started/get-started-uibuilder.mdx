...
![Image](https://agora-doc.s3.us-east-1.amazonaws.com/images/flexible-classroom/uibuilder.png)

You use <Vg k="FC_UIB" /> to:
- Create a classroom from a template for a use-case.
...
1. **Start a <Vg k="FC_UIB" /> session**
    ...
    1. Give the following authorization:
        ...
        ![Authorization](https://agora-doc.s3.us-east-1.amazonaws.com/images/flexible-classroom/flexible-classroom-authorization.png)
...
1. **Create a project**
    ...
    ![Create new project](https://agora-doc.s3.us-east-1.amazonaws.com/images/flexible-classroom/create-new-project.png)
...
1. **Open your project**
    ...
    ![Scene Editor](https://agora-doc.s3.us-east-1.amazonaws.com/images/flexible-classroom/scene-editor-layout.png)
...
1. **Create a scene**
    ...
    1. Press **Create new scene**, then choose a template based on the number of expected participants in your classroom. For the purpose of this demo, select **Interactive Small Classroom**.
        ...
        ![Choose a template](https://agora-doc.s3.us-east-1.amazonaws.com/images/flexible-classroom/choose-a-scene-template.png)
...
1. **Add modules to your scene**
    ...
    1. Press **Module**. You are presented with the following module options:
        ...
        * Chat
        ...
        ![Choose a template](https://agora-doc.s3.us-east-1.amazonaws.com/images/flexible-classroom/scene-editor-add-module.png)
    ...
    1. Add a Teacher Video Window.
        ...
        ![Teacher video window](https://agora-doc.s3.us-east-1.amazonaws.com/images/flexible-classroom/scene-editor-teacher-video.png)
    ...
    Your completed scene looks like:
        ...
        ![Final Scene](https://agora-doc.s3.us-east-1.amazonaws.com/images/flexible-classroom/scene-editor-complete-scene.png)

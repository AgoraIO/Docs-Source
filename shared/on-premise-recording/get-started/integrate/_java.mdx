...
1. [Download](http://docs.agora.io/en/sdks?platform=linux) the Agora On-premise Recording SDK for Linux package. The package structure is listed as follows:
...
The Agora On-premise Recording SDK is integrated. You can start recording by calling APIs, see [Agora Recording Java API Reference](https://api-ref.agora.io/en/on-premise-recording-sdk/linux-java/3.x/index.html).

...
When you need to [create and manage Agora projects](#creates-a-project) or [check usage](#gets-project-usage), besides using the graphic user interface at Agora Console, you can also call the Agora Console RESTful API.
...
| Parameter | Type   | Description                                                                                                   |
|-----------|--------|---------------------------------------------------------------------------------------------------------------|
| `id`      | String | (Required) The project ID, which can be obtained by calling the [Gets all projects](#gets-all-projects) API. |
...
|Parameter |Type |Description|
|---|---|---|
|`project_id` |String |(Required) The project ID, which can be obtained by calling the [Gets all projects](#gets-all-projects) API.|

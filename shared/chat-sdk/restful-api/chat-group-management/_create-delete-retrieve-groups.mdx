...
| `maxusers` | String | The maximum number of chat group members (including the group owner). The default value is 200. The upper limit varies with your price plans. For details, see [Pricing Plan Details]([Pricing Plan Details](../../reference/pricing-plan-details#group). | No |

...
| Storage space per channel or user metadata set | 64KB | N/A | To change the limit, contact [support@agora.io](mailto:support@agora.io). |
| Storage space per metadata item | 64KB | N/A | To change the limit, contact [support@agora.io](mailto:support@agora.io). |

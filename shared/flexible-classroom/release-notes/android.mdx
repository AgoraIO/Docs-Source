...
- Web: [getSnapshotRgba](/en/agora-class/API%20Reference/edu_context_web/v2.6.x/classes/_stores_domain_common_media_index_.MediaStore.html#getSnapshotRgba)
- Electron: [getSnapshot](/en/agora-class/API%20Reference/edu_context_web/v2.6.x/classes/_stores_domain_common_media_index_.MediaStore.html#getSnapshot)
- iOS: [getSnapshot](/en/agora-class/API%20Reference/edu_context_swift/v2.6.x/API/class_mediacontext.html#api_getsnapshot)
- Android: [getSnapshot](/en/agora-class/API%20Reference/edu_context_kotlin/v2.6.x/API/class_mediacontext.html#api_getsnapshot)
...
As of v1.1.5.1, Flexible Classroom adds the [Media Context API](/en/agora-class/edu_context_api_ref_android_media?platform=Android) to allow developers to implement the pre-class test module, with which students can check whether their camera and microphone are functioning correctly and preview how they look and sound before they join a class.

...
You can push a media stream to the CDN through the RESTful API or through the API provided by the [Agora RTC SDK v3.x](/3.x/interactive-live-streaming/advanced-features/media-push).

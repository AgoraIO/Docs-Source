...
For advanced configuration options, available voices, and detailed parameter descriptions, see the [Amazon TTS documentation](https://docs.aws.amazon.com/polly/latest/dg/what-is.html).
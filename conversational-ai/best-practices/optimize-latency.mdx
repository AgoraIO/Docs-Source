...
description: >
   Optimize end-to-end conversation latency by tuning LLM, ASR, and TTS components, geographic deployment, and RTC settings.
---
...
* **Optimize network conditions**: Ensure stable user network connection and consider using <Vg k="SDRTN" /> to optimize network transmission.

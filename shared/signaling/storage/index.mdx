...
<PlatformWrapper notAllowed="web,android,ios,macos,unity, linux-cpp">
**The <Vpl k="NAME" /> implementation is coming soon.**
</PlatformWrapper>

<PlatformWrapper notAllowed="windows,electron,linux-java">
...
<PlatformWrapper notAllowed={['ios','macos','android', 'unity', 'linux-cpp']}>
## Reference

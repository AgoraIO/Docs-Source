...
Released on Jul xx, 2025.

#### New features

* **Support for OpenAI realtime API**

    Integrate Multimodal Large Language Models (MLLMs) with <Vpd k="NAME" /> to enable real-time audio and text interactions without separate ASR/TTS components. 
    See [OpenAI Realtime API](/conversational-ai/models/mllm/openai) for integration details.

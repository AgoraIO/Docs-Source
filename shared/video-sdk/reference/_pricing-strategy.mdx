...
- Starting July 26, 2024, when you create a new general project in the <Vg k="COMPANY"/> Console, all existing general projects under your account will automatically switch to the new billing model. If the switch fails, contact [`support@agora.io`](mailto:support@agora.io).

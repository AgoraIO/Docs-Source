...
2. **Add a button to start and stop screen sharing**
    ...
    1. Add a **Text** for the button. Drag **Text** from the **Common** section of the **Palette Panel** and drop it over `shareScreenBtn`. Then, in **Details**, update the **Text** field to `Share Screen`.
...
3. **Add a Check Box**
    ...
    1. Add a text widget for `muteCheckBox`. Drag **Text** from **Palette Panel** and drop it over `muteCheckBox`, and then in **Details** change the **Text** field to `Mute`.

...
public class Handlers {
    ...
    public static class NcsHandler implements HttpHandler {
                ...
                if (productId == 4) { // Media Pull
                    ...
                    System.out.println(
                            "Event type: " + eventType
                                    + ", Notice ID: " + noticeId
                                    + ", Time stamp: " + lts
                                    + ", " + eventDetails(eventType, (JSONObject) payload.get("player")));
                }
            } catch (Exception e) {
        ...
        String eventDetails(int eventType, JSONObject details) {
            ...
            switch (eventType) {
                case 1: 
                    info = "Player Created, stream url: " + details.get("streamUrl").toString();
                    break;
                case 3: 
                    info = "Player Destroyed, channel name: " + details.get("channelName").toString();
                    break;
                case 4: 
                    info = "Player Status Changed, status: " + details.get("status").toString();
                    break;
                default:

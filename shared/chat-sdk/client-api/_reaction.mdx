...
- The project integrates a version of the Chat SDK later than v1.0.3 and has implemented the <Link to="../get-started/get-started-sdk?platform={{platform.PATH}}">basic real-time chat functionalities</Link>.

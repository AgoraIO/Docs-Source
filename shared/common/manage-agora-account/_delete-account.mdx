...
If any prerequisite is not met, an error message appears after you click **Continue**. Check the [Prerequisites](#prerequisite) and try again.
...
The admin email address is the email address you use to sign up for this account. You can find it on [the Profile page](#manage-profiles).

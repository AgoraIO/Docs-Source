...
- **Deprecation of Direct CDN streaming APIs**
    ...
    The following APIs related to Direct CDN streaming are deprecated in this release and will be removed in a future version. Use [server-side transcoding and media push](https://docs.agora.io/en/media-push/get-started/enable-media-push) instead.

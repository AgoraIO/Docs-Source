...
You can call the <code>{storage.setchannel[props.ag_platform]}</code> method in the following way:
...
| `data` | <code>{storage.metadata[props.ag_platform]}</code> | Required | - | Metadata item. See <a href='#storagemetadatapropsag_platform'><code>{storage.metadata[props.ag_platform]}</code></a>. |
...
You can call the <code>{storage.getchannel[props.ag_platform]}</code> method in the following way:
...
You can call the <code>{storage.removechannel[props.ag_platform]}</code> method in the following way:
...
You can call the <code>{storage.updatechannel[props.ag_platform]}</code> method in the following way:
...
You can call the <code>{storage.setuser[props.ag_platform]}</code> method in the following way:
...
You can call the <code>{storage.getuser[props.ag_platform]}</code> method in the following way:
...
You can call the <code>{storage.removeuser[props.ag_platform]}</code> method in the following way:
...
You can call the <code>{storage.updateuser[props.ag_platform]}</code> method in the following way:
...
You can call the <code>{storage.subscribeuser[props.ag_platform]}</code> method in the following way:
...
You can call the <code>{storage.unsubscribeuser[props.ag_platform]}</code> method in the following way:
...
| <code className="index-group-item-metadata index-api-createmetadata" id="createmetadata">createMetadata</code> | <div class="index-desc-createmetadata">Creates the <code>{storage.metadata[props.ag_platform]}</code> instance.</div> |

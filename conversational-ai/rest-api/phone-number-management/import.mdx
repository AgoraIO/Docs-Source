...
<ParameterList title="Request Body" required={true}>
  ...
  <Parameter name="inbound_config" type="object" required={false}>
    ...
    <Parameter name="allowed_addresses" type="array" required={true}>
  ...
  <Parameter name="outbound_config" type="object" required={true}>
    ...
    <Parameter name="transport" type="string" possibleValues="tls, tcp, udp" required={false}>
      Transport protocol. 
    </Parameter>
    ...
    <Parameter name="user" type="string" required={false}>
      SIP authentication username for outbound calls
    </Parameter>

    <Parameter name="password" type="string" required={false}>
      SIP authentication password for outbound calls
    </Parameter>
  </Parameter>
</ParameterList>

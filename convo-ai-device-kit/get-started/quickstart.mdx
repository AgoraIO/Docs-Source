...
- Agora Conversational AI device kit
...
1. Under **Conversational AI Devices**, tap the **+** button.
...
1. Short press the middle button (S2) to wake up the device.
2. Wait 3-5 seconds for the eye screens to activate. The red LED stops blinking when the device is ready.
3. Ask your question or make a request. For example:
    - "Tell me about the Agora Conversational AI Device Kit."
    - "Tell me about Agora."
    - "Who is Bill Gates?"

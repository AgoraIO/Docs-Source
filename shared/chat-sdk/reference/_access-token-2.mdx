...
## Prerequisites 
- You have built a token server based on Spring Framework and a Web client using Agora Chat according to <Link to="../develop/generate-user-tokens?platform={{platform.PATH}}">Authenticate Your Users with Tokens</Link>. 

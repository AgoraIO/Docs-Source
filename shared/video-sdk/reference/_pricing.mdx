...
In scenarios involving screen sharing, the unit price of the screen-sharing stream is calculated on the basis of the video dimension that you set in [`ScreenVideoTrackInitConfig`](https://docs.agora.io/en/Video/API%20Reference/web_ng/interfaces/screenvideotrackinitconfig.html).
</PlatformWrapper>

<PlatformWrapper platform="android">
In scenarios involving screen sharing, the unit price of the screen-sharing stream is calculated on the basis of the video dimension that you set in [`ScreenCaptureParameters`](https://docs.agora.io/en/video-call-4.x-beta/API%20Reference/java_ng/API/rtc_api_data_type.html#class_screencaptureparameters)
</PlatformWrapper>

<PlatformWrapper platform="ios">
In scenarios involving screen sharing, the unit price of the screen-sharing stream is calculated on the basis of the video dimension that you set in [`AgoraScreenCaptureParameters`](https://docs.agora.io/en/video-call-4.x-beta/API%20Reference/mac_ng/API/rtc_api_data_type.html#class_screencaptureparameters)
</PlatformWrapper>

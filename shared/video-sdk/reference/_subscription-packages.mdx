...
By default, each project is assigned the Free Package upon creation. You can upgrade at any time to the Starter, Standard, Premium, or Enterprise package. Higher-tier packages provide greater discounts and lower unit prices. For details, see [Pricing](pricing).
...
* **Price**: When you purchase or upgrade to a paid package, it becomes effective for the entire month, regardless of the purchase date. You are charged the full monthly price, and you receive the full monthly allocation of included minutes.

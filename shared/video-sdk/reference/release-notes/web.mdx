...
As of this release, the SDK can be used together with the <Vg k="RTEE_CLARITY" /> extension to intelligently enhance video quality without changing the resolution, thereby improving the viewing experience.

...
- Implement <Link to="../../../interactive-live-streaming/get-started/get-started-sdk">Get Started with <Vg k="ILS" /></Link>.
- [Activate Hive Visual Moderation API](https://console.agora.io/marketplace/extension/introduce?serviceName=hives) on Agora Console.

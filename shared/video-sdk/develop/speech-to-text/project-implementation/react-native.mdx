...
1.  **Install and Import the necessary modules**
    ...
    To convert your credentials to base-64 format, we will use the `Buffer` module. To do so, run the following command in your terminal:
...
1. **Receive and display the text stream**
    ...
    To receive this stream and display the text in your <Vpl k="CLIENT" />, in `App.tsx`, add the following code after `const EventHandles = {`:

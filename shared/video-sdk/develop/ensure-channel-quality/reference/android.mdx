...
For more detailed information, about the connection state and reasons, see <Link to="{{Global.API_REF_ANDROID_ROOT}}/class_irtcengineeventhandler.html#callback_onconnectionstatechanged">IRtcEngineEventHandler.onConnectionStateChanged</Link>.
...
- <Link to="{{global.API_REF_ANDROID_ROOT}}/class_irtcengine.html#api_enabledualstreammode">enableDualStreamMode</Link>

- <Link to="{{global.API_REF_ANDROID_ROOT}}/class_irtcengine.html#api_setremotevideostreamtype">setRemoteVideoStreamType</Link>

- <Link to="{{global.API_REF_ANDROID_ROOT}}/class_irtcengine.html#api_setaudioprofile">setAudioProfile</Link>

- <Link to="{{global.API_REF_ANDROID_ROOT}}/class_irtcengine.html#api_setvideoencoderconfiguration">setVideoEncoderConfiguration</Link>
...
- <Link to="{{global.API_REF_ANDROID_ROOT}}/class_irtcengineeventhandler.html#callback_onlocalvideostats">onLocalVideoStats</Link>

- <Link to="{{global.API_REF_ANDROID_ROOT}}/class_irtcengineeventhandler.html#callback_onremotevideostats">onRemoteVideoStats</Link>

- <Link to="{{global.API_REF_ANDROID_ROOT}}/class_irtcengineeventhandler.html#callback_onrtcstats">onRtcStats</Link>

- <Link to="{{global.API_REF_ANDROID_ROOT}}/class_irtcengineeventhandler.html#callback_onnetworkquality">onNetworkQuality</Link>

- <Link to="{{global.API_REF_ANDROID_ROOT}}/class_irtcengine.html#api_startechotest3">startEchoTest</Link>

- <Link to="{{global.API_REF_ANDROID_ROOT}}/class_irtcengine.html#api_stopechotest">stopEchoTest</Link>

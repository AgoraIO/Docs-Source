...
## Query push binding information

Query the push binding information of all devices of the current user.
...
|  Parameter  |  Type  |  Description  |
| :-------- | :------- | :------- |
| `entities` | Array | 	A list of push binding information for all devices of the current user. If there is no push binding information for any device of the current user, an empty list will be returned. |
...
|  Parameter  |  Type  |  Description  |
| :-------- | :------- | :------- |
| `entities` | JSON Array | The user's nickname and information about the user displayed in push notifications. |

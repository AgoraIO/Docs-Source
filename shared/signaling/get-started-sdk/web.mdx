...
-   The Agora <Vg k="MESS_SDK" /> supports creating multiple <Link to="{{Global.SIGNALING_API_REF_WEB_ROOT}}/classes/rtmclient.html">RtmClient</Link> instances that are independent of each other.

...
Agora has partnered with Wi-Fi chip manufacturers to release the R1 open-source development kit based on Broadcom's BK7258 chip. This guide shows you how to run the demo project and helps you get started quickly with the ConvoAI Device Kit.

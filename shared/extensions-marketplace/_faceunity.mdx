...
The <Vg k="RTEE_FU" /> AR Filter extension uses 3D vision, 3D graphics, and deep learning technologies to provide industry’s leading AR portrait video effects for <Vg k="VSDK"/>. It enables you to add diverse special effects that cover full coverage of the human face, including:

...
To add the button to the UI, do the following:
    ...
    1. Add a text widget for the spatial audio button. Drag **Text** from **Palette** > **Common** to the canvas panel. In **Details**, change the **Text** field to `Spatial Audio`, then change the following properties:

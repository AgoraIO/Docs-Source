...
To ensure that you receive all events from the moment the engine starts, set the `eventHandler` property of the `RtcEngineContext` to your event handler instance when [initializing the engine](#initialize-the-engine).
</Admonition>

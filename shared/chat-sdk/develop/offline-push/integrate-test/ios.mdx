...
1. In the **Certificate Assistant** dialog box, fill in the **User Email Address** and **Common Name**, select **Saved to disk** for **Request is**, click **Continue**, and add a storage path to save the file.
    ...
    ![push_apns_ca](https://agora-doc.s3.us-east-1.amazonaws.com/images/chat/push_apns_ca.png)
...
![push_apns_add_certificate](https://agora-doc.s3.us-east-1.amazonaws.com/images/chat/push_apns_add_certificate.png)

...
<body>
    <h2 class="left-align">Chat Examples</h5>
        <form id="loginForm">
...
1. Import the Chat SDK. Copy the following code to the `index.js` file:
...
2. Implement peer-to-peer messaging with the core methods provided by the Chat SDK. Copy the following code and add them behind the import function in the `index.js` file.

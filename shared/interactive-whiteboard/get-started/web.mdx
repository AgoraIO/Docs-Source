...
In `index.html`, add <code>&lt;script src="https://sdk.netless.link/white-web-sdk/2.15.16.js"&gt;&lt;/script&gt;</code> right below the <code>&lt;head&gt;</code> line to import the <Vg k="WHITE_SDK" />.
...
2. Create a `WhiteWebSdk` instance and join the room. You need to pass in the following parameters:
 - `appIdentifier`: The App Identifier of the whiteboard project in Agora <Vg k="CONSOLE" />. See [Get security credentials for your <Vg k="WHITE" /> project](../develop/enable-whiteboard#get-security-credentials-for-your-whiteboard-project).

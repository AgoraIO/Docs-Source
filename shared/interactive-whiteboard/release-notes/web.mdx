...
v2.16.51 was released on xx, 2024.
...
This version fixes the error message `AkkoSocket can't emit when phase is connecting` that appears in the console when connecting to WebSocket for more than 2 seconds.

...
You can select the pencil, text, or shape tools on the left toolbar to write and draw on the whiteboard. When the current page is full, click the `+` icon in the center of the screen to add a new page; use the arrows to switch pages.

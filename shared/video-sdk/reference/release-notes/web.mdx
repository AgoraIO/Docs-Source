...
**AI Super Clarity extension (Beta)**

As of this release, the SDK can be used together with the AI Super Clarity extension to intelligently enhance video quality without changing the resolution, thereby improving the viewing experience.

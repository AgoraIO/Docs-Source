...
Skills includes integration with the [Agora MCP server](https://mcp.agora.io/), which gives your assistant access to live Agora documentation. For installation instructions and supported tools, see the [Agora Skills repository](https://github.com/AgoraIO/skills).

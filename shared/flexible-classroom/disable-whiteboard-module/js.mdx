...
1. Create a new branch based on the [latest release branch](https://github.com/AgoraIO-Community/flexible-classroom-desktop/tree/release/apaas/2.1.2/packages) in the Flexible-Classroom-Desktop repository.

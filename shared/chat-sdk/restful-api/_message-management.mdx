...
Once a message is sent, you can call this method to recall the message. The default time limit for recalling a message is two minutes. You can change this time frame and extend it no longer than 7 days in Agora Console. See [Enable and configure Chat](../get-started/enable).
...
| `chat_type` | String   | Yes     | The type of the chat where the recalled message is located. <ul><li>`chat`: A one-on-one chat.</li><li>`group_chat`: A chat group.</li><li>`chatroom`: A chat room.</li></ul> |
...
| `chattype` | The type of the chat where the recalled message is located. <ul><li>`chat`: A one-on-one chat.</li><li>`group_chat`: A chat group.</li><li>`chatroom`: A chat room.</li></ul> |

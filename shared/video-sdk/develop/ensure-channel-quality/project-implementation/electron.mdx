...
5. **Set the latency level**
    ...
    ```
    For <Vg k="ILS" /> choose `AudienceLatencyLevelUltraLowLatency`. Ultra-low latency is a feature of <Vg k="ILS" /> and its use is subject to special [pricing](../reference/pricing#unit-pricing).
</ProductWrapper>
...
5. **Set the latency level**
    ...
    agoraEngine.updateChannelMediaOptions(options); 
    ```
    For <Vg k="BS" /> choose `AudienceLatencyLevelUltraLowLatency`. Low latency is a feature of <Vg k="BS" /> and its use is subject to special [pricing](../reference/pricing#unit-pricing).
</ProductWrapper>

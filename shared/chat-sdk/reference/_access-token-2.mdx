...
## Prerequisites 
- You have built a token server based on Spring Framework and a Web client using Agora Chat according to <Link to="/video-calling/develop/authentication-workflow?platform={{platform.PATH}}">Authenticate Your Users with Tokens</Link>. 

...
For integration details, refer to [App size optimization](/realtime-communication/best-practices/app-size-optimization?platform=android).
</TabItem>
...
For integration details, refer to [App size optimization](/realtime-communication/best-practices/app-size-optimization?platform=ios).
</TabItem>
...
- Toolkit
    - [`loadAudioSettings`](/conversational-ai/reference/android#loadaudiosettings)

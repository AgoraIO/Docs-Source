...
The Agora Fastboard SDK provides the [`insertImage`](/en/whiteboard/fastboard_api_web?platform=Web#insertimage) method for inserting and displaying an image in the main window of the whiteboard. You can call this method and pass in the URL of the image to display a specified image.

### Prerequisites

Before you start, make sure you meet the following requirements:

- Integrate the Agora Fastboard SDK in your project, and join the room. See [Join a Whiteboard Room](./join_whiteboard_room_web_fastboard?platform=Web).
...
The following steps show how to implement inserting an image in the [Join a Whiteboard Room](./join_whiteboard_room_web_fastboard?platform=Web) project:
...
The following steps show how to implement playing a video in the [Join a Whiteboard Room](./join_whiteboard_room_web_fastboard?platform=Web):
...
- Ensure the format of the converted images or web pages is supported by the Agora Fastboard SDK.
    ...
    - Static images in PNG, JPG/JPEG, and WEBP formats converted from PPT, PPTX, DOC, DOCX, and PDF files. See [Static-file conversion service](https://docs.agora.io/en/whiteboard/file_conversion_overview?platform=RESTful#static-file-conversion).
    
    - HTML web pages converted from PPTX files. See [Dynamic-file conversion service](https://docs.agora.io/en/whiteboard/file_conversion_overview?platform=RESTful#dynamic-file-conversion).
...
The following steps show how to implement presenting a three-page, animated PPTX file in the [Join a Whiteboard Room](./join_whiteboard_room_web_fastboard?platform=Web) project:
...
3. Open the [Join a Whiteboard Room](./join_whiteboard_room_web_fastboard?platform=Web) project, and add the following lines to the `main.js` file:
...
<div class = "alert info">The Fastboard SDK also provides another insertDocs method for inserting and displaying documents. For details, see the <a href = "https://docs-preprod.agora.io/en/whiteboard/fastboard_api_web?platform=Web#insertdocs-22">API reference</a>.</div>

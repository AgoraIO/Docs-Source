...
```shell
# Get SDK
wget https://download.agora.io/sdk/release/Agora-<Vg k="VSDK" />-x86_64-linux-gnu-v3.8.202.20-20220627_152601-214165.tgz
# Decompress the tgz file
tar xvf Agora-<Vg k="VSDK" />-x86_64-linux-gnu-v3.8.202.20-20220627_152601-214165.tgz
```

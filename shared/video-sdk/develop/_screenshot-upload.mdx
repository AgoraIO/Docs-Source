...
* There is no additional charge for this feature when bundled with [Cloud Recording](../../cloud-recording/overview/product-overview). ​
* [Pricing](../../cloud-recording/reference/pricing) is the same as Cloud Recording when used standalone.

#### Client-side option

The following prices apply when used as a feature under <Vg k="VIDEO"/> and <Vg k="ILS"/> products:​ 
...
*The fee is waived for customers using the [Active Fence](../../extensions-marketplace/develop/integrate/activefence?platform=web) content moderation extension.​ Additional charges for monthly peak QPS above 500 apply on a case-by-case basis.

...
2. Implement client-side logic
    ...
    1. To manually add the encryption library to your project:
        ...
        <Admonition type="caution" title="note" style="background-color:pink">Apple requires that an app's extension not contain dynamic libraries. If you need to integrate the SDK into a dynamic library within an extension, change the file's status to **Do Not Embed**.</Admonition>

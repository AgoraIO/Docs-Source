...
<Vg k="COMPANY" /> supplies a single GitHub repository containing all the code used in this <Vpd  k="SDK" />
documentation. To create a <Vpd  k="SDK" /> development environment:

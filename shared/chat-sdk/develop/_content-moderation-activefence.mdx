...
<Admonition type="info" title="Note">Content moderation powered by ActiveFence is in public beta. Moderation powered by Microsoft Azure is currently the default option. See [documentation](content-moderation-microsoft) for details.</Admonition>

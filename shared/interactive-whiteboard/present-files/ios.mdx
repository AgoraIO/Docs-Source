...
The Agora Fastboard SDK provides the [`insertImg`](/en/whiteboard/fastboard_api_ios?platform=iOS#insertimg) method for inserting and displaying an image in the main window of the whiteboard. You can call this method and pass in the URL, width, and height of the image to display a specified image.

### Prerequisites

Before you start, make sure you meet the following requirements:

- Integrate the Agora Fastboard SDK in your project, and join the room. See [Join a Whiteboard Room](./join_whiteboard_room_ios_fastboard?platform=iOS).
...
The Fastboard SDK does not provides a UI for insertImage. You need to implement the UI yourself.

<div class = "alert note">The Fastboard SDK does not provides a UI for <code>insertImg</code>. You need to implement the UI yourself.</div>

## Play audio and video

The Agora Fastboard SDK integrates the media player extension and provides the [`insertMedia`](/en/whiteboard/fastboard_api_ios?platform=iOS#insertmedia) method for playing audio and video files. You can simply call `insertMedia` and pass in the URL of the audio or video file and the title of the sub-window play the audio and video in a sub-window on the whiteboard.
...
<div class = "alert note">The Fastboard SDK does not provides a UI for <code>insertMedia</code>. You need to implement the UI yourself.</div>

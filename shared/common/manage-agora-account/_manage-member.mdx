...
1.  Log in to [Agora Console](https://console.agora.io/), click your account name in the top-right corner, and click **Setting** in the dropdown menu.
...
To enter the **Role Management** page, click **Role management** in the left navigation panel of the [Settings](https://console.agora.io/settings) page.

...
To use <Vg k="VSDK" /> in your component, include the following imports:
...
* `token`: Authenticates user permissions.
...
A complete code sample demonstrating the basic process of real-time interaction is provided for your reference. To use the complete sample, add the following component to your app. Replace appId, channelName, and token with values from the <Vg k="CONSOLE"/>.

...
After upgrading the SDK, you need to update the code in your app according to the business scenarios. See the [Migration guide](../develop/migration-guide) for details.
...
6. **Spatial audio**
    ...
    ![image](/images/video-sdk/spatial-audio-remote-user.png)
    ...
    ![image](/images/video-sdk/spatial-audio-media-player.png)

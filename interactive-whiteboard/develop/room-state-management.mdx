...
The following section extends the [Join the Whiteboard Room](../get-started/get-started-uikit#join-the-whiteboard-room) sample code to show the implementation of getting or listening for room states.

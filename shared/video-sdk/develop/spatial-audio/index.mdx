...
![Spatial audio comparison](/images/rtc-sdk/spatial-audio-comparison.png)
...
![SpatialAudio](/images/rtc-sdk/spatial-audio-effect-user.svg)
...
![SpatialAudio](/images/rtc-sdk/spatial-audio-effect-player.svg)
...
![Spatial audio steps](/images/rtc-sdk/spatial-audio-steps.svg)
</details>
<ProjectImplement/>
...
<div style={{ width: '33%' , height : '33%' }}>
  ![Social Chat](/images/rtc-sdk/voice-chatroom-social-spatial.png)
</div>
...
![Games & Metaverse](/images/rtc-sdk/gmes-scenario-spatial.png)
...
![Online Meetings](/images/rtc-sdk/online-spatial-scenario.png)

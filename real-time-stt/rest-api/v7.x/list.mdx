...
<Section title="Request example">
  ...
  <Tabs groupId="code-examples">
    ...
    ```bash
      curl --request GET \
        --url 'https://api.agora.io/api/speech-to-text/v1/projects/:appid/agents?state=RUNNING&limit=20' \
    ...
    ```js
    const url = 'https://api.agora.io/api/speech-to-text/v1/projects/:appid/agents?state=RUNNING&limit=20';
    const options = {
      method: 'GET',
      headers: {Authorization: 'Basic <credentials>'}
    };

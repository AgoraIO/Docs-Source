...
| `token` | The <Vg k="MESS" /> token used for authentication. For details, see [Generate a <Vg k="MESS" /> Token](/flexible-classroom/develop/integrate/authentication-workflow). |

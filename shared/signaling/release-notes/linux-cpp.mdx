<PlatformWrapper platform={["linux-cpp","windows-cpp"]}>
...
Starting from 2.2.0, the RTM SDK and RTC SDK (version 4.3.0 or later) both include dynamic library files. If you are using both RTM and RTC SDKs, please manually delete the dynamic library files of the lower version to avoid conflicts.

- 2.2.2 RTM SDK dynamic library version: 1.0.11.
- 2.2.1 RTM SDK dynamic library version: 1.0.11.
- 2.2.0 RTM SDK dynamic library version: 1.0.0.17.

### v2.2.2

v2.2.2 was released on November X, 2024.
...
- In some scenarios, users may receive repeated offline notifications from the same offline user.

...
<script type="text/javascript"> 
  ...
  AgoraEduSDK.launch(document.querySelector('#root'), {
    ...
    courseWareList: [],
    uiMode: light, // The theme of the classroom UI: FcrMultiThemeMode.light for the light mode, FcrMultiThemeMode.dark for the dark mode.
    listener: (evt, args) => {
    },
  }).then(() => {
...
3. Run the following command to pull the sub-module:

...
![Screen Share Process](/images/video-sdk/tmp_screen-sharing-ios-process.jpg)
...
1. Combine this with a manual action by the user to make the app turn on <Vg k="SCR_SHR" />. There are two ways to do this:
    ...
    1. Prompt the user to long press the **screen recording** button in the **Control Center** on iOS and choose to use the extension you created to start recording.
...
// Stop sharing captured videos in the channel

...
To enable and change virtual backgrounds, you add a button the user interface. To do this, open `index.html` and add the following lines after `<button type="button" id="leave">Leave</button>`:

...
| 100 | `AgoraChatErrorInvalidAppkey` |  The App Key is invalid. Log in again using a valid App Key. For how to get the App Key, see [Get the information of theAgora Chat project](../get-started/enable?platform=iOS). |

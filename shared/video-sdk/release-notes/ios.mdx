...
After upgrading the SDK, you need to update the code in your app according to the business scenarios. For details, see the [Migration guide](../understand/migration-guide).

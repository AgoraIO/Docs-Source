...
After upgrading the SDK, you need to update the code in your app according to the business scenarios. See [Migration guides](../develop/migration-guide) for details.

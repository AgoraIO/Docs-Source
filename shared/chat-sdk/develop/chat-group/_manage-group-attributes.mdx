...
import Understand from '@docs/shared/chat-sdk/develop/chat-group/manage-group-attributes/understand/index.mdx';
import ProjectImplement from '@docs/shared/chat-sdk/develop/chat-group/manage-group-attributes/project-implementation/index.mdx';

...
1. **Pre-load audio effects**
    ...
    To improve performance, you can pre-load sound effects before you join a channel. To do this, add the following code to the `join` component before `joinChannelWithOptions`:

...
The Models tab is where you select the ASR, LLM, and TTS services your agent uses. The dropdowns list vendor-model combinations that support Agora Managed Key. To use your own API key, click the settings icon next to the relevant dropdown to open the advanced configuration panel.
...
To use a vendor or model not available under Agora Managed Key, click the settings icon next to the relevant dropdown. This opens the advanced configuration panel where you can select any supported vendor and add your own API credentials. See [Manage integrations](integrations#credentials) for details on adding credentials.
...
The Agora project this agent is associated with. Billing and usage are tracked under this project.
...
Controls how the system decides the user has finished speaking.

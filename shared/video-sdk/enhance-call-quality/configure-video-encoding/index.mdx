...
* Capturing device orientation: _Landscape_
    ![orientation_adaptive_locked_landscape](/images/rtc-sdk/orientation_adaptive_locked_landscape.png) 

* Screen rotation: _Disabled_
* Capturing device orientation: _Portrait_
    ![orientation_adaptive_locked_portrait](/images/rtc-sdk/orientation_adaptive_locked_portrait.png) 

* Screen rotation: _Enabled_
* Capturing device orientation: _Landscape_
    ![orientation_adaptive_unlocked_landscape](/images/rtc-sdk/orientation_adaptive_unlocked_landscape.png) 

* Screen rotation: _Enabled_
* Capturing device orientation: _Portrait_
    ![orientation_adaptive_unlocked_portrait](/images/rtc-sdk/orientation_adaptive_unlocked_portrait.png) 
...
* Capturing device orientation: _Landscape_
    ![orientation_landscape_landscape](/images/rtc-sdk/orientation_landscape_landscape.png) 

* Capturing device orientation: _Portrait_
    ![orientation_landscape_portrait](/images/rtc-sdk/orientation_landscape_portrait.png) 
...
* Capturing device orientation: _Portrait_
    ![orientation_portrait_portrait](/images/rtc-sdk/orientation_portrait_portrait.png) 

* Capturing device orientation: _Landscape_
    ![orientation_portrait_landscape](/images/rtc-sdk/orientation_portrait_landscape.png) 

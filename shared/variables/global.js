...
export const API_REF_MACOS_ROOT_VOICE_SDK = `${API_REF_ROOT}/macos/${VSDK_RELEASE_API}/documentation`;
...
export const AI_FRAMEWORK = 'TEN framework'
export const AI_VOICE_AGENT = 'Astra Conversational AI agent'
...
To meet the needs of video content supervision, you use Agora <Vg k="VSDK" /> to take screenshots of the
video stream in a channel, then upload these images to third-party cloud storage.
...
your server in an `HTTPS` request.

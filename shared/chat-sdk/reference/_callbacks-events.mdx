...
| `security`      | String   | Signature in the format: `MD5(callId+secret+timestamp)`. For details on `Secret`, refer to [Configure callback rules](/agora-chat/develop/setup-webhooks#configure-callback-rules). |

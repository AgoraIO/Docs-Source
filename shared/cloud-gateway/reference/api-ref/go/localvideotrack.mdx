The `LocalVideoTrack` class provides basic methods for local video tracks. You can publish one or more video tracks using the [`PublishVideo`](./localuser#publishvideo) method.

...
To accommodate diverse business use-cases, <Vg k ="COMPANY"/>  also provides the streaming end with the option to choose whether its published audio stream participates in audio-strength stream selection or is directly transmitted to the receiving end.
...
<details>
<summary>Audio strength selection use case</summary>

![Use Case use-case](/images/rtc-sdk/audio-strength-selection-use-case.svg)
</details>

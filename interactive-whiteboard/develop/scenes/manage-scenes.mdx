...
Once you grasp the basic operations of scenes, you can refer to [Display Files](../scenes/display-files) for instructions on creating a set of scenes to display a complete file.

...
- Adds `crossOrigin` parameter to the `insertImage` method to enable Cross-Origin Resource Sharing (CORS) for inserted images.
- Adds `jumpPage` method to jump to a specified whiteboard page.

...
7. Press **Start speech to text**. You see notifications confirming receipt of a builder token and starting of a speech-to-text task.
...
10. Press **Stop speech to text**. The speech-to-text task stops and a confirmation message is displayed.

...
This page shows how to use the Chat RESTful API to implement presence in your project. Before calling the following methods, ensure that you meet the following:

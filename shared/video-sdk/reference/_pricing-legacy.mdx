...
You're viewing information about Agora's previous monthly billing model. For the latest prepaid packages, see [Pricing](pricing). 
</Admonition>
...
| Usage type    | Ordinary Users | Broadcast Streaming audience |
|---------------|--------|--------|
| Audio         | 0.99   | 0.59   |
| Video HD      | 3.99   | 1.99   |
...
- **Ordinary users**:  For Voice calling, Video calling, and Interactive live streaming participants (hosts and audience), and Broadcast streaming hosts, the user's latency level is ultra-low latency.

- **Broadcast streaming audience**:  For audience in the Broadcast streaming use case, the latency level is low latency. 
</Admonition>

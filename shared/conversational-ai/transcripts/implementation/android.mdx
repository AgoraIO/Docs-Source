...
1. **Implement UI rendering logic**
    ...
    Inherit your UI module from the `IConversationSubtitleCallback` interface. Implement the `onTranscriptUpdated` method to handle the logic for rendering transcript to the UI.

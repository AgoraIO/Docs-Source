...
<Vg k="AGORA_BACKEND"/>, or Software Defined Real-time Network, is a real-time transmission network built by <Vg k="COMPANY" /> and is the only network infrastructure specifically designed for real-time communications in the world.

...
To enable and change virtual backgrounds, you add a button the user interface. To do this, take the following steps:
    ...
    1. To change the button label, in **Properties**, update the **Caption** field with `Virtual Background`.

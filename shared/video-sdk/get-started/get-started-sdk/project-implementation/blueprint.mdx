...
- **Channel profile selection**: Choose communication mode for small group calls, typically under 17 participants, where all users publish. Use live broadcasting mode for larger events where you manage hosts (broadcasters) and audience separately.

...
This article describes how to implement multipath network transmission in your project.
...
- A mobile device running Android 7.0 or higher with two or more available network connections
- Android API level 24 or higher
</PlatformWrapper>
<PlatformWrapper platform="windows">
- Windows Vista or above device, with two or more available network ports.
</PlatformWrapper>

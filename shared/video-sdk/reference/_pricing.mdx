...
[AI Noise Suppression](../develop/ai-noise-suppression) helps reduce noise and voice distortion in virtual communication.
Agora charges for voice sent to the channel by the host while noise suppression is activated.
...
[3D Spatial Audio](../develop/spatial-audio) brings theater-like effects to virtual communication, making it seem as if the sound originates
from all around the user. Agora charges for the time users spend in a channel with spatial audio activated.

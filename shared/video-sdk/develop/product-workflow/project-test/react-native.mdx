...
7. **Test screensharing**
    ...
    1. Press the **Screen Share** button. You will get a prompt asking you to allow screen sharing, allow it.
    1. You notice that your screen is now visible below your your own video.
    1. Press the **Screen Share** button again. You notice that screen sharing is now stopped.

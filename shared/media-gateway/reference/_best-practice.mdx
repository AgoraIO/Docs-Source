...
1. Based on the geographical location of your source stream, use the primary domain name from the following table:
    ...
    |:----|:----------------------------|:----------------------------|
    | North America | `rtls-ingress-prod-na.agoramdn.com` | `rtls-ingress-backup-na.agoramdn.com` |
    | Europe | `rtls-ingress-prod-eu.agoramdn.com` | `rtls-ingress-backup-eu.agoramdn.com` |
    | Asia except Mainland China | `rtls-ingress-prod-ap.agoramdn.com` | `rtls-ingress-backup-ap.agoramdn.com` |
    | Chinese mainland | `rtls-ingress-prod-cn.agoramdn.com` | `rtls-ingress-backup-cn.agoramdn.com` |

...
- `sdkConfig`: (Required) Object. Configurations for the <Link to="{{Global.API_REF_WEB_WHITE}}/globals.html#whitewebsdkconfiguration">WhiteWebSdk</Link> object, in which you must pass the following parameters:
  - `appIdentifier`: String. The App Identifier of your Interactive Whiteboard project issued by Agora. See [Get security credentials for your whiteboard project](../get-started/enable-whiteboard#get-security-credentials-for-your-whiteboard-project).

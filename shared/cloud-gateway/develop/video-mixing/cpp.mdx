...
Agora supports video mixing. You can mix video tracks from multiple remote or local users and output the video in customized format. You can use video mixing to create watermarks, for picture-in-picture, and in other scenarios.

...
Extensions are add-ons designed to rapidly extend the functionality of your <Vpd k="CLIENT" />. [<Vg k="EM" />](https://www.agora.io/en/agora-extensions-marketplace/) is home to extensions that make your <Vpd k="CLIENT" /> more fun. Extensions provide features such as Audio effects and voice changing, Face filters and background removal, and Live transcription and captioning.
...
1. **Help developers easily integrate your extension into their <Vpd k="CLIENT" />**.

...
When you select **Audience**, this <Vpl k="CLIENT"/>:
    ...
    3. Subscribes to the remote video stream <Link to = "{{global.API_REF_ELECTRON_ROOT}}/class_irtcengine.html#api_irtcengine_muteremotevideostream">muteRemoteVideoStream</Link> method.
</ProductWrapper>

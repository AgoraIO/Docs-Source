...
5.  Integrate <Vg k="UIK" /> into your project.
    ...
    1.  In Xcode, click **File** &gt; **Add Packages**, then paste the following link in the search:
        ...
        ```
        You see the **VideoUIKit-iOS** package. Choose a version later than 1.8.4.
        </PlatformWrapper>
        <PlatformWrapper platform="macos">
        ```
        https://github.com/AgoraIO-Community/macOS-UIKit.git
        ```
        You see the **macOS-UIKit** package. Choose the main branch.
        </PlatformWrapper>


    1.  Click **Add Package**. In **Choose Package Products**, select `AgoraRtmControl` and `AgoraUIKit`, then click **Add Package**.
        <PlatformWrapper platform="ios">
        You see *VideoUIKit-IOS*, *AgoraRtmKit* and *AgoraRtcKit* in the *Package Dependencies* for your project.
        </PlatformWrapper>
        <PlatformWrapper platform="macos">
        You see *VideoUIKit-macOS*, *AgoraRtmKit* and *AgoraRtcKit* in the *Package Dependencies* for your project.
        </PlatformWrapper>

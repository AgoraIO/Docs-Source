...
To synchronize the online status of hosts, you can use this endpoint or the [query user status](query-user-status) endpoint. Agora recommends using this endpoint as it requires a lower call frequency and offers higher efficiency.

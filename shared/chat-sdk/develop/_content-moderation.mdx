...
<Admonition type="info" title="Note">This page describes the default content moderation option powered by [Microsoft Azure Moderator](https://azure.microsoft.com/en-us/services/cognitive-services/content-moderator/). Moderation powered by Active Fence is currently in public beta. See [documentation](https://docs-beta.agora.io/en/agora-chat/develop/content-moderation) for details.</Admonition>

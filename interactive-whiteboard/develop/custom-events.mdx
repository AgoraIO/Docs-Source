...
The following section extends the [Join a Whiteboard Room](../get-started/get-started-sdk) sample code to show the implementation of sending and receiving simple text messages by using the custom event methods.

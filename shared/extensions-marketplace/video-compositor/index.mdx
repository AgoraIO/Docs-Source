...
Ensure that you have implemented the [SDK quickstart](/realtime-communication/get-started/get-started-sdk) in your project using the Web SDK version 4.12.0 or later.

...
The source code for Flexible Classroom is located in the Github [Flexible-Classroom-Desktop](https://github.com/AgoraIO-Community/flexible-classroom-desktop) repository. To download the source code, take the following steps:

...
### 2. Update the Agora code in your app
    ...
    The v4.0.0 Beta SDK has optimized or modified the implementation of some functions, resulting in incompatibility with the v3.6.2 SDK. In order to retain Agora functionality in your app, update the code in your app according to [What has changed](../develop/migration-guide).
...
* setVideoDenoiserOptions, setLowlightEnhanceOptions, and setColorEnhanceOptions: Use setExtensionPropertyWithVendor instead. See [How to enable the video enhancement extensions](../develop/use-an-extension).

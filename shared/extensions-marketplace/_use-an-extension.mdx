...
import ProjectPrerequisites from '@docs/shared/extensions-marketplace/use-an-extension/project-prerequisites/index.mdx';
...
This page shows App developers how to integrate and use an extension from the <Vg k="COMPANY" /> Extensions Marketplace.
...
* To have completed <Link to="../get-started/get-started-sdk">Get Started with <Vpd k="NAME"/></Link>.
</ProductWrapper>
<ProductWrapper product="extensions-marketplace">
    * A working project that integrates <Vg k="VSDK"/>.
</ProductWrapper>

...
import ConvoAIToken from '@docs/shared/common/restful-authentication/convo-ai-token-authentication.mdx';
...
- **Token authentication**
    ...
    Token authentication uses an RTC token generated on your server using your app ID and app certificate. Unlike Basic Auth, which grants access to all projects on your Agora account, a token is scoped to a specific app ID and channel, making it the preferred method for production environments.
</ProductWrapper>

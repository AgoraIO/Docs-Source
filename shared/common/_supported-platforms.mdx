...
- *Platforms*:
    | Target Platform | Operating system version | IDE version                           |
    |-----------------|--------------------------|---------------------------------------|
    | macOS           | macOS 10.11 or later     | Xcode 9.0 or later                    |
...
- *Platforms*:
    | Target Platform | Operating system version | IDE version                           |
    |-----------------|--------------------------|---------------------------------------|
    | Windows         | Windows 7 or later. {data.VSDK} supports the following: <ul><li>x86-64</li><li>arm64</li></ul>  | Microsoft Visual Studio 2017 or later |
...
- *Platforms*:
    ...
    | iOS             | iOS 9.0 or later         | Xcode 9.0 or later                    |
    | Windows         | Windows 7 or later. {data.VSDK} supports the following: <ul><li>x86-64</li><li>arm64</li></ul>  | Microsoft Visual Studio |

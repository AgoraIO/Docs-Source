...
Please note that as Signaling v2.1.3 is currently in public beta, certain specific functionalities may be subject to future changes aimed at improving the overall user experience.
</Admonition>

#### New features

v2.1.3 provides the following core functional modules:

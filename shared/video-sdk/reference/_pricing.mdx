...
<Vg k="COMPANY" /> uses *standard minutes* to measure usage for all <Vg k="VSDK" /> products. Audio and video usage is converted into standard minutes according to the following conversion ratios:
...
Agora deducts standard minutes from the balance in your subscribed package. If you have not purchased a package, <Vg k="COMPANY"/> provides a default Starter package that includes 10,000 standard minutes. The following table shows the available packages.
...
- After subscribing to a paid package, you no longer receive the 10,000 free minutes.
- Different packages support different value-added features. Purchase a package that fits your business needs. For details, see [Feature availability by package](#feature-availability-by-package).
</Admonition>
...
|----------------|----------------|------------|
| 25,000	       |  _**$23.50**_  |    5%      |
| 250,000	       |  _*$247.50*_	  |    7%      |
| 1,000,000	     |  _*$990.00*_	  |    10%     |

\* The discount is calculated based on the standard minute (audio) rate ($0.99 per 1,000 minutes) and is already reflected in the package price.

- Top-up minutes remain valid for one year.
- You can apply top-up to any package, including the Starter (free) package.
...
User A purchases the Premium Package on August 15, 2025, and enables automatic renewal.

* **August 15**: On purchase, User A pays:  
  *$339.99 × (17 / 31) = $186.45* for the remaining days in August.
...
<Tabs groupId="sdk">
<TabItem value="native-sdk" label="Native, Web, and framework Video SDK">
...
| Feature | Starter            | Basic    | Standard       | Premium  |  Enterprise  |
| ------- | -------------------| ---------| -------------- | -------- | ------------ |
...
When you purchase a paid package, the free minutes are reflected in the package price through discounts. Higher-tier packages offer more free minutes. The 10,000 free minutes per month in the default package no longer apply.

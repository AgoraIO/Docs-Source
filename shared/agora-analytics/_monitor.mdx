...
<tbody>
<tr class="odd">
<td style="text-align: left;"><p>Average login time</p></td>
<td style="text-align: left;"><p>The average time it takes for a user to join a channel.</p></td>
</tr>
<tr class="even">
<td style="text-align: left;"><p>Audio Freeze Rate</p></td>
<td style="text-align: left;"><p>The rate at which audio freezing occurs, which equals Total audio freezing time ÷ Total audio duration. Only audio freezing longer than 200 milliseconds is counted.</p>
...
<tr class="odd">
<td style="text-align: left;"><p>Video Freeze Rate</p></td>
<td style="text-align: left;"><p>The rate at which video freezing occurs, which equals Total video freezing time ÷ Total video duration.</p>
...
<tr class="even">
<td style="text-align: left;"><p>Network delay rate</p></td>
<td style="text-align: left;"><p>The rate at which network delay occurs, which equals Total end-to-end network delay ÷ Total audio and video duration. Only end-to-end network delays longer than 400 milliseconds are counted.</p></td>
</tr>
</tbody>
</table>

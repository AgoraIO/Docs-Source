...
During the run time of the <Vg k="CHAT_SDK"/>, if the method call succeeds, the SDK returns `nil`; of not, the SDK returns the following error codes and error messages:

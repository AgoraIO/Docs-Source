...
<Admonition type="info">Before calling this API, ensure that you have called the Enable/Disable custom recording for an entry point API to disable custom recording for the entry point that includes this live stream.</Admonition>

...
The following code shows how to create a teaching-aid plugin for pre-class roll calls based on the existing widget capabilities of <Vg k="FC"/>. See the full source code in [rollbook-widget](https://github.com/AgoraIO-Community/flexible-classroom-desktop/).

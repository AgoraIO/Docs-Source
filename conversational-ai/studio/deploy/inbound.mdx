...
description: >
  Import a number in Agent Studio and associate it with an agent to answer inbound calls.
last_update:
  date: 2026-03-05
---

After configuring your Twilio SIP trunk for inbound calling, import your phone number into <Vpd k="STUDIO" /> and associate it with an agent. Once set up, calls to your Twilio number are automatically routed to your agent.
...
1. In <Vpd k="STUDIO" />, navigate to **Deploy → Phone Numbers** 

...
To use <Vg k="COMPANY" /> SDKs, create an audio and video project in the <Vg k="CONSOLE" /> first. See [Agora account management](../reference/manage-agora-account) for details.
</ProductWrapper>

![Create project in Agora Console](/images/common/create-project.png)

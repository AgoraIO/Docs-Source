...
* **TTS parameter update**
    ...
    Adds `base_url` (WSS url) field to the TTS parameters examples for [OpenAI](/conversational-ai/models/tts/openai) and [ElevenLabs](/conversational-ai/models/tts/elevenlabs).

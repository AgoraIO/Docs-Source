...
1. Download and unzip the [<Vg k="RTEE_MK"/>](https://download.agora.io/sdk/release/Agora_MetaKit_SDK_for_iOS_v2_1_0.zip?_gl=1*44lt1d*_gcl_au*MTk5MjA4NTEwMi4xNzE4MjAxNDUx*_ga*MjA0NDUxNTUwLjE2ODM3MTkwNzY.*_ga_BFVGG7E02W*MTcyMDY5NDUzNi4yMTUuMS4xNzIwNjk2NDM4LjAuMC4w) iOS extension.

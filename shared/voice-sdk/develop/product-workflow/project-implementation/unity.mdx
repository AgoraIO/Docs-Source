...
1. **Add the required library**
    ...
    To import the required Uinty UI library, in `Assets/Agora-RTC-Plugin/Agora-Unity-RTC-SDK/Code/JoinChannelAudio.cs`, add the following to the namespace declarations:

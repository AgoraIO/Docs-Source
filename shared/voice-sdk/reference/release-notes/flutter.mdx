...
## v<Vg k = "VSDK_FLUTTER_RELEASE"/>

v<Vg k = "VSDK_FLUTTER_RELEASE"/> was released on September 29, 2022.

#### Compatibility changes

This release changed SDK package name from `agora_rtc_ng` to `agora_rtc_engine`, and optimized the implementation of some features, resulting in incompatibility with v<Vg k = "VSDK_PREVIOUS_RELEASE"/> The following are the main features with compatibility changes:

...
- Integrate the <Vg k="WHITE_SDK" /> into your project and implement joining a room. For details, see [Join The Whiteboard Room](../../get-started/get-started-uikit#join-the-whiteboard-room).
...
- [Start file conversion (POST)](../../reference/whiteboard-api/file-conversion#start-file-conversion)

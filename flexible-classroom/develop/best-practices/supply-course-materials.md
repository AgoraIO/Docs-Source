...
1. When you call [launch](/flexible-classroom/client-api/classroom-sdk#launch) on your client, pass in the list of converted files by setting the [courseWareList](/flexible-classroom/client-api/classroom-sdk#configcoursewares) parameter. Then students can see the courseware in the classroom.

...
3. To launch a classroom, call  [AgoraEduSDK.config](/en/agora-class/agora_class_api_ref_web?platform=Web#config) and [AgoraEduSDK.launch](/en/agora-class/agora_class_api_ref_web?platform=Web#launch) in the JavaScript code of the project.
...
2. To launch a classroom, call  [AgoraEduSDK.config](/en/agora-class/agora_class_api_ref_web?platform=Web#config) and [AgoraEduSDK.launch](/en/agora-class/agora_class_api_ref_web?platform=Web#launch) in the JavaScript code of the project.
...
The sample code requires passing in `rtmToken`. You can refer to [Generate an RTM token](/en/Agora%20Platform/get_appid_token?platform=All%20Platforms#generate-an-rtm-token) to learn what is RTM token, how to get a temporary RTM token for testing purpose, and how to generate an RTM token from the server.
...
<div class="alert info">Make sure you have <a href="/cn/agora-class/agora_class_quickstart_web?platform=Web#dev-env">set up the development environment</a>.</div>
...
3. After pulling the code to your local device, you are free to edit the code according to your needs. You can refer to the [Customize the Classroom UI guide](/en/agora-class/agora_class_custom_ui_web?platform=Web).

...
<div class="alert note">After calling the <a href="./rest-api-recording-fls">Set custom recording configuration</a> API, custom recording is automatically enabled for all live streams under the entry point.</div>

---
title: "Embed a custom plugin in Flexible Classroom with ExtApp"
sidebar_position:  3
type: docs
description: >
...
The source code of ExtApp is in the `extapp` directory the [CloudClass-Android](https://github.com/AgoraIO-Community/CloudClass-Android/tree/release/apaas%2F1.1.5.1) repository on GitHub (Branch release/apaas/1.1.5.1).

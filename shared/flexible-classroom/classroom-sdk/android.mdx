...
Register an extension application by using the ExtApp tool. ExtApp is a tool for embedding extension applications in Flexible Classroom. For details, see [Customize Flexible Classroom with ExtApp](/flexible-classroom/develop/integrate/customize-ui/customize-classroom).
...
| :-------- | :----------------------------------------------------------- |
| `appId` | The Agora App ID. See [Get the Agora App ID](/flexible-classroom/get-started/manage-agora-account#get-the-app-id). |
...
| `rtmToken` | The <Vg k="MESS" /> token used for authentication. For details, see [Secure authentication with tokens](/flexible-classroom/develop/integrate/authentication-workflow/). |

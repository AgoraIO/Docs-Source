...
| [`putScenes`](https://docs.agora.io/en/whiteboard/API%20Reference/whiteboard_web/interfaces/room.html#putscenes)         | Inserts multiple scenes under the specified scene directory. |
...
To follow the procedure on this page, ensure that you have integrated the <Vg k="WHITE_SDK" /> into your project and implemented joining a room. For details, see [Join a whiteboard room](../get-started/get-started-uikit#join-the-whiteboard-room).

The following section extends the [Join a whiteboard room](../get-started/get-started-uikit#join-the-whiteboard-room) sample code to show the implementation of scene management.
...
Once you grasp the basic operations of scenes, you can refer to [Display Files](../develop/scenes/display_files) for instructions on creating a set of scenes to display a complete file.

...
To enable and change virtual backgrounds, you add a button the user interface. To implement this user interface, take the following steps:
...
3. **Setup an event listner for the virtual background button**

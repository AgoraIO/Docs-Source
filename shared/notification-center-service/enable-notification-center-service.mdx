...
Follow these steps to enable the NCS on the <Vg k="CONSOLE" />:

1. Log in to <Vg k="CONSOLE" />, and click the Project Management icon on the left navigation panel.

1. On the Project Management page, find the project for which you want to enable the NCS and click **Config**.
...
1. On the Notification Center Service Configuration page, fill in the following information, and click Save:

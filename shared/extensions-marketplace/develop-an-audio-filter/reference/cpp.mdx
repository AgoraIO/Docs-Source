...
- [`IAudioFilter`](#iaudiofilter): Implement receiving, processing, and delivering audio data.
- [`IExtensionProvider`](#iextensionprovider): encapsulate your `IAudioFilter` implementation into an extension.

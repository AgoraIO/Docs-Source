...
<PlatformWrapper platform="android, ios, macos, web, windows, unity">
...
- In a live broadcast scenario, only hosts can call `StartOrUpdateChannelMediaRelay`.
...
<PlatformWrapper notAllowed="android, ios, macos, web, windows, unity">
<NotAvailable />
</PlatformWrapper>

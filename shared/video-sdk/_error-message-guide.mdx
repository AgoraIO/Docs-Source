...
This page provides descriptions and troubleshooting tips for common <Vpd k="NAME"/> error and warning codes. If you receive a response that is not included here, best practice is to contact support@agora.io so that our technical support team can help resolve the issue.

<PlatformWrapper notAllowed="web">

## Messages and codes

When you make an API call to access an <Vpd k="NAME"/>, the SDK may return:

-   **Error codes** - when a problem occurs that cannot be recovered without app intervention. Error code can be a negative. However, you should read it as a positive number. For example, if <Vpd k="NAME"/> returns `-2`, refer to `2` in the error code table.
...
This section applies to the <Vg k="COMPANY" /> <Vpd k="NAME"/> designed for:
...
| `154`      | An error occurs on <Vg k="COMPANY" />'s streaming server. Call the `addPublishStreamUrl` method to push the stream again.                                                                                           |
...
<tr>
<th>Error code</th>
<th>Cause and troubleshooting tips</th>
</tr>
</thead>
<tbody>
<tr>
<td><p><code>1003</code></p></td>
<td><p>The camera fails to start. Check whether the camera is already in use by another app, or try rejoining the channel.</p>
<p><strong>Note:</strong> This method is <strong>deprecated</strong> as of v2.4.1. Please use <code>LOCAL_VIDEO_STREAM_ERROR_CAPTURE_FAILURE(4)</code> in the <code>onLocalVideoStateChanged</code> callback instead.</p></td>
</tr>
<tr>
<td><p><code>1004</code></p></td>
<td><p>The video rendering module fails to start.</p></td>
</tr>
<tr>
<td><p><code>1510</code></p></td>
<td><p>Permission to access the camera is not granted. Check whether permission to access the camera permission is granted.</p></td>
</tr>
<tr>
<td><p><code>1512</code></p></td>
<td><p>The camera is already in use.</p>
<p><strong>Note:</strong> This method is <strong>deprecated</strong> as of v2.4.1. Please use <code>LOCAL_VIDEO_STREAM_ERROR_DEVICE_BUSY(3)</code> in the <code>onLocalVideoStateChanged</code> callback instead.</p></td>
</tr>
<tr>
<td><p><code>1600</code></p></td>
<td><p>An unknown error occurs.</p></td>
</tr>
<tr>
<td><p><code>1601</code></p></td>
<td><p>Video encoding initialization fails. Try rejoining the channel.</p></td>
</tr>
<tr>
<td><p><code>1602</code></p></td>
<td><p>Video encoding fails. Try rejoining the channel.</p></td>
</tr>
<tr>
<td><p><code>1603</code></p></td>
<td><p>Video encoding settings fail to be applied.</p></td>
</tr>
</tbody>
</table>
...
For details about the error and warning codes that may occur when you use the <Vg k="COMPANY" /> <Vpd k="NAME"/>, see
<Link to="{{global.API_REF_WEB}}/index.html#error-code">Error codes</Link>

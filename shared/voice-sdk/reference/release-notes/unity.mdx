...
The SDK supports a new version of AI noise reduction (in comparison to the basic AI noise reduction in v3.x). The new AI noise reduction has better vocal fidelity, cleaner noise suppression, and adds a dereverberation option. To experience this feature, contact sales-us@agora.io.
...
![](https://web-cdn.agora.io/docs-files/1663826986859)
...
![](https://web-cdn.agora.io/docs-files/1663826999285)

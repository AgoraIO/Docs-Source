...
* **`onAgentListeningChanged`** :
  A fine-grained complement to `onAgentStateChanged`. Listen for changes in the agent's listening state to monitor when the agent starts or stops listening to user input.

* **`onAgentThinkingChanged`** :
  A fine-grained complement to `onAgentStateChanged`. Listen for changes in the agent's thinking state to monitor when the agent starts or stops processing a request.

* **`onAgentSpeakingChanged`** :
  A fine-grained complement to `onAgentStateChanged`. Listen for changes in the agent's speaking state to monitor when the agent starts or stops playing back speech.
...
- [`onAgentListeningChanged`](/conversational-ai/reference/android#onagentlisteningchanged)
- [`onAgentThinkingChanged`](/conversational-ai/reference/android#onagentthinkingchanged)
- [`onAgentSpeakingChanged`](/conversational-ai/reference/android#onagentspeakingchanged)
...
- [`onAgentListeningChanged`](/conversational-ai/reference/ios#onagentlisteningchanged)
- [`onAgentThinkingChanged`](/conversational-ai/reference/ios#onagentthinkingchanged)
- [`onAgentSpeakingChanged`](/conversational-ai/reference/ios#onagentspeakingchanged)

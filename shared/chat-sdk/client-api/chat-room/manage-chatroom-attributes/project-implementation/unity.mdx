...
Chat room members can call `RemoveAttributes` to remove one or more custom attributes that they have themselves and others. After you successfully call this method, other members in the chat room receive an `OnChatroomAttributesRemoved` callback. 

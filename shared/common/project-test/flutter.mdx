...
3. **Set the APP ID**
    In `flutter-reference-app/assets/config/config.json`, set `appId` to the [AppID](../get-started/manage-agora-account?platform=android#get-the-app-id) of your project.

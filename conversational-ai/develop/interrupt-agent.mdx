...
By default, this feature is disabled. To enable it, set `advanced_features.enable_aivad` to `true` when calling [Start a conversational AI agent](/conversational-ai/rest-api/agent/join). 
...
<Tabs groupId="platform">
<TabItem value="android" label="Android" default>
- [`interrupt`](../reference/toolkit/android#interrupt)
- [`destroy`](../reference/toolkit/android#destroy)
</TabItem>

<TabItem value="ios" label="iOS">
- [`interrupt`](../reference/toolkit/ios#interrupt)
- [`destroy`](../reference/toolkit/ios#destroy)
</TabItem>

<TabItem value="web" label="Web">
- [`interrupt`](../reference/toolkit/web#interrupt)
- [`destroy`](../reference/toolkit/web#destroy)
</TabItem>
</Tabs>

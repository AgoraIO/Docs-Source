...
1. On the <Vg k="FC"/> configuration page in <Vg k="CONSOLE"/>, find the whiteboard module:
   ...
   ![configure-whiteboard-feature](https://agora-doc.s3.us-east-1.amazonaws.com/images/flexible-classroom/configure-whiteboard-feature.png)
...
1. In the **Features** section of the **Edit Project** page, click **Enable/Configure** next to **Chat**.
   ...
   ![](https://agora-doc.s3.us-east-1.amazonaws.com/images/flexible-classroom/enable-chat.png)

1. Select the data center location.

   ![](https://agora-doc.s3.us-east-1.amazonaws.com/images/flexible-classroom/select-data-center.png)
...
1. In the **Chat** section, complete the required fields:
   ...
   ![](https://agora-doc.s3.us-east-1.amazonaws.com/images/flexible-classroom/synchronize-chat.png)
...
* Bucket policy
   ...
   ```
   ![](https://agora-doc.s3.us-east-1.amazonaws.com/images/flexible-classroom/configure-aws-ss1.png)
...
* Cross-origin resource sharing
   ...
   ```
   ![](https://agora-doc.s3.us-east-1.amazonaws.com/images/flexible-classroom/configure-aws-ss2.png)

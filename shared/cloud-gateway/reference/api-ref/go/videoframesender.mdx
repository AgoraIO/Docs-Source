...
Creates a raw video data sender module. This method creates a `VideoFrameSender` object, which can be used in the [`NewCustomVideoTrackFrame`](./localvideotrack#newcustomvideotrackframe) method.

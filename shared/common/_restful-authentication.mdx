...
<ProductWrapper product="signaling, flexible-classroom, media-gateway">
The following REST authentication methods are available:
</ProductWrapper>

<ProductWrapper notAllowed="signaling, flexible-classroom, media-gateway">
...
<ProductWrapper product="media-gateway, signaling">

...
v4.3.0 was released on xx January, 2024.
...
2. **Renaming parameters in callbacks**
   ...
   **Note:** For specific renaming of enumerations, refer to [API changes](#apichange).
...
3. **Dual-stream mode optimization**
   ...
   This release optimizes the video dual-stream mode. In the low-quality video stream adaptive mode (`AUTO_SIMULCAST_STREAM`), when the receiver requests a low-quality video stream by calling <Link to="{{Global.API_REF_ANDROID_ROOT}}/class_irtcengine.html#api_irtcengine_setremotevideostreamtype">setRemoteVideoStreamType</Link> or <Link to="{{Global.API_REF_ANDROID_ROOT}}/class_irtcengineex.html#api_irtcengineex_setremotevideostreamtypeex">setRemoteVideoStreamTypeEx</Link>, the sender now processes requests from all users, expanding beyond the previous restriction to broadcasters only. This change ensures that the audience requests for low-quality video streams are implemented, thus improving the flexibility and adaptability of the dual-stream mode.
...
5. **Optimization of video pre-processing methods**
   ...
   - <Link to="{{Global.API_REF_ANDROID_ROOT}}/class_irtcengine.html#api_irtcengine_setbeautyeffectoptions2">setBeautyEffectOptions</Link>
   - <Link to="{{Global.API_REF_ANDROID_ROOT}}/class_irtcengine.html#api_irtcengine_setlowlightenhanceoptions2">setLowlightEnhanceOptions</Link>
   - <Link to="{{Global.API_REF_ANDROID_ROOT}}/class_irtcengine.html#api_irtcengine_setvideodenoiseroptions2">setVideoDenoiserOptions</Link>
   - <Link to="{{Global.API_REF_ANDROID_ROOT}}/class_irtcengine.html#api_irtcengine_setcolorenhanceoptions2">setColorEnhanceOptions</Link>

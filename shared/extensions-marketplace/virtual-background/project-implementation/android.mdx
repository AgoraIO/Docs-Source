...
To enable and change virtual backgrounds, you add a button the user interface. To do this, open `/app/res/layout/activity_main.xml` and add the following lines before `</RelativeLayout>`:

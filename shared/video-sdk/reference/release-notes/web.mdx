...
This release includes internal improvements and fixes an issue where calling the `setMute` or `setEnable` methods under certain conditions could result in no sound. If you're using SDK version 4.23.0 or later, upgrade to this release for a better user experience.

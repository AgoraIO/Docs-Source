...
<Vg k="FAST" /> provides the [`insertImg`](../reference/uikit-sdk#insertstaticdocument) method for inserting and displaying an image in the main window of the whiteboard. You can call this method and pass in the URL, width, and height of the image to display a specified image.
...
<Vg k="FAST" /> does not provide a UI for <code>insertMedia</code>. You need to implement the UI yourself.

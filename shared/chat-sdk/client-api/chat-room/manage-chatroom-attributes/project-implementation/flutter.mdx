...
Chat room members can call `removeAttributes` to remove one or more custom attributes that they have set themselves and others. After you successfully call this method, other members in the chat room receive an `EMChatRoomEventHandler#onAttributesRemoved` callback.

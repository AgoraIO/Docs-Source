...
You configure your agent to listen to specific UIDs through the `remote_rtc_uids` parameter. The agent only processes audio from those UIDs—giving you control over who can interact with the agent.

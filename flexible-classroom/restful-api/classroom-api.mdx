...
To create a Cloud Classroom, followings are the required parameters:
...
| `msg`     | String  | Detailed information about the code.                                                                |
| `ts`      | Number  | The current Unix timestamp (in milliseconds) of the server in UTC.  |
|`data`     | Object  | The returned object, which contains the following data:<ul><li>roomUuid: String type, room ID.</li><li>roomName: String type, room name.</li><li>createTime: Integer type, room creation timestamp.</li><li>roomProperties: Object type, room attribute.<ul><li>roomType: Integer type, room type.<ul><li>0: 1v1.</li><li>2: Large class.</li><li>4: Small class size.</li></ul></li><li>schedule: Object type, lesson plan.<ul><li>state: Integer type, room status.<ul><li>0: has not started.</li><li>1: start.</li><li>2: Finish.</li><li>3: closure.</li></ul></li><li>startTime: Integer type, starting time.</li><li>endTime: Integer type, end time.</li><li>closeTime: Integer type, closing time.</li></ul></li><li>widgets: Object type, component collection.<ul><li>netlessBoard: Object type, whiteboard component.<ul><li>extra: Object type, extended information.<ul><li>boardAppId: String type, whiteboard App ID.</li><li>boardId: String type, whiteboard room ID.</li><li>boardToken: String type, whiteboard room Token.</li><li>boardRegion: String type, whiteboard area.</li></ul></li><li>state: Integer type, component status.<ul><li>0: Integer type, not activated.</li><li>1: Integer type, activated.</li></ul></li></ul></li><li>easemobIM: Object type, chat room component.<ul><li>extra: Object type, extended information.<ul><li>orgName: String type, organization name.</li><li>appName: String type, app name.</li><li>chatRoomId: String type, chat room ID.</li><li>appKey: String type, app Key.</li></ul></li><li>state: Integer type, component status.<ul><li>0: Integer type, not activated.</li><li>1: Integer type, activated.</li></ul></li></ul></li></ul></li></ul></li></ul>|

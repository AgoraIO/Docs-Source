...
1. Create a new branch based on the [latest release branch](https://github.com/AgoraIO-Community/flexible-classroom-android.git) in the Flexible-classroom-android repository.
</PlatformWrapper>

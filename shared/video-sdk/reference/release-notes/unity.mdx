...
1. **Speech driven avatar**
   ...
   The SDK introduces a speech driven extension that converts speech information into corresponding facial expressions to animate avatar. You can access the facial information through the newly added <Link to="{{Global.API_REF_UNITY_ROOT}}/class_irtcengine.html#api_imediaengine_registerfaceinfoobserver">RegisterFaceInfoObserver</Link> method and <Link to="{{Global.API_REF_UNITY_ROOT}}/class_ifaceinfoobserver.html#callback_ifaceinfoobserver_onfaceinfo">OnFaceInfo</Link> callback. This facial information conforms to the ARKit standard for Blend Shapes, which you can further process using third-party 3D rendering engines.
...
1. **Other features**
   ...
   - New method <Link to="{{Global.API_REF_UNITY_ROOT}}/class_irtcengineex.html#api_irtcengineex_enableencryptionex">EnableEncryptionEx</Link> is added for enabling media stream or data stream encryption in multi-channel scenarios.
   - New method <Link to="{{Global.API_REF_UNITY_ROOT}}/class_irtcengine.html#api_irtcengine_setaudiomixingplaybackspeed">SetAudioMixingPlaybackSpeed</Link> is introduced for setting the playback speed of audio files.
   - New method <Link to="{{Global.API_REF_UNITY_ROOT}}/class_irtcengineex.html#api_irtcengineex_getcallidex">GetCallIdEx</Link> is introduced for retrieving call IDs in multi-channel scenarios.

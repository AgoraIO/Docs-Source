...
The UI Kit does not provides a UI for <code>insertImage</code>. You need to implement the UI yourself.
...
The <Vg k="UIK" /> does not provide a UI for <code>insertVideo</code>. You need to implement the UI yourself.

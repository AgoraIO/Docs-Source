...
- **Equipment quality test**
    ...
    <details>
    <summary>Pre-call echo test</summary>
    
    ![Echo Test](/images/rtc-sdk/pre-call-echo-test.svg)
    </details>

- **Network quality analysis**

    The quality of the last mile network affects the smoothness and clarity of the audio and video that the user sends and receives. Last mile refers to the last leg of communication network between the edge server of the <Vg k="AGORA_BACKEND"/> and the end-user devices. Network quality analysis enables you to get feedback on the available bandwidth, packet loss rate, network jitter, and round-trip delay of the upstream and downstream last-mile networks. The following figure shows the basic process of running a last-mile probe test.

    <details>
    <summary>Pre-call last mile test</summary>
    
    ![Last Mile Test](/images/rtc-sdk/pre-call-last-mile-test.svg)
    </details>
...
## Prerequisites
Ensure that you have implemented the [SDK quickstart](../get-started/get-started-sdk) project and that your <Vpl k="CLIENT" /> has obtained permissions to use the relevant devices.

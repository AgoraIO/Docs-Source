...
1. **Portrait center stage**
   ...
   Before enabling portrait center stage, it is recommended to verify whether your current device supports this feature by calling <Link to="{{Global.API_REF_MACOS_ROOT}}/">isCameraCenterStageSupported</Link>. A list of supported devices can be found in the API documentation at <Link to="{{Global.API_REF_MACOS_ROOT}}/">enableCameraCenterStage</Link>.

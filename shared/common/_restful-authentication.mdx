...
- **Basic HTTP authentication**
    ...
    Generate a Base64-encoded credential with the customer ID and customer secret provided by <Vg k="COMPANY" /> and pass the credential with the `Authorization` parameter in the request header.
</ProductWrapper>

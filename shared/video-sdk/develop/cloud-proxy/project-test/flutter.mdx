...
4. Connect a test Android device to your development device.
...
6. Click **Join** to start a call.
    ...
    You see your <Vpl k="CLIENT" /> connects to the <Vg k="AGORA_BACKEND" /> from a restricted network environment using the proxy service. 

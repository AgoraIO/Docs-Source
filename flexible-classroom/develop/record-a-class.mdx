...
When you deploy the web page to be recorded into your CDN, you can use the template HTML file `templates/record_page_prod.html` provided by Agora in the [Flexible-Classroom-android](https://github.com/AgoraIO-Community/flexible-classroom-android) GitHub repository.
</PlatformWrapper>

...
- #1: If <Vpd k="NAME"/> is enabled for this channel at the start, the algorithm will remove 8 minutes of silent audio for host A, 7 minutes for host B, and 7 minutes for host C. Therefore, the transcription duration is (10 - 8) + (10 -7) + (10 - 7) = 2 + 3 + 3 = 8 minutes.

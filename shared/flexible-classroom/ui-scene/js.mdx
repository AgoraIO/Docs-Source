...
| `token`                   | The RTM Token. See [Secure your classrooms](/flexible-classroom/develop/integrate/authentication-workflow).             |
...
| `recordUrl`               | (Optional) The URL address for recording. You need to pass in the URL deployed by yourself for webpage recording, for example, `https://bing.com/recordUrl`.              |

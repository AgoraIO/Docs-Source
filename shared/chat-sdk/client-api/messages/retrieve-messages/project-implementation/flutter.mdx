...
If you have integrated <Vg k="CHAT_SDK"/> after June 8, 2023, you can retrieve historical messages even before joining the Chat Group. For earlier implementations, contact [support@agora.io](mailto:support@agora.io) to enable this.
...
int pageSize = 10;
ChatCursorResult<ChatConversation> result =
    await ChatClient.getInstance.chatManager.fetchPinnedConversations(
  cursor: cursor,
  pageSize: pageSize,
);
```

...
// Define the audio encoding settings
m_rtcEngine->setAudioProfile(AUDIO_PROFILE_TYPE.AUDIO_PROFILE_MUSIC_HIGH_QUALITY_STEREO);
```
### Music teaching
...
// Define the audio encoding settings
m_rtcEngine->setAudioProfile(AUDIO_PROFILE_TYPE.AUDIO_PROFILE_MUSIC_STANDARD_STEREO);
```

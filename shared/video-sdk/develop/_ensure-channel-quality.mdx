...
1. <Link to="{{Global.TOKEN_GENERATE_URL}}">Generate a temporary token</Link> in Agora Console.

2. In your browser, navigate to the <Link to="https://webdemo.agora.io/dualStream/index.html"><Vg k="COMPANY" /> web demo with dual stream</Link> and update _App ID_, _Channel_, and _Token_ with the values for your temporary token, then click **Join**.

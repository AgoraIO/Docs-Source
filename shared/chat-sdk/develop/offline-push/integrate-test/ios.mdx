...
- A non-jail broken device using the iOS system.
...
1. Check whether the correct APNs certificate has been uploaded in Agora Console and the correct certificate environment has been set.

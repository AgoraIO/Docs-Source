...
The following section extends the [Join a Whiteboard Room](https://docs.agora.io/en/whiteboard/join_whiteboard_room_web?platform=Web) sample code to show the implementation of sending and receiving simple text messages by using the custom event methods.
...
- [`dispatchMagix``Event`](https://docs.agora.io/en/whiteboard/API%20Reference/whiteboard_web/interfaces/room.html#dispatchmagixevent)
- [`addMagixEventListener`](https://docs.agora.io/en/whiteboard/API%20Reference/whiteboard_web/interfaces/room.html#addmagixeventlistener)
- [`removeMagixEventListener`](https://docs.agora.io/en/whiteboard/API%20Reference/whiteboard_web/interfaces/room.html#removemagixeventlistener)

...
2. Add a layout file for your activity. 
    ...
    Set up two `FrameLayout` elements in your activity to display local and remote video streams. Refer to [Create a user interface](#create-a-user-interface) to get a bare bones sample layout.
    </ProductWrapper>

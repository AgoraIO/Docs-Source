...
- Method: `GET`
- Endpoint: `https://api.agora.io/api/conversational-ai-agent/v1/projects/{appid}/agents`
...
<CodeItem language="bash" name="curl">{`curl --request get \\
  --url https://api.agora.io/api/conversational-ai-agent/v1/projects/:appid/agents`}</CodeItem>

  <CodeItem language="python" name="Python">{`import requests\n
url = "https://api.agora.io/api/conversational-ai-agent/v1/projects/:appid/agents"\n
response = requests.request("get", url)\n
print(response.text)`}</CodeItem>

  <CodeItem language="js" name="Node.js">{`const url = 'https://api.agora.io/api/conversational-ai-agent/v1/projects/:appid/agents';

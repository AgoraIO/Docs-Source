...
To follow the procedure on this page, ensure that you have integrated the Agora Interactive Whiteboard SDK into your project and implemented joining a room. For details, see [Join a Whiteboard Room](https://docs.agora.io/en/whiteboard/join_whiteboard_room_web?platform=Web).

## Set the whiteboard tool in the code

You can directly set the whiteboard tool used in the current room in the program. This section uses the [Join a Whiteboard Room](https://docs.agora.io/en/whiteboard/join_whiteboard_room_web?platform=Web) sample code as an example.
...
This section extends the [Join a Whiteboard Room](https://docs.agora.io/en/whiteboard/join_whiteboard_room_web?platform=Web) sample code to show the implementation of a simple toolbar.

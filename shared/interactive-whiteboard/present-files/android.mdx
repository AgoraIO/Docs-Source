...
- Integrate <Vg k="FAST" /> in your project and join the room. See [Join the whiteboard room](/interactive-whiteboard/fastboard-sdk/get-started/get-started-uikit#join-the-whiteboard-room).
...
The following steps show how to implement inserting an image in the [Join the whiteboard room](/interactive-whiteboard/fastboard-sdk/get-started/get-started-uikit#join-the-whiteboard-room) project:
...
- Integrate the <Vg k="FAST" /> in your project and join the room. See [Join the whiteboard room](/interactive-whiteboard/fastboard-sdk/get-started/get-started-uikit#join-the-whiteboard-room).
...
The following steps show how to implement playing a video in the [Join the whiteboard room](/interactive-whiteboard/fastboard-sdk/get-started/get-started-uikit#join-the-whiteboard-room) project:
...
2. Call the [Generate a Task Token (POST) API](/interactive-whiteboard/whiteboard-sdk/develop/generate-token-rest/), and pass the UUID in the request path to generate a task token for the file conversion task.
...
- Understand and enable the [file-conversion service](/interactive-whiteboard/whiteboard-sdk/develop/file-conversion-overview).

### Implementations

The following steps show how to implement presenting an animated PPTX document in the [Join the whiteboard room](../../fastboard-sdk/get-started/get-started-uikit#join-the-whiteboard-room) project:

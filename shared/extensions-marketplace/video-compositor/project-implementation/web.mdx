...
- Two local images.
- Source video track 1: Created from the video stream captured by the camera, with the background removed using the [Virtual Background extension](/realtime-communication/advanced-features/virtual-background).
...
1. Integrate the [Virtual Background](/realtime-communication/advanced-features/virtual-background#integrate-the-virtual-background-extension) extension. Ensure that you understand the [considerations](/realtime-communication/advanced-features/virtual-background#considerations).

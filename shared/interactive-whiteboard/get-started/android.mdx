...
>You can find the latest SDK version number in [Release Notes](../reference/release-notes).
...
- `appId`: The App Identifier of the whiteboard project in Agora Console. See [Get security credentials for your whiteboard project](../develop/enable-whiteboard).

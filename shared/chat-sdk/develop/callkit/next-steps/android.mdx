...
Tokens are generated on your app server using the token generator provided by Agora. For how to generate a token on the server and retrieve and renew the token on the client, see <Link to="/video-calling/develop/authentication-workflow">Authenticate Your Users with Tokens</Link>.

...
This is the first release of the Signaling SDK for Web v2.x, which brings innovation in functional coverage,
  performance improvement, and experience optimization.
...
- `new RTM`: Create an instance of the Signaling client and perform the initial configuration as follows:
   ...
   - `rtmConfig`: this object contains the following variables:

...
<CodeItem language="bash" name="curl">{`curl --request get \\
  --url https://api.agora.io/api/conversational-ai-agent/v2/projects/:appid/agents/:agentId`}</CodeItem>
...
print(response.text)`}</CodeItem>
  ...
  <CodeItem language="js" name="Node.js">{`const url = 'https://api.agora.io/api/conversational-ai-agent/v2/projects/:appid/agents/:agentId';

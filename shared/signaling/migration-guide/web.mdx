...
<Admonition type="info" title="Note">When using AWS-S3 for static file storage, log in to the Amazon S3 console and set the correct user permissions and access policies. For details, see [Amazon Simple Storage Service](https://aws.amazon.com/pm/serv-s3/)</Admonition>

...
- An Agora project with the <Vg k="WHITE" /> enabled. Get the app identifier and SDK token from <Vg k="CONSOLE" />. See [Enable and configure <Vg k="WHITE" />](../../whiteboard-sdk/get-started/enable-whiteboard).

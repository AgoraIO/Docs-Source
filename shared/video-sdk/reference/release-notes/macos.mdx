...
1. **Other features**
   ...
   - New method <Link to="{{Global.API_REF_MACOS_ROOT}}/">enableEncryptionEx</Link> is added for enabling media stream or data stream encryption in multi-channel scenarios.
   - New method <Link to="{{Global.API_REF_MACOS_ROOT}}/">setAudioMixingPlaybackSpeed</Link> is introduced for setting the playback speed of audio files.
   - New method <Link to="{{Global.API_REF_MACOS_ROOT}}/">getCallIdEx</Link> is introduced for retrieving call IDs in multi-channel scenarios.

...
**Call Inspector** helps you search calls and analyze quality issues. See [Call Inspector](../develop/call-inspector/call-search) for details.
...
Big Channel helps you monitor and analyze quality issues of Big Channels in real time, improving the operational efficiency of user activities in Big Channels. For details, see [Big Channel](../develop/call-inspector/big-channel).
...
**Data Insights** provides statistics on the usage and quality of your project over a specified period of time. See [Data Insights](../develop/data-insight) for details.
...
**Real-time Monitoring** provides visualized data for multiple call metrics in real time. See [Real-time Monitoring](../develop/monitor) for details.
...
-   Data synchronization with [Call Inspector](../develop/call-inspector/call-search) and [Data Insights](../develop/data-insight), so that you can easily dive into problem analysis.

![1635496901316](https://web-cdn.agora.io/docs-files/1635496901316)

# Alert Notifications

**Alert Notifications** sends alerts to you when abnormal metrics or events are detected in your Agora RTC projects. See [Alert Notifications](../develop/alarm) for details.
